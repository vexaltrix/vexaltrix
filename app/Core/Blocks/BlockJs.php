...
if ( ! class_exists( 'Vexaltrix\\Core\\Blocks\\BlockJs' ) ) {

	/**
	 * Class \Vexaltrix\Core\Blocks\BlockJs.
	 */
	class BlockJs {
		...
		public static function blocksAdvancedHeadingGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $headLoadGoogleFont, $headFontFamily, $headFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $subheadLoadGoogleFont, $subheadFontFamily, $subheadFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $highlightHeadLoadGoogleFont, $highlightHeadFontFamily, $highlightHeadFontWeight );
		}
		...
		public static function blocksHowToGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $headLoadGoogleFont, $headFontFamily, $headFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $subheadLoadGoogleFont, $subheadFontFamily, $subheadFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $priceLoadGoogleFont, $priceFontFamily, $priceFontWeight );
		}
		/**
		...
		public static function blocksHowToStepGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $urlLoadGoogleFont, $urlFontFamily, $urlFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $titleLoadGoogleFont, $titleFontFamily, $titleFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $descriptionLoadGoogleFont, $descriptionFontFamily, $descriptionFontWeight );
		}
		...
		public static function blocksReviewGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $subheadLoadGoogleFont, $subheadFontFamily, $subheadFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $headLoadGoogleFont, $headFontFamily, $headFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $contentLoadGoogleFonts, $contentFontFamily, $contentFontWeight );
		}
		...
		public static function blocksInlineNoticeGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $titleLoadGoogleFont, $titleFontFamily, $titleFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $descLoadGoogleFont, $descFontFamily, $descFontWeight );
		}
		...
		public static function blocksCf7StylerGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $msgFontLoadGoogleFont, $msgFontFamily, $msgFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $validationMsgLoadGoogleFont, $validationMsgFontFamily, $validationMsgFontWeight );

			\Vexaltrix\Support\Helper::blocksGoogleFont( $radioCheckLoadGoogleFont, $radioCheckFontFamily, $radioCheckFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $buttonLoadGoogleFont, $buttonFontFamily, $buttonFontWeight );

			\Vexaltrix\Support\Helper::blocksGoogleFont( $labelLoadGoogleFont, $labelFontFamily, $labelFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $inputLoadGoogleFont, $inputFontFamily, $inputFontWeight );
		}
		...
		public static function blocksMarketingBtnGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $titleLoadGoogleFont, $titleFontFamily, $titleFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $prefixLoadGoogleFont, $prefixFontFamily, $prefixFontWeight );
		}
		...
		public static function blocksTableOfContentsGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $loadGoogleFont, $fontFamily, $fontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $headingLoadGoogleFont, $headingFontFamily, $headingFontWeight );
		}
		...
		public static function blocksBlockquoteGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $descLoadGoogleFont, $descFontFamily, $descFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $authorLoadGoogleFont, $authorFontFamily, $authorFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $tweetBtnLoadGoogleFont, $tweetBtnFontFamily, $tweetBtnFontWeight );
		}
		...
		public static function blocksTestimonialGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $descLoadGoogleFonts, $descFontFamily, $descFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $nameLoadGoogleFonts, $nameFontFamily, $nameFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $companyLoadGoogleFonts, $companyFontFamily, $companyFontWeight );
		}
		...
		public static function blocksRestaurantMenuGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $titleLoadGoogleFonts, $titleFontFamily, $titleFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $priceLoadGoogleFonts, $priceFontFamily, $priceFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $descLoadGoogleFonts, $descFontFamily, $descFontWeight );
		}
		...
		public static function blocksContentTimelineGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $headLoadGoogleFonts, $headFontFamily, $headFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $subheadloadGoogleFonts, $subheadfontFamily, $subheadfontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $dateLoadGoogleFonts, $dateFontFamily, $dateFontWeight );
		}
		...
		public static function blocksPostTimelineGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $authorLoadGoogleFonts, $authorFontFamily, $authorFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $ctaLoadGoogleFonts, $ctaFontFamily, $ctaFontWeight );
		}
		...
		public static function blocksPostGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $metaLoadGoogleFont, $metaFontFamily, $metaFontWeight );

			\Vexaltrix\Support\Helper::blocksGoogleFont( $excerptLoadGoogleFont, $excerptFontFamily, $excerptFontWeight );

			\Vexaltrix\Support\Helper::blocksGoogleFont( $ctaLoadGoogleFont, $ctaFontFamily, $ctaFontWeight );
		}
		...
		public static function blocksCallToActionGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $titleLoadGoogleFont, $titleFontFamily, $titleFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $descLoadGoogleFont, $descFontFamily, $descFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $secondCtaLoadGoogleFont, $secondCtaFontFamily, $secondCtaFontWeight );
		}
		...
		public static function blocksFaqGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $questionLoadGoogleFont, $questionFontFamily, $questionFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $answerLoadGoogleFont, $answerFontFamily, $answerFontWeight );
		...
		public static function blocksSeparatorGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $elementTextLoadGoogleFont, $elementTextFontFamily, $elementTextFontWeight );
		}
		...
		public static function blocksTaxonomyListGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $titleLoadGoogleFont, $titleFontFamily, $titleFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $countLoadGoogleFont, $countFontFamily, $countFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $listLoadGoogleFont, $listFontFamily, $listFontWeight );
		...
		public static function blocksFormsGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $submitTextLoadGoogleFont, $submitTextFontFamily, $submitTextFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $labelLoadGoogleFont, $labelFontFamily, $labelFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $inputLoadGoogleFont, $inputFontFamily, $inputFontWeight );
		}
		...
		public static function blocksAdvancedImageGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $headingLoadGoogleFont, $headingFontFamily, $headingFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $captionLoadGoogleFont, $captionFontFamily, $captionFontWeight );
		}
		...
		public static function blocksCounterGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $headingLoadGoogleFont, $headingFontFamily, $headingFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $numberLoadGoogleFont, $numberFontFamily, $numberFontWeight );
		}
		...
		public static function blocksImageGalleryGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $captionLoadGoogleFont, $captionFontFamily, $captionFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $loadMoreLoadGoogleFont, $loadMoreFontFamily, $loadMoreFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $lightboxLoadGoogleFont, $lightboxFontFamily, $lightboxFontWeight );
		}
		...
		public static function blocksCountdownGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $digitLoadGoogleFont, $digitFontFamily, $digitFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $labelLoadGoogleFont, $labelFontFamily, $labelFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $separatorLoadGoogleFont, $separatorFontFamily, $separatorFontWeight );
		}
		...
		public static function blocksModalGfont( $attr ) {
			...
			\Vexaltrix\Support\Helper::blocksGoogleFont( $textLoadGoogleFont, $textFontFamily, $textFontWeight );
			\Vexaltrix\Support\Helper::blocksGoogleFont( $btnLoadGoogleFont, $btnFontFamily, $btnFontWeight );
		}
	}
}
