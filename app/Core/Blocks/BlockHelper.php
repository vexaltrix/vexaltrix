...
if ( ! class_exists( 'Vexaltrix\\Core\\Blocks\\BlockHelper' ) ) {

	/**
	 * Class \Vexaltrix\Core\Blocks\BlockHelper.
	 */
	class BlockHelper {
		...
		public static function getButtonsChildSelectors( $attr, $id, $childMigrate ) {
			...
			if ( ! $attr['inheritFromTheme'] ) {
				...
				$selectors[' .vxt-button__wrapper .vxt-buttons-repeater']                   = [
					...
					'font-size'       => \Vexaltrix\Support\Helper::getCssValue( $attr['size'], $attr['sizeType'] ),
					...
					'color'           => $attr['color'],
					'margin-top'      => \Vexaltrix\Support\Helper::getCssValue( $attr['topMargin'], $attr['marginType'] ),
					'margin-bottom'   => \Vexaltrix\Support\Helper::getCssValue( $attr['bottomMargin'], $attr['marginType'] ),
					'margin-left'     => \Vexaltrix\Support\Helper::getCssValue( $attr['leftMargin'], $attr['marginType'] ),
					'margin-right'    => \Vexaltrix\Support\Helper::getCssValue( $attr['rightMargin'], $attr['marginType'] ),
				];
				...
				$mSelectors[ $wrapper . ' .vxt-button__link' ]     = [
					'font-size'   => \Vexaltrix\Support\Helper::getCssValue( $attr['sizeMobile'], $attr['sizeType'] ),
				...
				$tSelectors[ $wrapper . ' .vxt-button__link' ]     = [
					'font-size'   => \Vexaltrix\Support\Helper::getCssValue( $attr['sizeTablet'], $attr['sizeType'] ),
				...
				$mSelectors[ $wrapper . '.wp-block-button__link' ]  = array_merge(
					[
						'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['topMobilePadding'], $attr['mobilePaddingUnit'] ),
						'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['bottomMobilePadding'], $attr['mobilePaddingUnit'] ),
						'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['leftMobilePadding'], $attr['mobilePaddingUnit'] ),
						'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['rightMobilePadding'], $attr['mobilePaddingUnit'] ),
						'margin-top'     => \Vexaltrix\Support\Helper::getCssValue( $attr['topMarginMobile'], $attr['marginType'] ),
						'margin-bottom'  => \Vexaltrix\Support\Helper::getCssValue( $attr['bottomMarginMobile'], $attr['marginType'] ),
						'margin-left'    => \Vexaltrix\Support\Helper::getCssValue( $attr['leftMarginMobile'], $attr['marginType'] ),
						'margin-right'   => \Vexaltrix\Support\Helper::getCssValue( $attr['rightMarginMobile'], $attr['marginType'] ),
					],
					$borderCssMobile
				);
				...
				$tSelectors[ $wrapper . '.wp-block-button__link' ] = array_merge(
					[
						'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['topTabletPadding'], $attr['tabletPaddingUnit'] ),
						'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['bottomTabletPadding'], $attr['tabletPaddingUnit'] ),
						'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['leftTabletPadding'], $attr['tabletPaddingUnit'] ),
						'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['rightTabletPadding'], $attr['tabletPaddingUnit'] ),
						'margin-top'     => \Vexaltrix\Support\Helper::getCssValue( $attr['topMarginTablet'], $attr['marginType'] ),
						'margin-bottom'  => \Vexaltrix\Support\Helper::getCssValue( $attr['bottomMarginTablet'], $attr['marginType'] ),
						'margin-left'    => \Vexaltrix\Support\Helper::getCssValue( $attr['leftMarginTablet'], $attr['marginType'] ),
						'margin-right'   => \Vexaltrix\Support\Helper::getCssValue( $attr['rightMarginTablet'], $attr['marginType'] ),
			...
			$selectors[ $wrapper . ' .vxt-button__icon > svg' ]       = [
				'width'  => \Vexaltrix\Support\Helper::getCssValue( self::getFallbackNumber( $attr['iconSize'], 'iconSize', $blockName ), 'px' ),
				'height' => \Vexaltrix\Support\Helper::getCssValue( self::getFallbackNumber( $attr['iconSize'], 'iconSize', $blockName ), 'px' ),
			...
			if ( ! $attr['removeText'] ) {
				$iconMargin        = \Vexaltrix\Support\Helper::getCssValue( self::getFallbackNumber( $attr['iconSpace'], 'iconSpace', $blockName ), 'px' );
				$tabletIconMargin = \Vexaltrix\Support\Helper::getCssValue( $attr['iconSpaceTablet'], 'px' );
				$mobileIconMargin = \Vexaltrix\Support\Helper::getCssValue( $attr['iconSpaceMobile'], 'px' );
		...
		public static function getPostSelectors( $attr ) {
			...
			$selectors = [
				'.is-grid .vxt-post__inner-wrap'         => array_merge(
					[
						'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $paddingTop, $attr['contentPaddingUnit'] ),
						'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $paddingBottom, $attr['contentPaddingUnit'] ),
						'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $paddingLeft, $attr['contentPaddingUnit'] ),
						'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $paddingRight, $attr['contentPaddingUnit'] ),
						'box-shadow'     => $boxShadowCss,
					],
					$overallBorderCss
				),
				'.is-grid .vxt-post__inner-wrap .vxt-post__image:first-child' => ! $isLeftRight ? [
					'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( ( - (int) $paddingLeft ), $attr['contentPaddingUnit'] ),
					'margin-right' => \Vexaltrix\Support\Helper::getCssValue( ( - (int) $paddingRight ), $attr['contentPaddingUnit'] ),
					'margin-top'   => \Vexaltrix\Support\Helper::getCssValue( ( - (int) $paddingTop ), $attr['contentPaddingUnit'] ),
				] : [],
				':not(.is-grid) .vxt-post__inner-wrap > .vxt-post__text:last-child' => [
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $paddingBottom, $attr['contentPaddingUnit'] ),
				],
				':not(.is-grid) .vxt-post__inner-wrap > .vxt-post__text:first-child' => [
					'margin-top' => \Vexaltrix\Support\Helper::getCssValue( $paddingTop, $attr['contentPaddingUnit'] ),
				],
				...
				':not(.wp-block-vxt-post-carousel):not(.is-grid).vxt-post__items' => [
					'margin-right' => \Vexaltrix\Support\Helper::getCssValue( ( - (int) $rowGapFallback / 2 ), $attr['rowGapUnit'] ),
					'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( ( - (int) $rowGapFallback / 2 ), $attr['rowGapUnit'] ),
				],
				':not(.is-grid).vxt-post__items article' => [
					'padding-right' => \Vexaltrix\Support\Helper::getCssValue( (int) ( $rowGapFallback / 2 ), $attr['rowGapUnit'] ),
					'padding-left'  => \Vexaltrix\Support\Helper::getCssValue( (int) ( $rowGapFallback / 2 ), $attr['rowGapUnit'] ),
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( ( $columnGapFallback ), $attr['columnGapUnit'] ),
				],
				':not(.is-grid) .vxt-post__inner-wrap > .vxt-post__text' => [
					'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( $paddingLeft, $attr['contentPaddingUnit'] ),
					'margin-right' => \Vexaltrix\Support\Helper::getCssValue( $paddingRight, $attr['contentPaddingUnit'] ),
				],
				...
				' .vxt-post__inner-wrap .vxt-post__cta' => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $ctaBottomSpaceFallback, $attr['ctaBottomSpaceUnit'] ),
				],
				' .vxt-post__image '                     => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $imageBottomSpaceFallback, $attr['imageBottomSpaceUnit'] ),
				],
				' .vxt-post__title'                      => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $titleBottomSpaceFallback, $attr['titleBottomSpaceUnit'] ),
				],
				' .vxt-post-grid-byline'                 => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $metaBottomSpaceFallback, $attr['metaBottomSpaceUnit'] ),
				],
				' .vxt-post__excerpt'                    => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $excerptBottomSpaceFallback, $attr['excerptBottomSpaceUnit'] ),
				],
				...
				'.is-grid.vxt-post__items'               => [
					'row-gap'    => \Vexaltrix\Support\Helper::getCssValue( $rowGapFallback, $attr['rowGapUnit'] ),
					'column-gap' => \Vexaltrix\Support\Helper::getCssValue( $columnGapFallback, $attr['columnGapUnit'] ),
				],
				...
				$selectors = array_merge(
					...
					[
						...
						'.vxt-post-grid .vxt-post__inner-wrap .wp-block-button.vxt-post__text.vxt-post__cta a'               => array_merge(
							[
								'color'          => $attr['ctaColor'],
								'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $paddingBtnTop, $attr['paddingBtnUnit'] ),
								'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $paddingBtnBottom, $attr['paddingBtnUnit'] ),
								'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $paddingBtnLeft, $attr['paddingBtnUnit'] ),
								'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $paddingBtnRight, $attr['paddingBtnUnit'] ),
							]
						),
		...
		public static function getPostMobileSelectors( $attr ) {
			...
			$mSelector = [
				...
				' .vxt-post__inner-wrap .vxt-post__text.vxt-post__cta' => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $ctaBottomSpaceMobile, $attr['ctaBottomSpaceUnit'] ),
				],
				' .vxt-post__inner-wrap .vxt-post__image' => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $imageBottomSpaceMobile, $attr['imageBottomSpaceUnit'] ),
				],
				' .vxt-post__inner-wrap .vxt-post__title' => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $titleBottomSpaceMobile, $attr['titleBottomSpaceUnit'] ),
				],
				' .vxt-post__inner-wrap .vxt-post-grid-byline' => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $metaBottomSpaceMobile, $attr['metaBottomSpaceUnit'] ),
				],
				' .vxt-post__inner-wrap .vxt-post__excerpt' => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $excerptBottomSpaceMobile, $attr['excerptBottomSpaceUnit'] ),
				],
				'.is-grid .vxt-post__inner-wrap'         => array_merge(
					[
						'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $paddingTopMobile, $attr['mobilePaddingUnit'] ),
						'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $paddingBottomMobile, $attr['mobilePaddingUnit'] ),
						'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $paddingLeftMobile, $attr['mobilePaddingUnit'] ),
						'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $paddingRightMobile, $attr['mobilePaddingUnit'] ),
					],
					$overallBorderCssMobile
				),
				'.is-grid.vxt-post__items'               => [
					'row-gap'    => \Vexaltrix\Support\Helper::getCssValue( $rowGapMobile, $attr['rowGapUnit'] ),
					'column-gap' => \Vexaltrix\Support\Helper::getCssValue( $columnGapMobile, $attr['columnGapUnit'] ),
				],
				':not(.is-grid).vxt-post__items article' => [
					'padding-right' => \Vexaltrix\Support\Helper::getCssValue( (int) ( $rowGapMobile / 2 ), $attr['rowGapUnit'] ),
					'padding-left'  => \Vexaltrix\Support\Helper::getCssValue( (int) ( $rowGapMobile / 2 ), $attr['rowGapUnit'] ),
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( ( $columnGapMobile ), $attr['columnGapUnit'] ),
				],
				':not(.is-grid).vxt-post__items'         => [
					'margin-right' => \Vexaltrix\Support\Helper::getCssValue( ( - (int) $rowGapMobile / 2 ), $attr['rowGapUnit'] ),
					'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( ( - (int) $rowGapMobile / 2 ), $attr['rowGapUnit'] ),
				],
				'.is-grid .vxt-post__inner-wrap .vxt-post__image:first-child' => [
					'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( - (int) ( $paddingLeftMobile ), $attr['mobilePaddingUnit'] ),
					'margin-right' => \Vexaltrix\Support\Helper::getCssValue( - (int) ( $paddingRightMobile ), $attr['mobilePaddingUnit'] ),
					'margin-top'   => \Vexaltrix\Support\Helper::getCssValue( - (int) ( $paddingTopMobile ), $attr['mobilePaddingUnit'] ),
				],
				':not(.is-grid) .vxt-post__inner-wrap .vxt-post__text:last-child' => [
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $paddingBottomMobile, $attr['mobilePaddingUnit'] ),
				],
				':not(.is-grid) .vxt-post__inner-wrap .vxt-post__text:first-child' => [
					'margin-top' => \Vexaltrix\Support\Helper::getCssValue( $paddingTopMobile, $attr['mobilePaddingUnit'] ),
				],
				':not(.is-grid).vxt-post__image-position-background .vxt-post__inner-wrap .vxt-post__text:nth-last-child(2) ' => [
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $paddingBottomMobile, $attr['mobilePaddingUnit'] ),
				],
				':not(.is-grid) .vxt-post__inner-wrap > .vxt-post__text:not(.highlighted)' => [
					'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( $paddingLeftMobile, $attr['mobilePaddingUnit'] ),
					'margin-right' => \Vexaltrix\Support\Helper::getCssValue( $paddingRightMobile, $attr['mobilePaddingUnit'] ),
				],
				':not(.is-grid) .vxt-post__inner-wrap .vxt-post__text:first-child' => [
					'margin-top' => \Vexaltrix\Support\Helper::getCssValue( $paddingTopMobile, $attr['mobilePaddingUnit'] ),
				],
		...
		public static function getPostTabletSelectors( $attr ) {
			...
			$tSelector = [
				...
				' .vxt-post__inner-wrap .vxt-post__text.vxt-post__cta' => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $ctaBottomSpaceTablet, $attr['ctaBottomSpaceUnit'] ),
				],
				' .vxt-post__inner-wrap .vxt-post__image' => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $imageBottomSpaceTablet, $attr['imageBottomSpaceUnit'] ),
				],
				' .vxt-post__inner-wrap .vxt-post__title' => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $titleBottomSpaceTablet, $attr['titleBottomSpaceUnit'] ),
				],
				' .vxt-post__inner-wrap .vxt-post-grid-byline' => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $metaBottomSpaceTablet, $attr['metaBottomSpaceUnit'] ),
				],
				' .vxt-post__inner-wrap .vxt-post__excerpt' => [
					'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $excerptBottomSpaceTablet, $attr['excerptBottomSpaceUnit'] ),
				],
				'.is-grid .vxt-post__inner-wrap'         => array_merge(
					[
						'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $paddingTopTablet, $attr['tabletPaddingUnit'] ),
						'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $paddingBottomTablet, $attr['tabletPaddingUnit'] ),
						'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $paddingLeftTablet, $attr['tabletPaddingUnit'] ),
						'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $paddingRightTablet, $attr['tabletPaddingUnit'] ),
					],
					$overallBorderCssTablet
				),
				'.is-grid.vxt-post__items'               => [
					'row-gap'    => \Vexaltrix\Support\Helper::getCssValue( $rowGapTablet, $attr['rowGapUnit'] ),
					'column-gap' => \Vexaltrix\Support\Helper::getCssValue( $columnGapTablet, $attr['columnGapUnit'] ),
				],
				':not(.is-grid).vxt-post__items article' => [
					'padding-right' => \Vexaltrix\Support\Helper::getCssValue( (int) ( $rowGapTablet / 2 ), $attr['rowGapUnit'] ),
					'padding-left'  => \Vexaltrix\Support\Helper::getCssValue( (int) ( $rowGapTablet / 2 ), $attr['rowGapUnit'] ),
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( ( $columnGapTablet ), $attr['columnGapUnit'] ),
				],
				':not(.is-grid).vxt-post__items'         => [
					'margin-right' => \Vexaltrix\Support\Helper::getCssValue( ( - (int) $rowGapTablet / 2 ), $attr['rowGapUnit'] ),
					'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( ( - (int) $rowGapTablet / 2 ), $attr['rowGapUnit'] ),
				],
				'.is-grid .vxt-post__inner-wrap .vxt-post__image:first-child' => ! $isLeftRight ? [
					'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( - (int) ( $paddingLeftTablet ), $attr['tabletPaddingUnit'] ),
					'margin-right' => \Vexaltrix\Support\Helper::getCssValue( - (int) ( $paddingRightTablet ), $attr['tabletPaddingUnit'] ),
					'margin-top'   => \Vexaltrix\Support\Helper::getCssValue( - (int) ( $paddingTopTablet ), $attr['tabletPaddingUnit'] ),
				] : [],
				':not(.is-grid) .vxt-post__inner-wrap .vxt-post__text:last-child' => [
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $paddingBottomTablet, $attr['tabletPaddingUnit'] ),
				],
				':not(.is-grid) .vxt-post__inner-wrap .vxt-post__text:first-child' => [
					'margin-top' => \Vexaltrix\Support\Helper::getCssValue( $paddingTopTablet, $attr['tabletPaddingUnit'] ),
				],
				':not(.is-grid).vxt-post__image-position-background .vxt-post__inner-wrap .vxt-post__text:nth-last-child(2) ' => [
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $paddingBottomTablet, $attr['tabletPaddingUnit'] ),
				],
				':not(.is-grid) .vxt-post__inner-wrap .vxt-post__text:not(.highlighted)' => [
					'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( $paddingLeftTablet, $attr['tabletPaddingUnit'] ),
					'margin-right' => \Vexaltrix\Support\Helper::getCssValue( $paddingRightTablet, $attr['tabletPaddingUnit'] ),
				],
				':not(.is-grid) .vxt-post__inner-wrap .vxt-post__text:first-child' => [
					'margin-top' => \Vexaltrix\Support\Helper::getCssValue( $paddingTopTablet, $attr['tabletPaddingUnit'] ),
				],
				...
				$tSelector = array_merge(
					...
					[
						...
						' .vxt-post__cta a' => array_merge(
							[
								'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $paddingBtnTopTablet, $attr['tabletPaddingBtnUnit'] ),
								'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $paddingBtnBottomTablet, $attr['tabletPaddingBtnUnit'] ),
								'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $paddingBtnLeftTablet, $attr['tabletPaddingBtnUnit'] ),
								'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $paddingBtnRightTablet, $attr['tabletPaddingBtnUnit'] ),
							],
							$borderCssTablet
						),
					]
		...
		public static function getTimelineSelectors( $attr ) {
			...
			$connectorSize      = \Vexaltrix\Support\Helper::getCssValue( $connectorBgSizeFallback, 'px' );
			...
			$selectors           = [
				' .vxt-timeline__heading'               => [
					'margin-top'    => \Vexaltrix\Support\Helper::getCssValue( $headTopSpacingFallback, 'px' ),
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $headSpaceFallback, 'px' ),
				...
				' .vxt-timeline__line'                  => [
					...
					'width'            => \Vexaltrix\Support\Helper::getCssValue( $separatorWidthFallback, 'px' ),
				],
				...
				'.vxt-timeline__center-block .vxt-timeline__left .vxt-timeline__marker' => [
					'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( $leftMargin, $attr['marginUnit'] ),
					'margin-right' => \Vexaltrix\Support\Helper::getCssValue( $rightMargin, $attr['marginUnit'] ),
				],
				...
				' .vxt-timeline__date-hide.vxt-timeline__inner-date-new' => [ // For New User.
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $dateBottomSpaceFallback, 'px' ),
				...
				' .vxt-timeline__events-inner-new'      => [
					...
					'border-radius'    => \Vexaltrix\Support\Helper::getCssValue( $borderRadiusFallback, 'px' ),
				],
				...
				' svg'                                   => [
					...
					'font-size' => \Vexaltrix\Support\Helper::getCssValue( $iconSizeFallback, 'px' ),
					'width'     => \Vexaltrix\Support\Helper::getCssValue( $iconSizeFallback, 'px' ),
					'fill'      => $attr['iconColor'],
				],
		...
		public static function getTimelineTabletSelectors( $attr ) {
			...
			$tabletSelector = [
				' .vxt-timeline__heading'               => [
					'margin-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['headTopSpacingTablet'], 'px' ),
				...
				'.vxt-timeline__center-block .vxt-timeline__day-new.vxt-timeline__day-left' => [
					'margin-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['leftMarginTablet'], $attr['tabletMarginUnit'] ),
					'margin-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['rightMarginTablet'], $attr['tabletMarginUnit'] ),
					'margin-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['topMarginTablet'], $attr['tabletMarginUnit'] ),
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['bottomMarginTablet'], $attr['tabletMarginUnit'] ),
				],
		...
		public static function getTimelineMobileSelectors( $attr ) {
			...
			$mSelectors = [
				' .vxt-timeline__heading'               => [
					'margin-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['headTopSpacingMobile'], 'px' ),
				...
				' .vxt-timeline__center-block .vxt-timeline__day-new.vxt-timeline__day-left' => [
					'margin-left' => \Vexaltrix\Support\Helper::getCssValue( $attr['horizontalSpace'], 'px' ),
				],
				' .vxt-timeline__center-block .vxt-timeline__day-new.vxt-timeline__day-right' => [
					'margin-left' => \Vexaltrix\Support\Helper::getCssValue( $attr['horizontalSpace'], 'px' ),
				],
				...
				'.vxt-timeline__center-block .vxt-timeline__day-new.vxt-timeline__day-left' => [
					'margin-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['leftMarginMobile'], $attr['mobileMarginUnit'] ),
					'margin-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['rightMarginMobile'], $attr['mobileMarginUnit'] ),
					'margin-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['topMarginMobile'], $attr['mobileMarginUnit'] ),
					'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['bottomMarginMobile'], $attr['mobileMarginUnit'] ),
				],
				'.vxt-timeline__center-block .vxt-timeline__day-new.vxt-timeline__day-right' => [
					'margin-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['leftMarginMobile'], $attr['mobileMarginUnit'] ),
					'margin-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['rightMarginMobile'], $attr['mobileMarginUnit'] ),
				...
				if ( isset( $attr['masonryGutter'] ) && '' !== $attr['masonryGutter'] ) {
					$selectors = [
						'.wp-block-gallery.has-nested-images.columns-' . $colCount => [
							'column-gap' => \Vexaltrix\Support\Helper::getCssValue( $attr['masonryGutter'], 'px' ),
						],
						'.wp-block-gallery.has-nested-images.columns-default' => [
							'column-gap' => \Vexaltrix\Support\Helper::getCssValue( $attr['masonryGutter'], 'px' ),
						],
						'.wp-block-gallery.has-nested-images figure.wp-block-image:not(#individual-image) img' => [
							'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['masonryGutter'], 'px' ),
						],
		...
		public static function getMasonryGalleryCss() {
			...
			$css = \Vexaltrix\Support\Helper::generateAllCss( $combinedSelectors, '.uag-masonry' );
		...
		public static function uagGetBackgroundObj( $bgObj, $cssForOverlay = '' ) {
			...
			$customXPosition = \Vexaltrix\Support\Helper::getCssValue( $xPosition, $xPositionType );
			$customYPosition = \Vexaltrix\Support\Helper::getCssValue( $yPosition, $yPositionType );
		...
		public static function uagGenerateBorderCss( $attr, $prefix, $device = 'desktop' ) {
			...
			if ( 'none' !== $attr[ $prefix . 'BorderStyle' ] && ! empty( $attr[ $prefix . 'BorderStyle' ] ) ) {
				$genBorderCss['border-top-width']    = \Vexaltrix\Support\Helper::getCssValue( $attr[ $prefix . 'BorderTopWidth' . $device ], 'px' );
				$genBorderCss['border-left-width']   = \Vexaltrix\Support\Helper::getCssValue( $attr[ $prefix . 'BorderLeftWidth' . $device ], 'px' );
				$genBorderCss['border-right-width']  = \Vexaltrix\Support\Helper::getCssValue( $attr[ $prefix . 'BorderRightWidth' . $device ], 'px' );
				$genBorderCss['border-bottom-width'] = \Vexaltrix\Support\Helper::getCssValue( $attr[ $prefix . 'BorderBottomWidth' . $device ], 'px' );
			}
			$genBorderUnit                                  = isset( $attr[ $prefix . 'BorderRadiusUnit' . $device ] ) ? $attr[ $prefix . 'BorderRadiusUnit' . $device ] : 'px';
				$genBorderCss['border-top-left-radius']     = \Vexaltrix\Support\Helper::getCssValue( $attr[ $prefix . 'BorderTopLeftRadius' . $device ], $genBorderUnit );
				$genBorderCss['border-top-right-radius']    = \Vexaltrix\Support\Helper::getCssValue( $attr[ $prefix . 'BorderTopRightRadius' . $device ], $genBorderUnit );
				$genBorderCss['border-bottom-left-radius']  = \Vexaltrix\Support\Helper::getCssValue( $attr[ $prefix . 'BorderBottomLeftRadius' . $device ], $genBorderUnit );
				$genBorderCss['border-bottom-right-radius'] = \Vexaltrix\Support\Helper::getCssValue( $attr[ $prefix . 'BorderBottomRightRadius' . $device ], $genBorderUnit );
		...
		public static function uagGenerateDeprecatedBorderCss( $currentCss, $borderWidth, $borderRadius, $borderColor = '', $borderStyle = '' ) {
			...
			if ( ! empty( $currentCss ) && isset( $currentCss['border-style'] ) && 'default' !== $currentCss['border-style'] ) {
				...
				$genBorderCss['border-top-width']    = ( isset( $currentCss['border-top-width'] ) && ( ! empty( $currentCss['border-top-width'] ) || 0 === $currentCss['border-top-width'] ) ) ? $currentCss['border-top-width'] : \Vexaltrix\Support\Helper::getCssValue( $borderWidth, 'px' );
				$genBorderCss['border-left-width']   = ( isset( $currentCss['border-left-width'] ) && ( ! empty( $currentCss['border-left-width'] ) || 0 === $currentCss['border-left-width'] ) ) ? $currentCss['border-left-width'] : \Vexaltrix\Support\Helper::getCssValue( $borderWidth, 'px' );
				$genBorderCss['border-right-width']  = ( isset( $currentCss['border-right-width'] ) && ( ! empty( $currentCss['border-right-width'] ) || 0 === $currentCss['border-right-width'] ) ) ? $currentCss['border-right-width'] : \Vexaltrix\Support\Helper::getCssValue( $borderWidth, 'px' );
				$genBorderCss['border-bottom-width'] = ( isset( $currentCss['border-bottom-width'] ) && ( ! empty( $currentCss['border-bottom-width'] ) || 0 === $currentCss['border-bottom-width'] ) ) ? $currentCss['border-bottom-width'] : \Vexaltrix\Support\Helper::getCssValue( $borderWidth, 'px' );

				$genBorderCss['border-top-left-radius']     = ( isset( $currentCss['border-top-left-radius'] ) && ( ! empty( $currentCss['border-top-left-radius'] ) || 0 === $currentCss['border-top-left-radius'] ) ) ? $currentCss['border-top-left-radius'] : \Vexaltrix\Support\Helper::getCssValue( $borderRadius, 'px' );
				$genBorderCss['border-top-right-radius']    = ( isset( $currentCss['border-top-right-radius'] ) && ( ! empty( $currentCss['border-top-right-radius'] ) || 0 === $currentCss['border-top-right-radius'] ) ) ? $currentCss['border-top-right-radius'] : \Vexaltrix\Support\Helper::getCssValue( $borderRadius, 'px' );
				$genBorderCss['border-bottom-left-radius']  = ( isset( $currentCss['border-bottom-left-radius'] ) && ( ! empty( $currentCss['border-bottom-left-radius'] ) || 0 === $currentCss['border-bottom-left-radius'] ) ) ? $currentCss['border-bottom-left-radius'] : \Vexaltrix\Support\Helper::getCssValue( $borderRadius, 'px' );
				$genBorderCss['border-bottom-right-radius'] = ( isset( $currentCss['border-bottom-right-radius'] ) && ( ! empty( $currentCss['border-bottom-right-radius'] ) || 0 === $currentCss['border-bottom-right-radius'] ) ) ? $currentCss['border-bottom-right-radius'] : \Vexaltrix\Support\Helper::getCssValue( $borderRadius, 'px' );
		...
		public static function generateBorderRadius( $unit, $topLeft, $topRight = null, $bottomRight = null, $bottomLeft = null ) {
			$borderRadius = ! is_null( $topRight )
				? (
					...
					? (
						! is_null( $bottomLeft )
						? \Vexaltrix\Support\Helper::getCssValue( $topLeft, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $topRight, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $bottomRight, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $bottomLeft, $unit )
						: \Vexaltrix\Support\Helper::getCssValue( $topLeft, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $topRight, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $bottomRight, $unit )
					)
					: \Vexaltrix\Support\Helper::getCssValue( $topLeft, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $topRight, $unit )
				)
				: \Vexaltrix\Support\Helper::getCssValue( $topLeft, $unit );
			return $borderRadius;
		}
		...
		public static function generateSpacing( $unit, $top, $right = null, $bottom = null, $left = null ) {
			$spacing = ! is_null( $right )
				? (
					...
					? (
						! is_null( $left )
						? \Vexaltrix\Support\Helper::getCssValue( $top, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $right, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $bottom, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $left, $unit )
						: \Vexaltrix\Support\Helper::getCssValue( $top, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $right, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $bottom, $unit )
					)
					: \Vexaltrix\Support\Helper::getCssValue( $top, $unit ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $right, $unit )
				)
				: \Vexaltrix\Support\Helper::getCssValue( $top, $unit );
			return $spacing;
		}
		...
		public static function generateShadowCss( $shadowProperties ) {
			...
			$horizontal = \Vexaltrix\Support\Helper::getCssValue( $horizontal, $horizontalUnit );
			if ( '' === $horizontal ) {
				$horizontal = 0;
			}

			$vertical = \Vexaltrix\Support\Helper::getCssValue( $vertical, $verticalUnit );
			if ( '' === $vertical ) {
				$vertical = 0;
			}

			$blur = \Vexaltrix\Support\Helper::getCssValue( $blur, $blurUnit );
			if ( '' === $blur ) {
				$blur = 0;
			}

			$spread = \Vexaltrix\Support\Helper::getCssValue( $spread, $spreadUnit );
			if ( '' === $spread ) {
				$spread = 0;
			}
