 ...
 */
function vxt_ugb() {
	return \Vexaltrix\Core\Plugin::getInstance();
}
...
if ( ! function_exists( 'uagb' ) ) {
	/**
	 * Backwards-compatibility wrapper for uagb() if not already defined.
	 *
	 * @since x.x.x
	 *
	 * @return object
 ...
 *
 * @param int $postId current step ID.
 * @since 2.0.0
 */
function vxt_ultimate_gutenberg_blocks_get_post_assets( $postId ) {
...
/**
 * Get Vexaltrix Font Awesome Polyfiller.
 *
 * @since 2.0.0
 */
function vxt_get_vexaltrix_font_awesome_polyfiller() {

	$fontAwesome5Polyfiller = [
		'ad'                                  => 'rectangle-ad',
	...
	return $fontAwesome5Polyfiller;
}

if ( ! function_exists( 'get_vexaltrix_font_awesome_polyfiller' ) ) {
	/**
	 * Backwards-compatibility wrapper for get_vexaltrix_font_awesome_polyfiller() if not already defined.
	 *
	 * @return array
	 */
	function get_vexaltrix_font_awesome_polyfiller() {
		return vxt_get_vexaltrix_font_awesome_polyfiller();
	}
}
