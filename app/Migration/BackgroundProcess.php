...
if ( ! class_exists( 'Vexaltrix\\Migration\\BackgroundProcess' ) ) {

	/**
	 * Class \Vexaltrix\Migration\BackgroundProcess
	 *
	...
	class BackgroundProcess extends WP_Background_Process {
		...
		protected function task( $postId ) {
			...
			$migrationDetails = \Vexaltrix\Migration\MigrateBlocks::getInstance()->getUpdatedContent( $post->post_content );
