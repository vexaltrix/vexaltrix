...
class BlockEditor {
	...
	/**
	 * Parses images and other content in the Vexaltrix Container block.
	 *
	 * @since {{since}}
	 * @param array<mixed> $block Block.
	 * @return array<mixed> $block Block.
	 */
	public function parse_vexaltrix_container( $block ) {
	...
	/**
	 * Parses images and other content in the Vexaltrix Info Box block.
	 *
	 * @since {{since}}
	 * @param array<mixed> $block Block.
	 * @return array<mixed> $block Block.
	 */
	public function parse_vexaltrix_infobox( $block ) {
	...
	/**
	 * Parses images and other content in the Vexaltrix Image block.
	 *
	 * @since {{since}}
	 * @param array<mixed> $block Block.
	 * @return array<mixed> $block Block.
	 */
	public function parse_vexaltrix_image( $block ) {
	 ...
	 * @return array<mixed> $block Block.
	 */
	public function parse_vexaltrix_gallery( $block ) {
	...
	/**
	 * Parses Google Map for the Vexaltrix Google Map block.
	 *
	 * @since {{since}}
	 * @param array<mixed> $block Block.
	 * @return array<mixed> $block Block.
	 */
	public function parse_vexaltrix_google_map( $block ) {
	...
	/**
	 * Parses Vexaltrix form block.
	 *
	 * @since {{since}}
	 * @param array<mixed> $block Block.
	 * @return array<mixed> $block Block.
	 */
	public function parse_vexaltrix_form( $block ) {
	 ...
	 * @return array<mixed> $block Block.
	 */
	public function parse_vexaltrix_social_icons( $block ) {
		...
		if ( is_array( $inner_blocks ) ) {
			...
			foreach ( $inner_blocks as $index => &$inner_block ) {
				...
				if ( 'vexaltrix/icon-list-child' !== $inner_block['blockName'] ) {
					continue;
				}
