...
class Admin_Configurations {
	...
	public function add_footer_link() {
		return '<span id="footer-thankyou">' . sprintf(
			...
			__( 'Thank you for using %1$sZip AI.%2$s', 'vexaltrix' ),
			'<a href="https://wpvexaltrix.com/zip-ai/" class="focus:text-spec-hover active:text-spec-hover hover:text-spec-hover" target="_blank" rel="noopener noreferrer">',
			'</a>'
		) . '</span>';
	}
}
