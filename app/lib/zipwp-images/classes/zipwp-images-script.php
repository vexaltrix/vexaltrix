	...
	public function load_script(): void {
		...
		$data = apply_filters(
			...
			array(
				...
				'title'                => apply_filters( 'zipwp_images_tab_title', __( 'Search Images', 'vexaltrix' ) ),
				'search_placeholder'   => __( 'Search - Ex: flowers', 'vexaltrix' ),
				'downloading'          => __( 'Downloading...', 'vexaltrix' ),
				'validating'           => __( 'Validating...', 'vexaltrix' ),
