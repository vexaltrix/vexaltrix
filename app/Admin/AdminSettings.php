...
if ( ! class_exists( 'Vexaltrix\\Admin\\AdminSettings' ) ) {

	/**
	 * Class \Vexaltrix\Admin\AdminSettings.
	 */
	final class AdminSettings {
		...
		public static function getBlockOptions() {
			...
			$blocks       = \Vexaltrix\Support\Helper::$blockList;
			...
			\Vexaltrix\Support\Helper::$blockList = is_array( $blocks ) ? $blocks : [];

			return apply_filters( 'vxt_ultimate_gutenberg_blocks_enabled_blocks', \Vexaltrix\Support\Helper::$blockList );
		}
	...
	/**
	 *  Prepare if class 'Vexaltrix\\Admin\\AdminSettings' exist.
