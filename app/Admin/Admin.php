...
if ( ! class_exists( 'Vexaltrix\\Admin\\Admin' ) ) {

	/**
	 * Class \Vexaltrix\Admin\Admin.
	 */
	final class Admin {
		...
		public function handleMigrationActionAjax() {
			...
			\Vexaltrix\Migration\MigrateBlocks::getInstance()->blocksMigration();
		...
		public function updateGutenbergTemplatesProUrl() { 
			return \Vexaltrix\Admin\AdminSettings::getProUrl( '/pricing/', 'gutenberg-templates', 'dashboard', 'Starter-Template-Backend' );
		}
		...
		public function postVxtUltimateGutenbergBlocksRollback() {
			...
			$rollback = new \Vexaltrix\Admin\Rollback(
				[
				...
				\VexaltrixAdminNotices::add_notice(
					[
						...
						'message'                    => sprintf(
							...
							esc_url( \Vexaltrix\Admin\AdminSettings::getProUrl( '/pricing/', 'free-plugin', 'popup-builder', 'popup-builder-banner' ) ),
						...
						document.addEventListener('DOMContentLoaded', function() {
							...
							if (upgradeLink) {
								...
								upgradeLink.addEventListener('click', function(e) {
									e.preventDefault();
									window.open( '<?php echo esc_url( \Vexaltrix\Admin\AdminSettings::getProUrl( '/pricing/', 'free-plugin', 'dashboard', 'setting' ) ); ?>', '_blank', 'noopener,noreferrer' );
								});
							}
						});
					</script>
