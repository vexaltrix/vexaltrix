...
/**
 * \Vexaltrix\Admin\AdminLearn class.
 *
 * @since 3.0.0
 */
class AdminLearn {
			...
			[
				...
				'steps'       => [
					...
					[
						...
						'action'      => [
							'label'      => __( 'Set Up', 'vexaltrix' ),
							'url'        => ( 'yes' === \Vexaltrix\Admin\AdminSettings::get( 'uag_enable_templates_button', 'yes' ) ? $homepageUrl . '#learn-insert-ready-made-sections' : admin_url( 'admin.php?page=vexaltrix&path=settings&settings=editor-enhancements' ) ),
							'isExternal' => true,
						],
						'completed'   => false,
					],
