...
if ( ! class_exists( 'Vexaltrix\\Support\\Helper' ) ) {
	...
	/**
	 * Class \Vexaltrix\Support\Helper.
	 */
	final class Helper {
		...
		public function __construct() {
			class_exists( 'Vexaltrix\\Core\\Blocks\\BlockHelper' );
			class_exists( 'Vexaltrix\\Core\\Blocks\\BlockJs' );
		...
		public function initializeBlockList() {
			self::$blockList = \Vexaltrix\Core\Blocks\BlockModule::getBlocksInfo();
		}
		...
		public static function getQuery( $attributes, $blockType ) {
			$fallbackForPostsToShow = \Vexaltrix\Core\Blocks\BlockHelper::getFallbackNumber( $attributes['postsToShow'], 'postsToShow', $attributes['blockName'] );
			$fallbackForOffset        = \Vexaltrix\Core\Blocks\BlockHelper::getFallbackNumber( $attributes['postsOffset'], 'postsOffset', $attributes['blockName'] );
		...
		public function getBlockCssAndJs( $block ) {
			...
			if ( strpos( $name, 'vexaltrix/' ) !== false ) {
				...
				$blockJs      = \Vexaltrix\Core\Blocks\BlockModule::getFrontendJs( $blockSlug, $blockattr, $blockId );
