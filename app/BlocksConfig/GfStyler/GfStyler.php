...
namespace Vexaltrix\BlocksConfig\GfStyler;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

if ( ! class_exists( 'Vexaltrix\\BlocksConfig\\GfStyler\\GfStyler' ) ) {

	/**
	 * Class \Vexaltrix\BlocksConfig\GfStyler\GfStyler.
	 */
	class GfStyler {
	...
	/**
	 *  Prepare if class 'Vexaltrix\\BlocksConfig\\GfStyler\\GfStyler' exist.
