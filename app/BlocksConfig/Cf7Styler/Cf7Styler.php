...
namespace Vexaltrix\BlocksConfig\Cf7Styler;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

if ( ! class_exists( 'Vexaltrix\\BlocksConfig\\Cf7Styler\\Cf7Styler' ) ) {

	/**
	 * Class \Vexaltrix\BlocksConfig\Cf7Styler\Cf7Styler.
	 */
	class Cf7Styler {
		...
		public function registerBlocks() {
			...
			if ( method_exists( 'Vexaltrix\\Core\\Blocks\\BlockHelper', 'uagGeneratePhpBorderAttribute' ) ) {
				...
				$fieldBorderAttribute = \Vexaltrix\Core\Blocks\BlockHelper::uagGeneratePhpBorderAttribute( 'input' );
	...
	/**
	 *  Prepare if class 'Vexaltrix\\BlocksConfig\\Cf7Styler\\Cf7Styler' exist.
