...
namespace Vexaltrix\BlocksConfig\Forms;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

if ( ! class_exists( 'Vexaltrix\\BlocksConfig\\Forms\\Forms' ) ) {

	/**
	 * Class \Vexaltrix\BlocksConfig\Forms\Forms.
	 */
	class Forms {
	...
	/**
	 *  Prepare if class 'Vexaltrix\\BlocksConfig\\Forms\\Forms' exist.
