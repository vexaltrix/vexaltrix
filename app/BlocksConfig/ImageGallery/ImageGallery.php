...
namespace Vexaltrix\BlocksConfig\ImageGallery;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

if ( ! class_exists( 'Vexaltrix\\BlocksConfig\\ImageGallery\\ImageGallery' ) ) {

	/**
	 * Class \Vexaltrix\BlocksConfig\ImageGallery\ImageGallery.
	 */
	final class ImageGallery {
		...
		public function registerImageGallery() {
			...
			if ( method_exists( 'Vexaltrix\\Core\\Blocks\\BlockHelper', 'uagGeneratePhpBorderAttribute' ) ) {
				$arrowBorderAttributes      = \Vexaltrix\Core\Blocks\BlockHelper::uagGeneratePhpBorderAttribute(
					'arrow',
					[
						'borderStyle'             => 'none',
						'borderTopWidth'          => 4,
				...
				$btnBorderAttributes        = \Vexaltrix\Core\Blocks\BlockHelper::uagGeneratePhpBorderAttribute( 'btn' );
				$imageBorderAttributes      = \Vexaltrix\Core\Blocks\BlockHelper::uagGeneratePhpBorderAttribute( 'image' );
				$mainTitleBorderAttributes = \Vexaltrix\Core\Blocks\BlockHelper::uagGeneratePhpBorderAttribute(
					'mainTitle',
					[
						'borderTopWidth'    => 2,
						'borderRightWidth'  => 0,
						...
						<div class='vexaltrix-image-gallery__control-lightbox' tabindex='0'>
							...
							<?php if ( $attributes['lightboxCloseIcon'] ) : ?>
								<button class='vexaltrix-image-gallery__control-lightbox--close' aria-label="Close">
									<?php \Vexaltrix\Support\Helper::renderSvgHtml( $attributes['lightboxCloseIcon'] ); ?>
								</button>
							<?php endif; ?>
						</div>
					<?php endif; ?>
		...
		private function renderMediaThumbnail( $mediaArray, $atts ) {
			...
			if ( 'bar-outside' === $atts['captionDisplayType'] && ( 'top' === \Vexaltrix\Core\Blocks\BlockHelper::getMatrixAlignment( $atts['imageCaptionAlignment'], 1 ) ) && $atts['imageDisplayCaption'] ) {
				?>
	...
	/**
	 *  Prepare if class 'Vexaltrix\\BlocksConfig\\ImageGallery\\ImageGallery' exist.
