...
namespace Vexaltrix\BlocksConfig\Lottie;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

if ( ! class_exists( 'Vexaltrix\\BlocksConfig\\Lottie\\Lottie' ) ) {

	/**
	 * Class \Vexaltrix\BlocksConfig\Lottie\Lottie.
	 *
	 * @since 1.20.0
	 */
	class Lottie {
	...
	/**
	 *  Prepare if class 'Vexaltrix\\BlocksConfig\\Lottie\\Lottie' exist.
