...
if ( ! class_exists( 'Vexaltrix\Integration\Compatibility\\FseFontsCompatibility' ) ) {

	/**
	 * Class \Vexaltrix\Integration\Compatibility\FseFontsCompatibility.
	 *
	 * @since 2.5.1
	 */
	final class FseFontsCompatibility implements ServiceInterface {
		...
		public function getFontFamilyForStarterTemplate( $families ) {
			...
			\Vexaltrix\Presentation\Admin\AdminSettings::updateAdminSettingsOption( 'vexaltrix_global_fse_fonts', $newFontFamilies );
		}
		...
		public static function deleteThemeFontFamily( $font ) {
			...
			\Vexaltrix\Presentation\Admin\AdminSettings::updateAdminSettingsOption( 'vexaltrix_global_fse_fonts', $vexaltrixGlobalFseFonts );
