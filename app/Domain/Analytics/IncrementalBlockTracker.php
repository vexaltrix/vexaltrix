...
if ( ! class_exists( 'Vexaltrix\Domain\Analytics\\IncrementalBlockTracker' ) ) {

	/**
	 * Class \Vexaltrix\Domain\Analytics\IncrementalBlockTracker
	 *
	...
	class IncrementalBlockTracker {
		 ...
		 * Member Variable
		 *
		 * @var \Vexaltrix\Domain\Analytics\IncrementalBlockTracker|null
		 * @since 2.19.13
		 */
		 ...
		 *
		 * @since 2.19.13
		 * @return \Vexaltrix\Domain\Analytics\IncrementalBlockTracker
		 */
		...
		public function trackBlockChangesOnSave( $postId, $post ) {
			...
			if ( $hadVexaltrix !== $hasVexaltrix && class_exists( 'Vexaltrix\Domain\Analytics\\DailyKpiCounters' ) ) {
				\Vexaltrix\Domain\Analytics\DailyKpiCounters::adjustPagesWithVexaltrix( $hasVexaltrix ? 1 : -1 );
			}
		}
		...
		public function trackBlockRemovalOnDelete( $postId ) {
			...
			if ( $this->hasVexaltrixBlocks( $previousBlocks ) && class_exists( 'Vexaltrix\Domain\Analytics\\DailyKpiCounters' ) ) {
				\Vexaltrix\Domain\Analytics\DailyKpiCounters::adjustPagesWithVexaltrix( -1 );
			}
		}
		...
		public function trackBlockAdditionOnUntrash( $postId ) {
			...
			if ( $this->hasVexaltrixBlocks( $currentBlocks ) && class_exists( 'Vexaltrix\Domain\Analytics\\DailyKpiCounters' ) ) {
				\Vexaltrix\Domain\Analytics\DailyKpiCounters::adjustPagesWithVexaltrix( 1 );
			}
		}
		...
		public function initializeExistingPosts() {
			...
			if ( $newlyAddedPages > 0 && class_exists( 'Vexaltrix\Domain\Analytics\\DailyKpiCounters' ) ) {
				\Vexaltrix\Domain\Analytics\DailyKpiCounters::adjustPagesWithVexaltrix( $newlyAddedPages );
			}
		}
