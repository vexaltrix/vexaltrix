...
if ( ! class_exists( 'Vexaltrix\Domain\Analytics\\DailyKpiCounters' ) ) {

	/**
	 * Class \Vexaltrix\Domain\Analytics\DailyKpiCounters
	 *
	 * @since 2.19.25
	 */
	class DailyKpiCounters {
		 ...
		 * Singleton instance.
		 *
		 * @var \Vexaltrix\Domain\Analytics\DailyKpiCounters|null
		 * @since 2.19.25
		 */
		 ...
		 *
		 * @since 2.19.25
		 * @return \Vexaltrix\Domain\Analytics\DailyKpiCounters
		 */
		 ...
		 *
		 * Runs after `\Vexaltrix\Domain\Analytics\IncrementalBlockTracker::trackBlockChangesOnSave()`
		 ...
		 *
		 * Maintained incrementally by {@see \Vexaltrix\Domain\Analytics\IncrementalBlockTracker}.
		 * Replaces the 180-day postmeta scan previously used in
		 * {@see \Vexaltrix\Domain\Analytics\BlockAnalytics::getSiteActivityLevel()}.
		 *
		 * @since 2.19.25
		 * @return int
		 */
