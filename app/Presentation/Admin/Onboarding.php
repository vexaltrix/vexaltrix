...
if ( ! class_exists( 'Vexaltrix\Presentation\Admin\\Onboarding' ) ) {

	/**
	 * Class \Vexaltrix\Presentation\Admin\Onboarding.
	 *
	 * @since 2.19.23
	 */
	class Onboarding implements ServiceInterface {

		/**
		 * Instance.
		 *
		 * @var \Vexaltrix\Presentation\Admin\Onboarding|null
		 * @since 2.19.23
		 */
		 ...
		 *
		 * @since 2.19.23
		 * @return \Vexaltrix\Presentation\Admin\Onboarding
		 */
