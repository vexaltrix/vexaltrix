...
/**
 * Class \Vexaltrix\Presentation\Admin\Dashboard.
 */
class Dashboard implements ServiceInterface {
	...
	public function addActionLinks( $links ) {
		...
		$vexaltrixPro = \Vexaltrix\Presentation\Admin\AdminSettings::getProUrl( '/pricing/', 'free-plugin', 'plugin-list', 'plugin-list' );
	...
	public function stylesScripts() {
		...
		$localize = apply_filters(
			...
			[
				...
				'vxt_links'                   => [
					'baseUrl'                => VXT_URI,
					'docsUrl'                => \Vexaltrix\Presentation\Admin\AdminSettings::getProUrl( '/docs/', 'free-plugin', 'vxt-dashboard', 'documentation' ),
					'docsCategoryDynamicUrl' => \Vexaltrix\Presentation\Admin\AdminSettings::getProUrl( '/docs-category/{{category}}', 'free-plugin', 'vxt-dashboard', 'documentation' ),
					'vipPrioritySupportUrl'  => \Vexaltrix\Presentation\Admin\AdminSettings::getProUrl( '/vip-priority-support/', 'free-plugin', 'vxt-dashboard', 'vip-priority-support' ),
					'templatesUrl'           => \Vexaltrix\Presentation\Admin\AdminSettings::getProUrl( '/pricing/', 'free-plugin', 'vxt-dashboard', 'starter-templates' ),
					'banner'                 => \Vexaltrix\Presentation\Admin\AdminSettings::getProUrl( '/pricing/', 'free-plugin', 'vxt-dashboard', 'banner' ),
					'topBar'                 => '',//\Vexaltrix\Presentation\Admin\AdminSettings::getProUrl( '/pricing/', 'free-plugin', 'vxt-dashboard', 'top-bar' ),
					'freeVsPro'              => \Vexaltrix\Presentation\Admin\AdminSettings::getProUrl( '/pricing/', 'free-plugin', 'vxt-dashboard', 'free-vs-pro' ),
					'setting'                => \Vexaltrix\Presentation\Admin\AdminSettings::getProUrl( '/pricing/', 'free-plugin', 'vxt-dashboard', 'setting' ),
					'uagDashboard'           => \Vexaltrix\Presentation\Admin\AdminSettings::getProUrl( '/pricing/', 'free-plugin', 'vxt-dashboard', 'uag-dashboard' ),
					'whatsNewFeedUrl'        => null, // esc_url( VXT_URI . 'whats-new/feed/' )
					'upsellModalAdmin'       => \Vexaltrix\Presentation\Admin\AdminSettings::getProUrl( '/pricing/', 'free-plugin', 'vxt-dashboard', 'upsell-popup-view-plan' ),
				],
				...
				'onboarding_completed'              => \Vexaltrix\Presentation\Admin\Onboarding::isOnboardingCompleted(),
			]
		);
