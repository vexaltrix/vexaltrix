...
namespace Vexaltrix\Presentation\BlocksConfig\TableOfContent;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

if ( ! class_exists( 'Vexaltrix\Presentation\BlocksConfig\\TableOfContent\\TableOfContent' ) ) {


	/**
	 * Class \Vexaltrix\Presentation\BlocksConfig\TableOfContent\TableOfContent.
	 */
		...
		public function renderTableOfContents( $attributes, $content, $block ) {
			...
			?>
				<div class="<?php echo esc_attr( implode( ' ', $wrap ) ); ?>"
					...
					data-offset= "<?php echo esc_attr( \Vexaltrix\Presentation\Blocks\BlockHelper::getFallbackNumber( $attributes['smoothScrollOffset'], 'smoothScrollOffset', 'table-of-contents' ) ); ?>"
				...
				<div class="vxt-toc__wrap">
						<div class="vxt-toc__title">
							...
							if ( $attributes['makeCollapsible'] && $attributes['icon'] ) {
								?>
									<?php \Vexaltrix\Core\Support\Helper::renderSvgHtml( $attributes['icon'] ); ?>
									<?php
							}
							?>
						</div>
	...
	/**
	 *  Prepare if class 'Vexaltrix\Presentation\BlocksConfig\\TableOfContent\\TableOfContent' exist.
