...
namespace Vexaltrix\Presentation\BlocksConfig\GoogleMap;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

if ( ! class_exists( 'Vexaltrix\Presentation\BlocksConfig\\GoogleMap\\GoogleMap' ) ) {

	/**
	 * Class \Vexaltrix\Presentation\BlocksConfig\GoogleMap\GoogleMap.
	 */
	class GoogleMap {
	...
	/**
	 *  Prepare if class 'Vexaltrix\Presentation\BlocksConfig\\GoogleMap\\GoogleMap' exist.
