...
namespace Vexaltrix\Presentation\BlocksConfig\Icon;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

if ( ! class_exists( 'Vexaltrix\Presentation\BlocksConfig\\Icon\\Icon' ) ) {

	/**
	 * Class \Vexaltrix\Presentation\BlocksConfig\Icon\Icon.
	 * 
	 * @since 2.12.5
	 */
	final class Icon {
		 ...
		 *
		 * @since 2.12.5
		 * @var \Vexaltrix\Presentation\BlocksConfig\Icon\Icon
		 */
		 ...
		 *
		 * @since 2.12.5
		 * @return \Vexaltrix\Presentation\BlocksConfig\Icon\Icon
		 */
		...
		public function registerIcon() {
			...
			$iconBorderAttributes = \Vexaltrix\Presentation\Blocks\BlockHelper::uagGeneratePhpBorderAttribute( 'icon' ); // @phpstan-ignore-line
		...
		public function renderVxtUltimateGutenbergBlocksIcon( $attributes ) {
			...
			ob_start();
			$iconHtml = \Vexaltrix\Core\Support\Helper::renderSvgHtml( $iconSvg );
	...
	/**
	 *  Prepare if class 'Vexaltrix\Presentation\BlocksConfig\\Icon\\Icon' exist.
