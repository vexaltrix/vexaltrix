...
namespace Vexaltrix\Presentation\BlocksConfig\PostTimeline;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

if ( ! class_exists( 'Vexaltrix\Presentation\BlocksConfig\\PostTimeline\\PostTimeline' ) ) {

	/**
	 * Class \Vexaltrix\Presentation\BlocksConfig\PostTimeline\PostTimeline.
	 */
	class PostTimeline {
		...
		public function postTimelineCallback( $attributes ) {
			...
			$recentPosts = \Vexaltrix\Core\Support\Helper::getQuery( $attributes, 'timeline' );
		...
		public function getIcon( $attributes ) {
			...
			<div class = "vxt-timeline__marker vxt-timeline__out-view-icon" >
				<span class = "vxt-timeline__icon-new vxt-timeline__out-view-icon" ><?php \Vexaltrix\Core\Support\Helper::renderSvgHtml( $attributes['icon'] ); ?></span>
			</div>
			<?php
		}
		...
		public function getTitle( $attributes ) {
			...
			$tag                   = \Vexaltrix\Core\Support\Helper::titleTagAllowedHtml( $attributes['headingTag'], $arrayOfAllowedHTML, 'h3' );
			global $post;
			?>
		...
		public function getExcerpt( $attributes ) {
			...
			$excerptLengthFallback = \Vexaltrix\Presentation\Blocks\BlockHelper::getFallbackNumber( $attributes['exerptLength'], 'exerptLength', $attributes['blockName'] );
	...
	/**
	 *  Prepare if class 'Vexaltrix\Presentation\BlocksConfig\\PostTimeline\\PostTimeline' exist.
