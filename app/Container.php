...
class Container {
	...
	private function resolve( string $class ) {
		...
		if ( ! $reflector->isInstantiable() ) {
			// If it's not normally instantiable (e.g. has private constructor), check if we can make it accessible.
		...
		// Instantiate using reflection to support private/protected constructors.
