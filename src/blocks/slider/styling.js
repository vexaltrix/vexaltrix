...
function styling( attributes, clientId, deviceType ) {
	...
	selectors = applyFilters( `vexaltrix.slider.styling`, selectors, attributes );
	tablet_selectors = applyFilters( `vexaltrix.slider.tabletStyling`, tablet_selectors, attributes );
	mobile_selectors = applyFilters( `vexaltrix.slider.mobileStyling`, mobile_selectors, attributes );
