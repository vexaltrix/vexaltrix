...
export default compose( addInitialAttr, applyWithSelect, AddStaticStyles )( VexaltrixSlider );
...
const uagbSlideClass = createHigherOrderComponent( ( BlockListBlock ) => {
	return ( props ) => {
		...
		if ( 'vexaltrix/slider-child' === props.name ) {
			const wrapperProps = {
				className: `vxt-editor-preview-mode-${ deviceType.toLowerCase() }`,
				...props.wrapperProps,
			};
...
addFilter( 'editor.BlockListBlock', 'vexaltrix/slider-child', uagbSlideClass );
