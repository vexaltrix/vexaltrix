...
const ALLOWED_BLOCKS = [ 'vexaltrix/slider-child' ];
...
const Render = ( props ) => {
	...
	doAction( `vexaltrix.slider.before_render`, sliderOption );
	...
	const { isPreview, transitionSpeed, slideItem, block_id, displayArrows, displayDots, extraClasses } = attributes;
						...
						[
							[
								'vexaltrix/info-box',
								{
									showIcon: false,
									ctaType: 'button',
									infoBoxTitle: __( 'Slide 1', 'vexaltrix' ),
									showCtaIcon: false,
									paddingBtnTop: 12,
									paddingBtnRight: 24,
									paddingBtnBottom: 12,
						...
						[
							[
								'vexaltrix/info-box',
								{
									showIcon: false,
									ctaType: 'button',
									infoBoxTitle: __( 'Slide 2', 'vexaltrix' ),
									showCtaIcon: false,
									paddingBtnTop: 12,
									paddingBtnRight: 24,
									paddingBtnBottom: 12,
						...
						[
							[
								'vexaltrix/info-box',
								{
									showIcon: false,
									ctaType: 'button',
									infoBoxTitle: __( 'Slide 3', 'vexaltrix' ),
									showCtaIcon: false,
									paddingBtnTop: 12,
									paddingBtnRight: 24,
									paddingBtnBottom: 12,
	...
	const hasChildrenClass = hasChildren ? 'vxt-slider-has-children' : '';
	const listViewClass = isListViewOpen ? 'vxt-list-view-enabled' : '';
	const blockProps = useBlockProps( {
		className: `vxt-block-${ block_id } ${ hasChildrenClass } ${ listViewClass } vxt-slider-container vxt-slider-editor-wrap vxt-editor-preview-mode-${ deviceType.toLowerCase() } ${ extraClasses }`,
	} );
	...
	useEffect( () => {
		if ( swiperInstance && swiperInstance.slides ) {
			...
			const sliderBlocks = [ 'vexaltrix/slider', 'vexaltrix/slider-child' ];
