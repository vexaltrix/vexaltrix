	...
	from: [
		...
		},
		{
			...
			transform: ( _attributes, innerBlocks ) => {
				...
				const isVexaltrixOnePaddingTopBottom =
					padding_temp_y && vexaltrixOneMapping.hasOwnProperty( padding_temp_y );
				const isVexaltrixOnePaddingLeftRight =
					padding_temp_x && vexaltrixOneMapping.hasOwnProperty( padding_temp_x );
				const isVexaltrixOneMarginTopBottom =
					margin_temp_y && vexaltrixOneMapping.hasOwnProperty( margin_temp_y );

				const vexaltrixOneTopBottomPadding = isVexaltrixOnePaddingTopBottom
					? getNumber( vexaltrixOneMapping[ padding_temp_y ] )
					: '';
				const vexaltrixOneRightLeftPadding = isVexaltrixOnePaddingLeftRight
					? getNumber( vexaltrixOneMapping[ padding_temp_x ] )
					: '';
				const vexaltrixOneTopBottomMargin = isVexaltrixOneMarginTopBottom
					? getNumber( vexaltrixOneMapping[ margin_temp_y ] )
					: '';
				...
				const borderRadiusUnit = getUnitDimension(
					( typeof _attributes?.style?.border?.radius !== 'object' && _attributes?.style?.border?.radius ) ||
						_attributes?.style?.border?.radius?.topRight ||
						_attributes?.style?.border?.radius?.topLeft ||
						_attributes?.style?.border?.radius?.bottomRight ||
						_attributes?.style?.border?.radius?.bottomLeft ||
						''
				);

				const newBorderColor =
					_attributes?.style?.border?.color ||
					colourNameToHex( _attributes?.borderColor || '' ) ||
					_attributes?.style?.border?.top?.color ||
					colourNameToHex( _attributes?.style?.border?.top?.color || '' );
				...
				const newAttributes = {
					...
					backgroundOverlayImageColor:
						_attributes?.customOverlayColor || colourNameToHex( _attributes?.overlayColor ) || '',
					backgroundImageColor:
						_attributes?.customOverlayColor || colourNameToHex( _attributes?.overlayColor ) || '#000001',
					...
					//Margin Padding
					topPaddingDesktop: isVexaltrixOnePaddingTopBottom
						? vexaltrixOneTopBottomPadding
						: getNumber( _attributes?.style?.spacing?.padding?.top || '' ),
					bottomPaddingDesktop: isVexaltrixOnePaddingTopBottom
						? vexaltrixOneTopBottomPadding
						: getNumber( _attributes?.style?.spacing?.padding?.bottom || '' ),
					leftPaddingDesktop: isVexaltrixOnePaddingLeftRight
						? vexaltrixOneRightLeftPadding
						: getNumber( _attributes?.style?.spacing?.padding?.left || '' ),
					rightPaddingDesktop: isVexaltrixOnePaddingLeftRight
						? vexaltrixOneRightLeftPadding
						: getNumber( _attributes?.style?.spacing?.padding?.right || '' ),
					topMarginDesktop: isVexaltrixOneMarginTopBottom
						? vexaltrixOneTopBottomMargin
						: getNumber( _attributes?.style?.spacing?.margin?.top || '' ),
					bottomMarginDesktop: isVexaltrixOneMarginTopBottom
						? vexaltrixOneTopBottomMargin
						: getNumber( _attributes?.style?.spacing?.margin?.bottom || '' ),
					marginType: isVexaltrixOneMarginTopBottom
						? 'px'
						: getUnit( _attributes?.style?.spacing?.margin?.top || 'px' ),
					paddingType: vexaltrixOneRightLeftPadding
						? 'px'
						: getUnit( _attributes?.style?.spacing?.padding?.top || 'px' ),
					// Border
					containerBorderTopWidth: getNumber(
						_attributes?.style?.border?.width || _attributes?.style?.border?.top?.width || ''
					),
					containerBorderBottomWidth: getNumber(
						_attributes?.style?.border?.width || _attributes?.style?.border?.bottom?.width || ''
					),
					containerBorderLeftWidth: getNumber(
						_attributes?.style?.border?.width || _attributes?.style?.border?.left?.width || ''
					),
					containerBorderRightWidth: getNumber(
						_attributes?.style?.border?.width || _attributes?.style?.border?.right?.width || ''
					),
					borderRadius: getNumber(
						( typeof _attributes?.style?.border?.radius !== 'object' &&
							_attributes?.style?.border?.radius ) ||
							_attributes?.style?.border?.radius?.topRight ||
							''
					),
					borderColor: newBorderColor,
					borderStyle:
						_attributes?.style?.border?.style ||
						( _attributes?.style?.border?.width || _attributes?.style?.border?.top?.width
							? _attributes?.style?.border?.top?.style || _attributes?.style?.border?.style || 'solid'
							: 'none' ),
					containerBorderBottomLeftRadius: getNumber(
						( typeof _attributes?.style?.border?.radius !== 'object' &&
							_attributes?.style?.border?.radius ) ||
							_attributes?.style?.border?.radius?.bottomLeft ||
							''
					),
					containerBorderBottomRightRadius: getNumber(
						( typeof _attributes?.style?.border?.radius !== 'object' &&
							_attributes?.style?.border?.radius ) ||
							_attributes?.style?.border?.radius?.bottomRight ||
							''
					),
					containerBorderTopLeftRadius: getNumber(
						( typeof _attributes?.style?.border?.radius !== 'object' &&
							_attributes?.style?.border?.radius ) ||
							_attributes?.style?.border?.radius?.topLeft ||
							''
					),
					containerBorderTopRightRadius: getNumber(
						( typeof _attributes?.style?.border?.radius !== 'object' &&
							_attributes?.style?.border?.radius ) ||
							_attributes?.style?.border?.radius?.topRight ||
							''
				...
				return createBlock( 'vexaltrix/container', newAttributes, innerBlocks );
			},
		},
	],
};
