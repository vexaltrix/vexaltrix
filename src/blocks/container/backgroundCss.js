...
const backgroundCss = ( attributes, deviceType, clientId, pseudoElementOverlay = {} ) => {
	...
	// check if 'vexaltrix/loop-builder' is present in parentBlockNames.
	const isLoopBuilderPresent = parentBlockNames.includes( 'vexaltrix/loop-builder' );

	const placeHolderImage = isLoopBuilderPresent
		? {
				type: 'image',
				url:
					vxt_ultimate_gutenberg_blocks_blocks_info.vxt_ultimate_gutenberg_blocks_url +
					'/admin/assets/images/uag-placeholder.svg',
		  }
		: '';
	const {
		backgroundType,
	...
	const backgroundAttributesTablet = {
		...
		backgroundImage: backgroundImageTablet?.url
			? backgroundImageTablet
			: backgroundAttributesDesktop.backgroundImage,
		gradientValue,
		gradientColor1,
		gradientColor2,
		gradientLocation1:
			'number' === typeof gradientLocationTablet1
				? gradientLocationTablet1
				: backgroundAttributesDesktop.gradientLocation1,
		gradientLocation2:
			'number' === typeof gradientLocationTablet2
				? gradientLocationTablet2
				: backgroundAttributesDesktop.gradientLocation2,
		gradientType,
		gradientAngle:
			'number' === typeof gradientAngleTablet ? gradientAngleTablet : backgroundAttributesDesktop.gradientAngle,
		selectGradient,
		backgroundRepeat: backgroundRepeatTablet
			? backgroundRepeatTablet
			: backgroundAttributesDesktop.backgroundRepeat,
		backgroundPosition: backgroundPositionTablet
			? backgroundPositionTablet
			: backgroundAttributesDesktop.backgroundPosition,
		...
		backgroundAttachment: backgroundAttachmentTablet
			? backgroundAttachmentTablet
			: backgroundAttributesDesktop.backgroundAttachment,
		backgroundCustomSize: backgroundCustomSizeTablet
			? backgroundCustomSizeTablet
			: backgroundAttributesDesktop.backgroundCustomSize,
		backgroundCustomSizeType,
		backgroundImageColor,
		overlayType,
		overlayOpacity,
		...
		customOverlayPosition,
		xPositionOverlay:
			'number' === typeof xPositionOverlayTablet
				? xPositionOverlayTablet
				: backgroundAttributesDesktop.xPositionOverlay,
		xPositionOverlayType: xPositionOverlayTypeTablet
			? xPositionOverlayTypeTablet
			: backgroundAttributesDesktop.xPositionOverlayType,
		yPositionOverlay:
			'number' === typeof yPositionOverlayTablet
				? yPositionOverlayTablet
				: backgroundAttributesDesktop.yPositionOverlay,
	...
	const backgroundAttributesMobile = {
		...
		backgroundImage: backgroundImageMobile?.url
			? backgroundImageMobile
			: backgroundAttributesTablet.backgroundImage,
		gradientValue,
		gradientColor1,
		gradientColor2,
		gradientLocation1:
		...
		gradientType,
		gradientAngle:
			'number' === typeof gradientAngleMobile ? gradientAngleMobile : backgroundAttributesTablet.gradientAngle,
		selectGradient,
		...
		backgroundPosition: backgroundPositionMobile
			? backgroundPositionMobile
			: backgroundAttributesTablet.backgroundPosition,
		...
		backgroundAttachment: backgroundAttachmentMobile
			? backgroundAttachmentMobile
			: backgroundAttributesTablet.backgroundAttachment,
		backgroundCustomSize: backgroundCustomSizeMobile
			? backgroundCustomSizeMobile
			: backgroundAttributesTablet.backgroundCustomSize,
		backgroundCustomSizeType,
		backgroundImageColor,
		overlayType,
		overlayOpacity,
		...
		customOverlayPosition,
		xPositionOverlay:
			'number' === typeof xPositionOverlayMobile
				? xPositionOverlayMobile
				: backgroundAttributesTablet.xPositionOverlay,
		xPositionOverlayType: xPositionOverlayTypeMobile
			? xPositionOverlayTypeMobile
			: backgroundAttributesTablet.xPositionOverlayType,
		yPositionOverlay:
			'number' === typeof yPositionOverlayMobile
				? yPositionOverlayMobile
				: backgroundAttributesTablet.yPositionOverlay,
	...
	for ( const cssProp in bgCss ) {
		...
		createCamelCase[ snakeToCamel( cssProp ) ] =
			'string' === typeof bgCss[ cssProp ] ? bgCss[ cssProp ].replace( ';', '' ) : bgCss[ cssProp ];
	}
