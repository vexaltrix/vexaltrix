...
const attributes = {
	...
	innerContentCustomWidthDesktop: {
		type: 'number',
		default: vxt_ultimate_gutenberg_blocks_blocks_info.content_width,
	},
	...
	topPaddingDesktop: {
		...
		default: vxt_ultimate_gutenberg_blocks_blocks_info.container_global_padding,
	},
	...
	rowGapDesktop: {
		...
		default: vxt_ultimate_gutenberg_blocks_blocks_info.container_elements_gap,
	},
	rowGapTablet: {
		type: 'number',
		isGBSStyle: true,
	...
	// --------------------------------------------------------------
	layout: {
		// Layout will be either grid or flex and by default it will be flex if not set.
		type: 'string',
		default: '',
	},
	gridColumnDesktop: {
