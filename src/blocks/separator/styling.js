...
function styling( attributes, clientId, name, deviceType ) {
	...
	if ( elementType === 'none' ) {
		borderStyle = {
			'.wp-block-vxt-separator .wp-block-vxt-separator__inner': {
				'margin-top': '5px',
				'margin-bottom': '5px',
				...borderCSS,
			},
		...
		borderStyle = {
			...
			'.wp-block-vxt-separator--text .wp-block-vxt-separator__inner::before': borderCSS,
			'.wp-block-vxt-separator--icon .wp-block-vxt-separator__inner::before': borderCSS,
			'.wp-block-vxt-separator--text .wp-block-vxt-separator__inner::after': borderCSS,
			'.wp-block-vxt-separator--icon .wp-block-vxt-separator__inner::after': borderCSS,
		};
		if ( elementPosition === 'left' ) {
			iconSpacingStyle[
				'.wp-block-vxt-separator .wp-block-vxt-separator__inner .wp-block-vxt-separator-element'
			] = {
	...
	if ( elementType === 'none' ) {
		...
		borderStyleTablet = {
			...
			'.wp-block-vxt-separator--text .wp-block-vxt-separator__inner::before': borderCSSTablet,
			'.wp-block-vxt-separator--icon .wp-block-vxt-separator__inner::before': borderCSSTablet,
			'.wp-block-vxt-separator--text .wp-block-vxt-separator__inner::after': borderCSSTablet,
			'.wp-block-vxt-separator--icon .wp-block-vxt-separator__inner::after': borderCSSTablet,
		};
		if ( elementPosition === 'left' ) {
	...
	if ( elementType === 'none' ) {
		...
		borderStyleMobile = {
			...
			'.wp-block-vxt-separator--text .wp-block-vxt-separator__inner::before': borderCSSMobile,
			'.wp-block-vxt-separator--icon .wp-block-vxt-separator__inner::before': borderCSSMobile,
			'.wp-block-vxt-separator--text .wp-block-vxt-separator__inner::after': borderCSSMobile,
			'.wp-block-vxt-separator--icon .wp-block-vxt-separator__inner::after': borderCSSMobile,
		};
		if ( elementPosition === 'left' ) {
