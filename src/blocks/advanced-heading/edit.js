...
const VexaltrixAdvancedHeading = ( props ) => {
	const {
		attributes,
	...
	const headingHasDynamicContent = -1 !== headingTitle.indexOf( '<span data-vexaltrix-dc-field="' );
	const descriptionHasDynamicContent = headingDesc && -1 !== headingDesc.indexOf( '<span data-vexaltrix-dc-field="' );
...
export default compose( AddInitialAttr, AddStaticStyles, AddGBSStyles )( VexaltrixAdvancedHeading );
