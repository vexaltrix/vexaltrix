...
import { Icon, ToggleControl, Notice } from '@wordpress/components';
...
export default function Settings( props ) {
	...
	const freeAndProOptions = [
		{ label: __( 'Button', 'vexaltrix' ), value: 'button', disabled: false },
		{ label: __( 'Icon', 'vexaltrix' ), value: 'icon', disabled: false },
		{ label: __( 'Image', 'vexaltrix' ), value: 'image', disabled: false },
		{ label: __( 'Text', 'vexaltrix' ), value: 'text', disabled: false },
		{
			label: __( 'Custom Class (Vexaltrix Pro)', 'vexaltrix' ),
			value: 'custom-class',
			disabled: ! isProActivated,
		},
		{
			label: __( 'Custom ID (Vexaltrix Pro)', 'vexaltrix' ),
			value: 'custom-id',
			disabled: ! isProActivated,
		},
		{
			label: __( 'Automatic (Vexaltrix Pro)', 'vexaltrix' ),
			value: 'automatic',
			disabled: ! isProActivated,
		},
	];
	...
	const modalTriggerPanel = (
		<UAGAdvancedPanelBody panelId={ 'trigger' } title={ __( 'Trigger', 'vexaltrix' ) } initialOpen={ ! isPro }>
			<UAGSelectControl
				setAttributes={ setAttributes }
				label={ __( 'Modal Trigger', 'vexaltrix' ) }
				data={ {
					value: modalTrigger,
					label: 'modalTrigger',
				} }
	...
	const modalContentPanel = (
		<UAGAdvancedPanelBody title={ __( 'Container', 'vexaltrix' ) } initialOpen={ false }>
			<Notice className="vexaltrix-sidebar-settings-notice" status="warning" isDismissible={ false }>
				{ __( 'Please click on the modal button to preview the modal container.', 'vexaltrix' ) }
			</Notice>
			<ResponsiveSlider
				label={ __( 'Modal Width', 'vexaltrix' ) }
				data={ {
					desktop: {
						value: modalWidth,
						label: 'modalWidth',
			...
			{ isTypePopup && (
				<MultiButtonsControl
					setAttributes={ setAttributes }
					label={ __( 'Modal Height', 'vexaltrix' ) }
					data={ {
			...
			{ isTypePopup && modalBoxHeight !== 'auto' && (
				<ResponsiveSlider
					label={ __( 'Modal Popup Height', 'vexaltrix' ) }
					data={ {
						desktop: {
							value: modalHeight,
							label: 'modalHeight',
	...
	const modalClosePanel = (
		<UAGAdvancedPanelBody
			...
			title={ __( 'Close Button', 'vexaltrix' ) }
			initialOpen={ false }
		>
			<UAGIconPicker
				label={ __( 'Icon', 'vexaltrix' ) }
			...
			{ closeIcon !== '' && (
				...
				>
					<option value="popup-top-left">{ __( 'Top Left', 'vexaltrix' ) }</option>
					<option value="popup-top-right">{ __( 'Top Right', 'vexaltrix' ) }</option>
				</UAGSelectControl>
			) }
			<ToggleControl
				label={ __( 'Close on ESC Keypress', 'vexaltrix' ) }
				checked={ escPress }
	...
	const triggerStylePanel = (
		<UAGAdvancedPanelBody panelId={ 'trigger' } title={ __( 'Trigger', 'vexaltrix' ) } initialOpen={ true }>
			...
			{ modalTrigger === 'icon' && icon === '' && (
				<p className="vxt-settings-notice">
					{ __( 'For the styling options please select the Icon.', 'vexaltrix' ) }
				</p>
			) }
			...
			{ modalTrigger === 'image' && iconImage === undefined && (
				<p className="vxt-settings-notice">
					{ __( 'For the styling options please select the Image.', 'vexaltrix' ) }
				</p>
			) }
						...
						{ 'not-installed' === vxt_ultimate_gutenberg_blocks_blocks_info.vexaltrix_pro_status && (
							<UAGAdvancedPanelBody className="block-editor-block-inspector__upgrade_pro vxt-upgrade_pro-tab">
								<UpgradeComponent
									control={ {
										title: __(
											'Take Modal Block to the next level with powerful features',
											'vexaltrix'
										),
										choices: [
											{
												title: __(
													'Automatic trigger, with custom classes or IDs',
													'vexaltrix'
												),
												description: '',
											},
											{
												title: __( 'Modal position setting', 'vexaltrix' ),
												description: '',
											},
											{
												title: __( 'Off-canvas modal', 'vexaltrix' ),
												description: '',
											},
											{
												title: __( 'More option for close button', 'vexaltrix' ),
												description: '',
											},
										],
										renderAs: 'list',
