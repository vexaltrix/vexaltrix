...
const attributes = {
	...
	gradientLocationTablet2: {
		type: 'number',
		UAGCopyPaste: {
			styleType: 'btn-gradient-location-tablet-2',
		},
	},
	...
	gradientAngleTablet: {
		type: 'number',
		UAGCopyPaste: {
			styleType: 'btn-gradient-angel-tablet',
		},
	},
	gradientAngleMobile: {
		type: 'number',
		UAGCopyPaste: {
			styleType: 'btn-gradient-angel-mobile',
		},
	},
	backgroundOpacity: {
		type: 'number',
	...
	heading: {
		...
		default: __( 'Subscribe Now', 'vexaltrix' ),
	},
	prefix: {
		source: 'html',
		selector: '.vxt-marketing-btn__prefix',
		default: __( 'Get access to Premium Features for FREE for a year!', 'vexaltrix' ),
	},
