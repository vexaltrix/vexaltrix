...
const attributes = {
	...
	prefix: {
		source: 'html',
		selector: '.vxt-marketing-btn__prefix',
			...
			return (
				<div
					className={ classnames(
						className,
						'vxt-marketing-btn__outer-wrap',
						`vxt-marketing-btn__align-${ align }`,
						`vxt-marketing-btn__align-text-${ textAlign }`,
						`vxt-marketing-btn__icon-${ iconPosition }`
					) }
					id={ `vxt-marketing-btn-${ block_id }` }
				>
					<div className="vxt-marketing-btn__wrap">
						<a href={ link } className="vxt-marketing-btn__link" target={ target }>
							<div className="vxt-marketing-btn__title-wrap">
								{ '' != icon && (
									<div className="vxt-marketing-btn__icon-wrap">{ renderSVG( icon ) }</div>
								) }
								<RichText.Content value={ heading } tagName="h6" className="vxt-marketing-btn__title" />
							</div>
							<div className="vxt-marketing-btn__prefix-wrap">
								<RichText.Content value={ prefix } tagName="p" className="vxt-marketing-btn__prefix" />
							</div>
						</a>
					</div>
				</div>
