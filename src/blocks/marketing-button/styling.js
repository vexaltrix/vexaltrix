...
function styling( attributes, clientId, name, deviceType ) {
	...
	const gradientLocationTablet1Fallback =
		'number' === typeof gradientLocationTablet1 ? gradientLocationTablet1 : gradientLocation1Fallback;
	const gradientLocationTablet2Fallback =
		'number' === typeof gradientLocationTablet2 ? gradientLocationTablet2 : gradientLocation2Fallback;

	const gradientLocationMobile1Fallback =
		'number' === typeof gradientLocationMobile1 ? gradientLocationMobile1 : gradientLocationTablet1Fallback;
	const gradientLocationMobile2Fallback =
		'number' === typeof gradientLocationMobile2 ? gradientLocationMobile2 : gradientLocationTablet2Fallback;

	const gradientAngleTabletFallback =
		'number' === typeof gradientAngleTablet ? gradientAngleTablet : gradientAngleFallback;
	const gradientAngleMobileFallback =
		'number' === typeof gradientAngleMobile ? gradientAngleMobile : gradientAngleTabletFallback;
	...
	let marginType;
	if ( vxt_ultimate_gutenberg_blocks_blocks_info.is_rtl !== '1' ) {
	...
	if ( ! inheritFromTheme ) {
		if ( 'transparent' === backgroundType ) {
			selectors[ ':not(.is-style-outline) .vxt-marketing-btn__link:not(.has-background)' ] = {
			...
			// Hover Background
			selectors[ ':not(.is-style-outline) .vxt-marketing-btn__link:not(.has-background):hover' ] = {
		...
		selectors = {
			...selectors,
			' .block-editor-rich-text__editable.vxt-marketing-btn__title': {
			...
			' .block-editor-rich-text__editable.vxt-marketing-btn__prefix': {
			...
			' .vxt-marketing-btn__link:hover .block-editor-rich-text__editable.vxt-marketing-btn__title': {
				color: titleHoverColor,
			},
			' .vxt-marketing-btn__link:focus .block-editor-rich-text__editable.vxt-marketing-btn__title': {
				color: titleHoverColor,
			},
			' .vxt-marketing-btn__link:hover .block-editor-rich-text__editable.vxt-marketing-btn__prefix': {
				color: prefixHoverColor,
			},
			' .vxt-marketing-btn__link:focus .block-editor-rich-text__editable.vxt-marketing-btn__prefix': {
				color: prefixHoverColor,
			},
			' .vxt-marketing-btn__link:not(.has-background)': {
