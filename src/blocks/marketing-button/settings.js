...
const Settings = ( props ) => {
	...
	const generalSettings = () => {
		return (
			<>
				<UAGAdvancedPanelBody title={ __( 'Content & Heading', 'vexaltrix' ) } initialOpen={ false }>
					<ToggleControl
					...
					/>
					<ToggleControl
						label={ __( 'Show Description', 'vexaltrix' ) }
			...
			<UAGAdvancedPanelBody title={ __( 'Icon', 'vexaltrix' ) } initialOpen={ false }>
				...
				{ '' !== icon && (
					<>
						...
						/>
						<ResponsiveSlider
							label={ __( 'Gap Between Icon And Text', 'vexaltrix' ) }
							data={ {
								desktop: {
									value: iconSpace,
									label: 'iconSpace',
