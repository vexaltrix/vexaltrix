...
const buttonsPresets = [
	...
	},
	{
		...
		attributes: [
			...
			{ label: 'btnBorderBottomWidth', value: 1 },
			{ label: 'btnBorderTopWidth', value: 1 },
			{ label: 'btnBorderLeftWidth', value: 1 },
			{ label: 'btnBorderRightWidth', value: 1 },
		],
