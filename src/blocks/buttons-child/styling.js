...
function styling( attributes, clientId, name, deviceType, gbsSelector = false ) {
	...
	if ( ! inheritFromTheme ) {
		...
		selectors[
			'.uagb-buttons__outer-wrap .uagb-button__wrapper .wp-block-button__link.uagb-buttons-repeater:hover'
		] = {
		...
		mobileSelectors[ `.uagb-buttons__outer-wrap .uagb-button__wrapper ${ buttonClass }.uagb-buttons-repeater` ] = {
		...
		tabletSelectors[ `.uagb-buttons__outer-wrap .uagb-button__wrapper ${ buttonClass }.uagb-buttons-repeater` ] = {
		...
		if ( 'transparent' === hoverbackgroundType ) {
			...
			const hoverbackgroundAttributesTablet = {
				...
				gradientColor2: hovergradientColor2,
				gradientLocation1:
					'number' === typeof hovergradientLocationTablet1
						? hovergradientLocationTablet1
						: hoverbackgroundAttributes.gradientLocation1,
				gradientLocation2:
					'number' === typeof hovergradientLocationTablet2
						? hovergradientLocationTablet2
						: hoverbackgroundAttributes.gradientLocation2,
				gradientType: hovergradientType,
				gradientAngle:
					'number' === typeof hovergradientAngleTablet
						? hovergradientAngleTablet
			...
			const hoverbackgroundAttributesMobile = {
				...
				gradientColor2: hovergradientColor2,
				gradientLocation1:
					'number' === typeof hovergradientLocationMobile1
						? hovergradientLocationMobile1
						: hoverbackgroundAttributesTablet.gradientLocation1,
				gradientLocation2:
					'number' === typeof hovergradientLocationMobile2
						? hovergradientLocationMobile2
						: hoverbackgroundAttributesTablet.gradientLocation2,
				gradientType: hovergradientType,
				gradientAngle:
					'number' === typeof hovergradientAngleMobile
						? hovergradientAngleMobile
	...
	tabletSelectors[ `.uagb-buttons__outer-wrap ${ buttonClass }.uagb-buttons-repeater .uagb-button__icon svg` ] = {
		width: generateCSSUnit( iconSizeTablet, 'px' ),
		height: generateCSSUnit( iconSizeTablet, 'px' ),
		fill: iconColor,
	};
	mobileSelectors[ `.uagb-buttons__outer-wrap ${ buttonClass }.uagb-buttons-repeater .uagb-button__icon svg` ] = {
		width: generateCSSUnit( iconSizeMobile, 'px' ),
		height: generateCSSUnit( iconSizeMobile, 'px' ),
		fill: iconColor,
	};
	selectors[ `.uagb-buttons__outer-wrap ${ buttonClass }.uagb-buttons-repeater:hover .uagb-button__icon > svg` ] = {
