...
const ButtonsChildComponent = ( props ) => {
	...
	const labelHasDynamicContent = label && -1 !== label.indexOf( '<span data-vexaltrix-dc-field="' );
	...
	return (
		<>
			...
			{ isSelected && <Settings { ...props } state={ state } setStateValue={ setStateValue } /> }
			<Render { ...props } />
		</>
	);
};

export default compose( addInitialAttr, AddStaticStyles, AddGBSStyles )( ButtonsChildComponent );
