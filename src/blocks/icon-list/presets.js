...
const presets = [
	...
	},
	{
		...
		attributes: [
			...
			// Gap between items.
			{ label: 'gap', value: 10 },
			{ label: 'gapTablet', value: '' },
			{ label: 'gapMobile', value: '' },
			{ label: 'gapType', value: 'px' },
			// Gap between icons and labels.
			{ label: 'inner_gap', value: 15 },
			{ label: 'innerGapTablet', value: '' },
			{ label: 'innerGapMobile', value: '' },
			{ label: 'innerGapType', value: 'px' },
		],
