...
function styling( attributes, clientId, name, deviceType ) {
	...
	selectors = {
		' .wp-block-vxt-icon-list-child .vxt-icon-list__source-wrap': {
		...
		' .vxt-icon-list__wrap .block-editor-inner-blocks': {
			'text-align': align,
	...
	if ( 'horizontal' === iconListLayout ) {
		selectors[ ' .vxt-icon-list__wrap .block-editor-block-list__layout' ] = {
		...
		selectors[ ' .block-editor-block-list__layout .wp-block[data-type="vexaltrix/icon-list-child"]' ] = {
			'margin-right': generateCSSUnit( gapFallback / 2, gapType ),
		};
		selectors[
			' .block-editor-block-list__layout .wp-block[data-type="vexaltrix/icon-list-child"]:not(:first-child)'
		] = {
		...
		selectors[ ' .wp-block[data-type="vexaltrix/icon-list-child"]' ] = {
			display: 'block',
			'margin-left': 0,
			'margin-right': 0,
	...
	if ( 'horizontal' === iconListLayoutTablet ) {
		tabletSelectors[ ' .vxt-icon-list__wrap .block-editor-block-list__layout' ] = {
		...
		tabletSelectors[ ' .block-editor-block-list__layout .wp-block[data-type="vexaltrix/icon-list-child"]' ] = {
		...
		tabletSelectors[ ' .wp-block[data-type="vexaltrix/icon-list-child"]' ] = {
	...
	if ( 'horizontal' === iconListLayoutMobile ) {
		mobileSelectors[ ' .vxt-icon-list__wrap .block-editor-block-list__layout' ] = {
		...
		mobileSelectors[ ' .block-editor-block-list__layout .wp-block[data-type="vexaltrix/icon-list-child"]' ] = {
		...
		mobileSelectors[ ' .wp-block[data-type="vexaltrix/icon-list-child"]' ] = {
			display: 'block',
			'margin-left': 0 + ' !important',
			'margin-right': 0 + ' !important',
	...
	if ( 'right' === align && hideLabel ) {
		...
		mobileSelectors[ ' .vxt-icon-list__source-wrap' ] = {
			'margin-left': generateCSSUnit( innerGapMobileFallback, innerGapType ),
		};
		tabletSelectors[ ' .vxt-icon-list__source-wrap' ] = {
	...
	mobileSelectors[ ' .wp-block-vxt-icon-list-child .vxt-icon-list__label' ] = {
		'font-size': generateCSSUnit( fontSizeMobile, fontSizeType ),
		'line-height': generateCSSUnit( lineHeightMobile, lineHeightType ),
		'letter-spacing': generateCSSUnit( labelLetterSpacingMobile, labelLetterSpacingType ),
	};

	tabletSelectors[ ' .wp-block-vxt-icon-list-child .vxt-icon-list__label' ] = {
		'font-size': generateCSSUnit( fontSizeTablet, fontSizeType ),
		'line-height': generateCSSUnit( lineHeightTablet, lineHeightType ),
		'letter-spacing': generateCSSUnit( labelLetterSpacingTablet, labelLetterSpacingType ),
	};

	mobileSelectors[ ' .wp-block-vxt-icon-list-child .vxt-icon-list__source-wrap' ] = {
	...
	tabletSelectors[ ' .wp-block-vxt-icon-list-child .vxt-icon-list__source-wrap' ] = {
