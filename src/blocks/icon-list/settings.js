...
const Settings = ( props ) => {
	...
	const generalSetting = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Content', 'vexaltrix' ) } initialOpen={ false }>
				...
				<ToggleControl
					label={ __( 'Hide Labels', 'vexaltrix' ) }
					checked={ hideLabel }
	...
	const labelSetting = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Label', 'vexaltrix' ) } initialOpen={ false }>
				<ResponsiveSlider
					label={ __( 'Gap between Icon and Label', 'vexaltrix' ) }
					data={ {
						desktop: {
							value: inner_gap,
							label: 'inner_gap',
	...
	const iconSetting = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Icon/Image', 'vexaltrix' ) } initialOpen={ true }>
				<ResponsiveSlider
				...
				<ResponsiveSlider
					...
					setAttributes={ setAttributes }
				/>
				{ ( iconBgColor || iconBgHoverColor || border || borderTablet || borderMobile ) && (
					<>
						<ResponsiveSlider
				...
				<UAGTabsControl
					...
					normal={
						<>
							...
							<AdvancedPopColorControl
								...
								colorValue={ iconBorderColor ? iconBorderColor : '' }
								data={ {
					...
					hover={
						<>
							...
							<AdvancedPopColorControl
								label={ __( 'Border Color', 'vexaltrix' ) }
								colorValue={ iconBorderHoverColor ? iconBorderHoverColor : '' }
								data={ {
		...
		return (
			<UAGAdvancedPanelBody title={ __( 'Icon', 'vexaltrix' ) } initialOpen={ true }>
				<UAGIconPicker
					...
					value={ parentIcon }
					onChange={ ( value ) => setAttributes( { parentIcon: value } ) }
				/>
			</UAGAdvancedPanelBody>
		);
	};
