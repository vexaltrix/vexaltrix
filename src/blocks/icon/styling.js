...
function styling( attributes, clientId, name, deviceType, gbsSelector = false ) {
	...
	const selectors = {
		...
		'.vxt-icon-wrapper .vxt-svg-wrapper': {
			display: 'inline-flex',
		...
		'.vxt-icon-wrapper.wp-block-vxt-icon--has-margin .vxt-icon-margin-wrapper': {
		...
		'.vxt-icon-wrapper .vxt-svg-wrapper:hover': {
			'border-color': iconBorderHColor,
			background: hoverBackground,
		},
		'.vxt-icon-wrapper .vxt-svg-wrapper:hover svg': {
			fill: iconHoverColor,
		},
	};
	...
	const tabletSelectors = {
		...
		'.vxt-icon-wrapper .vxt-svg-wrapper svg': {
	...
	let stylingCss = '';
	const base_selector = gbsSelector ? gbsSelector : `.vxt-block-${ block_id }`;
