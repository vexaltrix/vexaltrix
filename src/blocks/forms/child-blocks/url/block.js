...
let urlCommonData = {};
urlCommonData = applyFilters( 'vexaltrix/forms-url', addCommonDataToVexaltrixBlocks( urlCommonData ) );
registerBlockType( 'vexaltrix/forms-url', {
	...urlCommonData,
	title: __( 'URL', 'vexaltrix' ),
	description: __( 'Add a URL input field in your form.', 'vexaltrix' ),
	icon: VXT_Block_Icons.url,
