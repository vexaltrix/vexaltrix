...
const Settings = ( props ) => {
	...
	const carousalSettings = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Carousel', 'vexaltrix' ) } initialOpen={ false }>
				...
				<MultiButtonsControl
					setAttributes={ setAttributes }
					label={ __( 'Show Arrows & Dots', 'vexaltrix' ) }
					data={ {
						value: arrowDots,
						label: 'arrowDots',
					} }
	...
	const carouselStyle = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Arrow & Dots', 'vexaltrix' ) } initialOpen={ false }>
				{ 'dots' !== arrowDots && (
					<>
						<Range
						...
						/>
						<Range
							label={ __( 'Arrow Border Size', 'vexaltrix' ) }
							setAttributes={ setAttributes }
						...
						/>
						<Range
							label={ __( 'Arrow Border Radius', 'vexaltrix' ) }
							setAttributes={ setAttributes }
	...
	const nameStyle = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Name', 'vexaltrix' ) } initialOpen={ true }>
				<AdvancedPopColorControl
					label={ __( 'Color', 'vexaltrix' ) }
	...
	const companyStyle = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Company', 'vexaltrix' ) } initialOpen={ false }>
				<AdvancedPopColorControl
					label={ __( 'Color', 'vexaltrix' ) }
	...
	const tmControls = ( index ) => {
		...
		const imageLabel = __( 'Image', 'vexaltrix' );
		return (
			<UAGMediaPicker
				...
				<InspectorTabs>
					<InspectorTab { ...UAGTabs.general }>
						<UAGAdvancedPanelBody title={ __( 'General', 'vexaltrix' ) } initialOpen={ true }>
							<Range
								label={ __( 'Number of Testimonials', 'vexaltrix' ) }
