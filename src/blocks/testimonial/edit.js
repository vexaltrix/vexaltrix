...
const Vexaltrixtestimonial = ( props ) => {
	const {
		setAttributes,
		attributes,
		attributes: {
	...
	const blockStyling = useMemo(
		() => TestimonialStyle( attributes, clientId, name, deviceType ),
		[ attributes, deviceType ]
	);
...
export default compose( addInitialAttr, AddStaticStyles )( Vexaltrixtestimonial );
