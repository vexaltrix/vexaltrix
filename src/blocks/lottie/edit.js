...
const VexaltrixLottie = ( props ) => {
	...
	return (
		<>
			...
			{ isSelected && <Settings { ...props } loopLottie={ loopLottie } reverseDirection={ reverseDirection } /> }
		</>
	);
};

export default compose( addInitialAttr, AddStaticStyles )( VexaltrixLottie );
