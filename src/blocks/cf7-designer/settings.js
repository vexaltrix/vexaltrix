...
const Settings = ( props ) => {
	...
	const fieldSetting = (
		<UAGAdvancedPanelBody title={ __( 'Field', 'vexaltrix' ) } initialOpen={ false }>
			<MultiButtonsControl
				setAttributes={ setAttributes }
	...
	const msgSettings = (
		<UAGAdvancedPanelBody title={ __( 'Success/Error Message', 'vexaltrix' ) } initialOpen={ false }>
			<p className="vxt-settings-notice">
				{ __( 'Note: This styling can be only seen at frontend', 'vexaltrix' ) }
			</p>
			<MultiButtonsControl
				setAttributes={ setAttributes }
				label={ __( 'Validation Message Position', 'vexaltrix' ) }
				data={ {
				...
				options={ [
					...
					{
						value: 'bottom_right',
						label: __( 'Bottom Right Side of Field', 'vexaltrix' ),
					},
				] }
			/>
			<ToggleControl
				label={ __( 'Highlight Borders', 'vexaltrix' ) }
	...
	const labelInputStyling = (
		<UAGAdvancedPanelBody title={ __( 'Label & Input', 'vexaltrix' ) } initialOpen={ false }>
			<AdvancedPopColorControl
			...
			/>
			<TypographyControl
				label={ __( 'Label Typography', 'vexaltrix' ) }
			...
			/>
			<AdvancedPopColorControl
				label={ __( 'Input Color', 'vexaltrix' ) }
			...
			/>
			<TypographyControl
				label={ __( 'Input Typography', 'vexaltrix' ) }
				attributes={ attributes }
				setAttributes={ setAttributes }
				loadGoogleFonts={ {
			...
			/>
			<ResponsiveSlider
				label={ __( 'Label & Input Gap', 'vexaltrix' ) }
				data={ {
					desktop: {
	...
	const fieldStyling = (
		<UAGAdvancedPanelBody title={ __( 'Field', 'vexaltrix' ) } initialOpen={ true }>
			{ fieldStyle === 'underline' && (
				<ResponsiveSlider
					label={ __( 'Border Bottom', 'vexaltrix' ) }
					data={ {
						desktop: {
			...
			<ResponsiveBorder
				...
				setAttributes={ setAttributes }
				borderHoverColorLabel={ __( 'Active Color', 'vexaltrix' ) }
				prefix={ 'input' }
				attributes={ attributes }
	...
	const messageStyling = (
		<UAGAdvancedPanelBody title={ __( 'Success/Error Message', 'vexaltrix' ) } initialOpen={ false }>
			...
			<AdvancedPopColorControl
				label={ __( 'Validation Message Color', 'vexaltrix' ) }
			...
			/>
			<TypographyControl
				label={ __( 'Validation Typography', 'vexaltrix' ) }
				attributes={ attributes }
				setAttributes={ setAttributes }
				loadGoogleFonts={ {
			...
			{ validationMsgPosition === 'bottom_right' && (
				<>
					<AdvancedPopColorControl
						label={ __( 'Message Background Color', 'vexaltrix' ) }
			...
			<h2>{ __( 'Success/Error Message', 'vexaltrix' ) }</h2>
			<TypographyControl
				label={ __( 'Typography', 'vexaltrix' ) }
				attributes={ attributes }
				setAttributes={ setAttributes }
			...
			/>
			<hr className="vxt-editor__separator" />
			<h2>{ __( 'Success Message', 'vexaltrix' ) }</h2>
			<AdvancedPopColorControl
				label={ __( 'Color', 'vexaltrix' ) }
			...
			/>
			<hr className="vxt-editor__separator" />
			<h2>{ __( 'Error Message', 'vexaltrix' ) }</h2>
			<AdvancedPopColorControl
				label={ __( 'Color', 'vexaltrix' ) }
