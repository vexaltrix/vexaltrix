...
function styling( attributes, clientId, deviceType ) {
	...
	const tabletSelectors = {
		...
		' .vxt-cf7-styler__check-style-enabled .wpcf7 input:not([type=submit])': {
	...
	const mobileSelectors = {
		...
		// underline border
		' .vxt-cf7-styler__field-style-underline .wpcf7 input:not([type=submit])': fieldBorderCSSMobile,
		' .vxt-cf7-styler__field-style-underline select': fieldBorderCSSMobile,
		" .vxt-cf7-styler__check-style-enabled .wpcf7 .wpcf7-checkbox input[type='checkbox'] + span:before": {
