...
const Settings = ( props ) => {
	...
	const getGeneralPanelBody = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'General', 'vexaltrix' ) } initialOpen={ true }>
				<h2>{ __( 'Choose heading tags to generate table', 'vexaltrix' ) }</h2>
	...
	const getScrollPanelBody = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Scroll', 'vexaltrix' ) } initialOpen={ false }>
				<ToggleControl
					label={ __( 'Smooth Scroll', 'vexaltrix' ) }
					checked={ smoothScroll }
					help={ __( 'This will be in action only in Front End.', 'vexaltrix' ) }
					onChange={ () => setAttributes( { smoothScroll: ! smoothScroll } ) }
				/>
				{ smoothScroll && (
					<>
						<Range
							label={ __( 'Smooth Scroll Offset', 'vexaltrix' ) }
				...
				<ToggleControl
					label={ __( 'Show Scroll To Top', 'vexaltrix' ) }
					checked={ scrollToTop }
					help={ __( 'This will add a scroll to top arrow at the bottom of page.', 'vexaltrix' ) }
	...
	const getGeneral = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'General', 'vexaltrix' ) } initialOpen={ true }>
				...
				<ResponsiveBorder
					setAttributes={ setAttributes }
					borderStyleLabel={ __( 'Style', 'vexaltrix' ) }
					borderWidthLabel={ __( 'Width', 'vexaltrix' ) }
					borderRadiusLabel={ __( 'Radius', 'vexaltrix' ) }
					prefix={ 'overall' }
					attributes={ attributes }
					deviceType={ deviceType }
		...
		return (
			<UAGAdvancedPanelBody title={ __( 'Content', 'vexaltrix' ) } initialOpen={ false }>
				...
				{ ! makeCollapsible && (
					<MultiButtonsControl
						setAttributes={ setAttributes }
						label={ __( 'Title Alignment', 'vexaltrix' ) }
						data={ {
				...
				<MultiButtonsControl
					setAttributes={ setAttributes }
					label={ __( 'List Alignment', 'vexaltrix' ) }
					data={ {
						value: align,
						label: 'align',
					} }
				...
				<ResponsiveSlider
					label={ __( 'Gap Between Lists', 'vexaltrix' ) }
					data={ {
						desktop: {
				...
				<ToggleControl
					...
					help={ __( "Table's width will be auto if this is kept off.", 'vexaltrix' ) }
				/>
				{ customWidth && (
					<ResponsiveSlider
				...
				<ToggleControl
					label={ __( 'Disable Marker', 'vexaltrix' ) }
				...
				{ ! disableBullets && (
					<MultiButtonsControl
						setAttributes={ setAttributes }
						label={ __( 'Marker View', 'vexaltrix' ) }
						data={ {
							value: markerView,
							label: 'markerView',
						} }
						...
						options={ [
							{
								value: 'disc',
								label: __( 'Bullets', 'vexaltrix' ),
							},
							{
								value: 'decimal',
								label: __( 'Numbers', 'vexaltrix' ),
							},
						] }
					/>
				) }
				<ToggleControl
					label={ __( 'Make Content Collapsible', 'vexaltrix' ) }
				...
				{ makeCollapsible && (
					<>
						<ToggleControl
							label={ __( 'Keep Collapsed Initially', 'vexaltrix' ) }
				...
				{ ! disableBullets && (
					<ToggleControl
						label={ __( 'Make List Collapsible', 'vexaltrix' ) }
						checked={ enableCollapsableList }
						onChange={ setColumns }
						help={ __( 'The collapsable functionality will only work in Front End.', 'vexaltrix' ) }
					/>
				) }
				{ enableCollapsableList && (
					<>
						<Range
							label={ __( 'Collapsible Level', 'vexaltrix' ) }
							setAttributes={ setAttributes }
							...
							displayUnit={ false }
							help={ __(
								'For example, if the depth is set to 1, only first-level headings that have nestable content will display a collapsible icon. As the depth increases, additional nested levels will become collapsible.',
								'vexaltrix'
							) }
						/>

						<ToggleControl
							label={ __( 'Initially Collapsed', 'vexaltrix' ) }
	...
	const getBulletStyle = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'List', 'vexaltrix' ) } initialOpen={ false }>
				...
				<SpacingControl
					{ ...props }
					label={ __( 'Inner Content Spacing', 'vexaltrix' ) }
					valueTop={ {
						value: topMargin,
						label: 'topMargin',
					} }
				...
				{ ! disableBullets && (
					<AdvancedPopColorControl
						label={ __( 'Marker Color', 'vexaltrix' ) }
	...
	const getScrollToTop = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Scroll To Top', 'vexaltrix' ) } initialOpen={ false }>
				<>
					<AdvancedPopColorControl
						label={ __( 'Icon Color', 'vexaltrix' ) }
