/**
 * BLOCK: Vexaltrix How-To Schema Attributes
 */
...
tools.push( {
	add_required_tools: __( '- A Computer.', 'vexaltrix' ),
} );

materials.push( {
	add_required_materials: __( '- A WordPress Website.', 'vexaltrix' ),
} );
...
const attributes = {
	...
	toolsTitle: {
		type: 'html',
		default: __( 'Required Tools:', 'vexaltrix' ),
	},
	materialTitle: {
		type: 'html',
		default: __( 'Things Needed?', 'vexaltrix' ),
	},
	stepsTitle: {
		type: 'html',
		default: __( 'Steps to configure the How-to Schema:', 'vexaltrix' ),
	},
	tools_count: {
		type: 'number',
		default: 1,
	...
	estCost: {
		type: 'html',
		default: __( 'Total Cost:', 'vexaltrix' ),
	},
	timeNeeded: {
		type: 'html',
		default: __( 'Total Time Needed :', 'vexaltrix' ),
	},
	timeIn: {
		type: 'html',
		default: __( 'Minutes', 'vexaltrix' ),
	},
	imgSize: {
		type: 'string',
		default: 'thumbnail',
	...
	headingTitle: {
		...
		default: __( 'How To Configure How-To Schema In Vexaltrix?', 'vexaltrix' ),
	},
	currencyType: {
		type: 'html',
		default: ' USD',
