...
function styling( attributes, clientId, name, deviceType ) {
	...
	const selectors = {
		' .block-editor-rich-text__editable.vxt-howto-desc-text': {
		...
		'.vxt-how-to-main-wrap .vxt-howto__source-wrap': {
			// For Backward
			'margin-bottom': generateCSSUnit( getFallbackNumber( row_gap, 'row_gap', blockName ), 'px' ),
		},
		...
		' .vxt-how-to-tools .vxt-how-to-tools-child__wrapper:last-child': {
			'margin-bottom': generateCSSUnit( getFallbackNumber( row_gap, 'row_gap', blockName ), 'px' ),
		},
		...
		' .block-editor-rich-text__editable.vxt-howto-timeNeeded-text': {
		...
		' .block-editor-rich-text__editable.vxt-howto-estcost-text': {
			'font-family': priceFontFamily,
			'font-style': priceFontStyle,
			'text-decoration': priceDecoration,
			'text-transform': priceTransform,
		...
		' .block-editor-rich-text__editable.vxt-howto-estcost-value': {
			'font-family': subHeadFontFamily,
			'font-style': subHeadFontStyle,
			'text-decoration': subHeadDecoration,
			'text-transform': subHeadTransform,
		...
		' .block-editor-rich-text__editable.vxt-howto-estcost-type': {
			'font-family': subHeadFontFamily,
			'font-style': subHeadFontStyle,
			'text-decoration': subHeadDecoration,
			'text-transform': subHeadTransform,
		...
		' .block-editor-rich-text__editable.vxt-howto-req-tools-text': {
			'font-family': priceFontFamily,
			'font-style': priceFontStyle,
			'text-decoration': priceDecoration,
			'text-transform': priceTransform,
		...
		'  .block-editor-rich-text__editable.vxt-tools__label': {
			'font-family': subHeadFontFamily,
			'font-style': subHeadFontStyle,
			'text-decoration': subHeadDecoration,
			'text-transform': subHeadTransform,
		...
		' .block-editor-rich-text__editable.vxt-howto-req-materials-text': {
			'font-family': priceFontFamily,
			'font-style': priceFontStyle,
			'text-decoration': priceDecoration,
			'text-transform': priceTransform,
		...
		' .block-editor-rich-text__editable.vxt-howto-req-steps-text': {
			'font-family': priceFontFamily,
			'font-style': priceFontStyle,
			'text-decoration': priceDecoration,
			'text-transform': priceTransform,
		...
		' .block-editor-rich-text__editable.vxt-materials__label': {
			'font-family': subHeadFontFamily,
			'font-style': subHeadFontStyle,
			'text-decoration': subHeadDecoration,
			'text-transform': subHeadTransform,
	...
	selectors[ '.vxt-how-to-main-wrap' ] = {
		'text-align': overallAlignment,
		display: 'block',
	};

	selectors[ ` ${ headingTag }.block-editor-rich-text__editable.vxt-howto-heading-text` ] = {
	...
	mobileSelectors = {
		' .block-editor-rich-text__editable.vxt-howto-heading-text': {
	...
	mobileSelectors[ ` ${ headingTag }.block-editor-rich-text__editable.vxt-howto-heading-text` ] = {
		'font-size': generateCSSUnit( headFontSizeMobile, headFontSizeType ),
		'line-height': generateCSSUnit( headLineHeightMobile, headLineHeightType ),
		'letter-spacing': generateCSSUnit( headLetterSpacingMobile, headLetterSpacingType ),
	};
	...
	tabletSelectors[ ` ${ headingTag }.block-editor-rich-text__editable.vxt-howto-heading-text` ] = {
		'font-size': generateCSSUnit( headFontSizeTablet, headFontSizeType ),
		'line-height': generateCSSUnit( headLineHeightTablet, headLineHeightType ),
		'letter-spacing': generateCSSUnit( headLetterSpacingTablet, headLetterSpacingType ),
	};
