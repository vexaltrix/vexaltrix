...
const deprecated = [
	{
		...
		save( props ) {
			...
			const imageMarkup = <img className="vxt-how-to-step-image" src={ imageUrl } alt={ image.alt } />;
			const contentMarkup = (
				<div className="vxt-step-content-wrap">
					<RichText.Content tagName="div" className="vxt-how-to-step-name" value={ name } />
					<RichText.Content tagName="p" className="vxt-how-to-step-description" value={ description } />
					{ 'text' === urlType && (
			...
			return (
				<div className={ classnames( 'vxt-how-to-step-wrap', `vxt-block-${ block_id }` ) }>
					{ 'all' === urlType && (
						<>
							<a
								href={ url }
								target={ target }
								className="vxt-step-link-all"
