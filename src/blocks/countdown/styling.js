...
export default function styling( attributes, clientId, name, deviceType, gbsSelector = false ) {
	...
	const isRTL = '1' === vxt_ultimate_gutenberg_blocks_blocks_info.is_rtl ? true : false;

	const childSelectorType = isRTL ? 'first' : 'last';
	const pseudoElementSelectorType = isRTL ? 'before' : 'after';

	const separatorSelector =
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box:not(:' +
		childSelectorType +
		'-child) .wp-block-vxt-countdown__time::' +
	...
	const minSeparatorRemovalSelector =
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-minutes:not(:' +
		childSelectorType +
	...
	const hoursSeparatorRemovalSelector =
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-hours:not(:' +
		childSelectorType +
	...
	const daysSeparatorRemovalSelector =
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-days:not(:' +
		childSelectorType +
	...
	let selectors = {
		...
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-days': {
			display: showDays ? '' : 'none',
		},
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-hours': {
			display: showHours ? '' : 'none',
		},
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-minutes': {
			display: showMinutes ? '' : 'none',
		},
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-seconds': {
			display: showSeconds ? '' : 'none',
		},
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box': {
		...
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-days:not(:last-child)': {
			'margin-right':
				showSeconds || showMinutes || showHours ? generateCSSUnit( boxSpacingFallback, 'px' ) : 'unset',
		},
		...
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box:not(:last-child) .wp-block-vxt-countdown__time::after':
			{}, // Empty ruleset to prevent undefined error.
		'.wp-block-vxt-countdown .wp-block-vxt-countdown__box:not(:first-child)': {}, // Empty ruleset to prevent undefined error (for RTL Box Gap).
	...
	// TABLET SELECTORS.
	tabletSelectors[ '.wp-block-vxt-countdown' ] = {
	...
	tabletSelectors[ '.wp-block-vxt-countdown .wp-block-vxt-countdown__box' ] = {
	...
	tabletSelectors[
		...
		'margin-right':
			showSeconds || showMinutes || showHours ? generateCSSUnit( boxSpacingFallbackTablet, 'px' ) : 'unset',
	};

	tabletSelectors[ '.wp-block-vxt-countdown .wp-block-vxt-countdown__box:not(:first-child)' ] = {}; // Empty ruleset to prevent undefined error (for RTL Box Gap).

	tabletSelectors[ '.wp-block-vxt-countdown .wp-block-vxt-countdown__time' ] = {
	...
	tabletSelectors[ '.wp-block-vxt-countdown div.wp-block-vxt-countdown__label' ] = {
	...
	mobileSelectors[ '.wp-block-vxt-countdown' ] = {
	...
	mobileSelectors[ '.wp-block-vxt-countdown .wp-block-vxt-countdown__box' ] = {
	...
	mobileSelectors[
		...
		'margin-right':
			showSeconds || showMinutes || showHours ? generateCSSUnit( boxSpacingFallbackMobile, 'px' ) : 'unset',
	};

	mobileSelectors[ '.wp-block-vxt-countdown .wp-block-vxt-countdown__box:not(:first-child)' ] = {}; // Empty ruleset to prevent undefined error (for RTL Box Gap).

	mobileSelectors[ '.wp-block-vxt-countdown .wp-block-vxt-countdown__time' ] = {
	...
	mobileSelectors[ '.wp-block-vxt-countdown div.wp-block-vxt-countdown__label' ] = {
	...
	if ( showSeparator ) {
		...
		tabletSelectors[ separatorSelector ] = {
			...
			right: separatorRightSpacingTabletFallback
				? generateCSSUnit( -separatorRightSpacingTabletFallback, 'px' )
				: '',
		...
		mobileSelectors[ separatorSelector ] = {
			...
			right: separatorRightSpacingMobileFallback
				? generateCSSUnit( -separatorRightSpacingMobileFallback, 'px' )
				: '',
	...
	if ( isRTL ) {
		const boxGapSelectorLTR = '.wp-block-vxt-countdown .wp-block-vxt-countdown__box:not(:last-child)';
		const boxGapSelectorRTL = '.wp-block-vxt-countdown .wp-block-vxt-countdown__box:not(:first-child)';
	...
	const baseSelector = '.editor-styles-wrapper ' + ( gbsSelector ? gbsSelector : `.vxt-block-${ block_id }` );

	selectors = applyFilters( `vexaltrix.${ blockName }.styling`, selectors, attributes );
	tabletSelectors = applyFilters( `vexaltrix.${ blockName }.tabletStyling`, tabletSelectors, attributes );
	mobileSelectors = applyFilters( `vexaltrix.${ blockName }.mobileStyling`, mobileSelectors, attributes );
