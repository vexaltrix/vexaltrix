...
function styling( attributes, clientId, name, deviceType ) {
	...
	if ( 'stack' === layout ) {
		if ( 'before' === starPosition ) {
			index = 'margin-top';
			selectors[ '.wp-block-vxt-star-rating' ] = {
	...
	if ( 'stack' === layoutTablet ) {
		if ( 'before' === starPositionTablet ) {
			...
			tabletSelectors[ '.wp-block-vxt-star-rating ' ] = {
				'flex-direction': 'column-reverse',
		...
		tabletSelectors[ '.wp-block-vxt-star-rating p.block-editor-rich-text__editable.uag-star-rating__title ' ] = {
			'margin-bottom': 0,
		};
	}
	...
	if ( 'stack' === layoutMobile ) {
		if ( 'before' === starPositionMobile ) {
			...
			mobileSelectors[ '.wp-block-vxt-star-rating ' ] = {
				'flex-direction': 'column-reverse',
		...
		mobileSelectors[ '.wp-block-vxt-star-rating p.block-editor-rich-text__editable.uag-star-rating__title ' ] = {
			'margin-bottom': 0,
		};
	}
