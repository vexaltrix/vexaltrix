...
export default function styling( attributes, clientId, name, deviceType ) {
	...
	const popupBackgroundStyles = generateBackgroundCSS( backgroundAttributesDesktop );
	const popupBackgroundStylesTablet = generateBackgroundCSS( backgroundAttributesTablet );
	const popupBackgroundStylesMobile = generateBackgroundCSS( backgroundAttributesMobile );
	...
	let selectors = {
		...
		' .vxt-popup-builder__container': {
			...
			'overflow-y':
				hasFixedHeight && ( 'center' === popupContentAlignmentV || 'flex-end' === popupContentAlignmentV )
					? 'hidden'
					: '',
	...
	let tabletSelectors = {
		' .vxt-popup-builder__wrapper--banner': {
			...
			'min-height': ! hasFixedHeight
				? generateCSSUnit( popupHeightTablet, sizingUnits.tablet.height )
				: undefined,
		},
		' .vxt-popup-builder__wrapper--popup': {
			height: hasFixedHeight ? generateCSSUnit( popupHeightTablet, sizingUnits.tablet.height ) : undefined,
			'max-height': ! hasFixedHeight
				? generateCSSUnit( popupHeightTablet, sizingUnits.tablet.height )
				: undefined,
	...
	let mobileSelectors = {
		' .vxt-popup-builder__wrapper--banner': {
			...
			'min-height': ! hasFixedHeight
				? generateCSSUnit( popupHeightMobile, sizingUnits.mobile.height )
				: undefined,
		},
		' .vxt-popup-builder__wrapper--popup': {
			height: hasFixedHeight ? generateCSSUnit( popupHeightMobile, sizingUnits.mobile.height ) : undefined,
