...
const VexaltrixRestaurantMenu = ( props ) => {
	const {
		isSelected,
		attributes,
	...
	const blockStyling = useMemo(
		() => RestMenuStyle( attributes, clientId, name, deviceType ),
		[ attributes, deviceType ]
	);
...
export default compose( addInitialAttr, AddStaticStyles )( VexaltrixRestaurantMenu );
