...
const Settings = ( props ) => {
	...
	const marginSettings = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Spacing', 'vexaltrix' ) } initialOpen={ false }>
				...
				<SpacingControl
					{ ...props }
					label={ __( 'Item Padding', 'vexaltrix' ) }
					valueTop={ {
	...
	const imageSizeOptions = [
		{ value: 'thumbnail', label: __( 'Thumbnail', 'vexaltrix' ) },
				...
				{ imgAlign === 'side' && (
					<>
						...
						<MultiButtonsControl
							...
							help={ __( 'Note: Choose on what breakpoint the Images will stack.', 'vexaltrix' ) }
							showIcons={ false }
							onChange={ setStack }
						/>
						<MultiButtonsControl
	...
	const priceSettings = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Price', 'vexaltrix' ) } initialOpen={ false }>
				<AdvancedPopColorControl
					label={ __( 'Color', 'vexaltrix' ) }
