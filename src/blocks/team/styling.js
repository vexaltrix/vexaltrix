...
function styling( attributes, clientId, name, deviceType ) {
	...
	const selectors = {
		' p.vxt-team__desc.block-editor-rich-text__editable': {
		...
		' .rich-text.block-editor-rich-text__editable.vxt-team__prefix': {
	...
	if ( 'above' === imgPosition ) {
		if ( 'center' === align ) {
			...
			selectors[ ' .vxt-team__social-list' ] = {
	...
	selectors[ ' ' + tag + '.rich-text.block-editor-rich-text__editable.vxt-team__title' ] = {
	...
	mobileSelectors[ ' ' + tag + '.rich-text.block-editor-rich-text__editable.vxt-team__title' ] = {
	...
	tabletSelectors[ ' ' + tag + '.rich-text.block-editor-rich-text__editable.vxt-team__title' ] = {
	...
	mobileSelectors[ ' ' + tag + '.vxt-team__title' ] = {
		'font-size': generateCSSUnit( titleFontSizeMobile, titleFontSizeType ),
	};

	tabletSelectors[ ' ' + tag + '.vxt-team__title' ] = {
		'font-size': generateCSSUnit( titleFontSizeTablet, titleFontSizeType ),
	};

	let stylingCss = '';
	const id = `#block-${ clientId } .vxt-block-${ block_id }`;
