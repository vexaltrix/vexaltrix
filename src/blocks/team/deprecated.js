...
function new_social_html_v2_0_13( icon, link, target ) {
	const target_value = target ? '_blank' : '_self';
	return (
		<li className="vxt-team__social-icon">
...
const deprecated = [
	{
		...
		save( props ) {
			...
			if ( '' != img_url ) {
				image_html = (
					<div className={ classnames( 'vxt-team__image-wrap', `vxt-team__image-crop-${ imgStyle }` ) }>
