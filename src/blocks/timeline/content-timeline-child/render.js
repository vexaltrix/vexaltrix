	...
	return (
		<article
			className={ classnames(
				'wp-block-vxt-content-timeline-child vxt-timeline__field',
				`vxt-timeline-child-${ block_id }`,
				props.attributes.content_class
			) }
		>
			<div className="vxt-timeline__marker vxt-timeline__out-view-icon">{ renderSVG( icon, setAttributes ) }</div>
			<div className={ classnames( props.attributes.dayalign_class, 'vxt-timeline__events-inner-new' ) }>
