/**
 * BLOCK: Vexaltrix Timeline Child Attributes
 */
...
const attributes = {
	...
	time_heading: {
		type: 'string',
		default: __( 'Timeline Heading', 'vexaltrix' ),
	},
	time_desc: {
		type: 'string',
		default: __( 'This is timeline description. Please click here to change this description.', 'vexaltrix' ),
	},
	dateFormat: {
		type: 'string',
		default: 'F j, Y',
