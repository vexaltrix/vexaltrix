...
const CtaLink = ( props ) => {
	...
	const ctaBtnClass = `vxt-timeline__link ${ buttonTypeClass }`;
	...
	if ( attributes.displayPostLink ) {
		if ( setAttributes !== 'not_set' ) {
			return (
				<div className="vxt-timeline__link_parent wp-block-button">
					<RichText
		...
		return (
			<div className="vxt-timeline__link_parent wp-block-button">
				<a
					className="vxt-timeline__link wp-block-button__link"
					href={ post.link }
					target={ target }
					rel="noopener noreferrer"
				>
