...
const Settings = ( props ) => {
	...
	const ImageSetting = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Image', 'vexaltrix' ) } initialOpen={ false }>
				<ToggleControl
					label={ __( 'Display Featured Image', 'vexaltrix' ) }
	...
	const contentSettings = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Content', 'vexaltrix' ) } initialOpen={ false }>
				...
				/>
				<ToggleControl
					label={ __( 'Display Post Author', 'vexaltrix' ) }
				...
				/>
				<ToggleControl
					label={ __( 'Display Post Date', 'vexaltrix' ) }
				...
				<ToggleControl
					label={ __( 'Display Post Excerpt', 'vexaltrix' ) }
				...
				{ displayPostExcerpt && (
					<Range
						label={ __( 'Excerpt Length', 'vexaltrix' ) }
						setAttributes={ setAttributes }
						value={ exerptLength }
						data={ {
							value: exerptLength,
				...
				<ToggleControl
					label={ __( 'Display Continue Reading Link', 'vexaltrix' ) }
				...
				{ displayPostLink && (
					<>
						...
						/>
						<ToggleControl
							label={ __( 'Open link in New Tab', 'vexaltrix' ) }
							checked={ linkTarget }
	...
	const headingStyleSettings = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Heading', 'vexaltrix' ) } initialOpen={ true }>
				...
				/>
				<ResponsiveSlider
					label={ __( 'Top Spacing', 'vexaltrix' ) }
					data={ {
						desktop: {
	...
	const ctaStyleSettings = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'CTA', 'vexaltrix' ) } initialOpen={ false }>
				{ ! inheritFromTheme && (
					<>
						<AdvancedPopColorControl
							label={ __( 'Color', 'vexaltrix' ) }
	...
	const spacingSettings = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Spacing', 'vexaltrix' ) } initialOpen={ false }>
				<SpacingControl
					{ ...props }
					label={ __( 'Post Padding', 'vexaltrix' ) }
					valueTop={ {
						value: topPadding,
						label: 'topPadding',
					} }
				...
				/>
				<ResponsiveSlider
					label={ __( 'Gap Between Posts', 'vexaltrix' ) }
					data={ {
						desktop: {
							value: verticalSpace,
							label: 'verticalSpace',
				...
				/>
				<ResponsiveSlider
					label={ __( 'Post - Marker Gap', 'vexaltrix' ) }
					data={ {
						desktop: {
