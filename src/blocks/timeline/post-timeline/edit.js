...
const PostTimelineComponent = ( props ) => {
	...
	const blockStyling = useMemo(
		() => contentTimelineStyle( attributes, clientId, name, deviceType ),
	...
	return (
		<>
			...
			{ isSelected && <Settings { ...props } taxonomyList={ taxonomyList } categoriesList={ categoriesList } /> }
			<Render { ...props } latestPosts={ latestPosts } />
		</>
	);
};
export default compose( AddInitialAttr, AddStaticStyles )( PostTimelineComponent );
