/**
 * BLOCK: Vexaltrix Timeline Attributes
 */
...
for ( let i = 1; i <= itemCount; i++ ) {
	item.push( {
		time_heading: __( 'Timeline Heading', 'vexaltrix' ) + i,
		time_desc: __( 'This is timeline description. Please click here to change this description.', 'vexaltrix' ),
	} );
