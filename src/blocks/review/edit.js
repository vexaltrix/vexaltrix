...
const ReviewComponent = ( props ) => {
	...
	useEffect( () => {
		const ratingLinkWrapper = document.querySelector( '.vxt-rating-link-wrapper' );
...
export default compose( addInitialAttr, AddStaticStyles )( ReviewComponent );
