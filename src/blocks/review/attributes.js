/**
 * BLOCK: Vexaltrix Review Block Attributes
 */
...
const attributes = {
	...
	rTitle: {
		type: 'string',
		default: 'Vexaltrix: Gutenberg Blocks',
	},
	rContent: {
		type: 'string',
		default:
			'Whether you’re a beginner, marketer, web designer or developer, Vexaltrix includes all the tools and resources you can trust to succeed online.',
	},
	rAuthor: {
		type: 'string',
	...
	mainimage: {
		type: 'object',
		default: {
			url: `${ vxt_ultimate_gutenberg_blocks_blocks_info.vxt_ultimate_gutenberg_blocks_url }/admin/assets/images/placeholder.png`,
		},
	},
	imgSize: {
		type: 'string',
	...
	featuresTitle: {
		type: 'string',
		default: __( 'List Of Features:', 'vexaltrix' ),
	},
	featuresAvgText: {
		type: 'string',
		default: __( 'Average Ratings', 'vexaltrix' ),
	},
	feature_count: {
		type: 'number',
		default: 1,
	...
	availabilityvalue: {
		type: 'string',
		default: __( 'Instock', 'vexaltrix' ),
	},
	availabilitytext: {
		type: 'string',
		default: __( 'Availability', 'vexaltrix' ),
	},
	contentVrPadding: {
		type: 'number',
		UAGCopyPaste: {
