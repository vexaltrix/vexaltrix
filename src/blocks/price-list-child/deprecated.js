...
const attributes = {
	...
	description: {
		type: 'string',
		default: __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'vexaltrix' ),
	},
	title: {
		type: 'string',
		default: __( 'Menu Item', 'vexaltrix' ),
	},
	price: {
		type: 'string',
		default: __( '$9', 'vexaltrix' ),
	},
	image: {
		type: 'object',
		default: null,
	...
	},
	{
		...
		attributes: {
			...
			image: {
				type: 'object',
				default: {
					url: `${ vxt_ultimate_gutenberg_blocks_blocks_info.vxt_ultimate_gutenberg_blocks_url }/admin/assets/images/uag-placeholder.svg`,
				},
			},
			imagePosition: {
				type: 'string',
