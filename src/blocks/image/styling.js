...
export default function styling( attributes, clientId, name, deviceType, gbsSelector = false ) {
	...
	const captionDecorationStyle =
		'' === captionDecoration && vxt_ultimate_gutenberg_blocks_blocks_info.is_astra_based_theme
			? vxt_ultimate_gutenberg_blocks_blocks_info.astra_body_text_decoration
			: captionDecoration;
	...
	const selectors = {
		...
		'.wp-block-vxt-image--layout-default figure img': {
			width: 'inherit',
			height: 'inherit',
		...
		// overlay
		'.wp-block-vxt-image--layout-overlay figure img': {
			width: 'inherit',
			height: 'inherit',
			'box-shadow': boxShadowCSS,
			...imageBorderCSS,
		},
		'.wp-block-vxt-image--layout-overlay .wp-block-vxt-image--layout-overlay__color-wrapper': {
		...
		'.wp-block-vxt-image--layout-overlay .wp-block-vxt-image--layout-overlay__inner': {
	...
	if ( customHeightSetDesktop ) {
		selectors[ '.wp-block-vxt-image .wp-block-vxt-image__figure img' ].height = height + 'px';
	}
	if ( headingShowOn === 'hover' ) {
		selectors[
			'.wp-block-vxt-image .wp-block-vxt-image__figure:hover .wp-block-vxt-image--layout-overlay__inner .vxt-image-heading'
		] = {
			opacity: 1,
		};
	}
	if ( captionShowOn === 'hover' ) {
		selectors[
			'.wp-block-vxt-image .wp-block-vxt-image__figure:hover .wp-block-vxt-image--layout-overlay__inner .vxt-image-caption'
		] = {
			opacity: 1,
		};
	}
	if ( seperatorShowOn === 'hover' ) {
		selectors[
			'.wp-block-vxt-image .wp-block-vxt-image__figure:hover .wp-block-vxt-image--layout-overlay__inner .vxt-image-separator'
		] = {
			opacity: 1,
		};
	}
	...
	if ( maskShape !== 'none' ) {
		let imagePath = `${ window?.vxt_ultimate_gutenberg_blocks_blocks_info?.vxt_ultimate_gutenberg_blocks_url }assets/images/masks/${ maskShape }.svg`;
		if ( maskShape === 'custom' ) {
			imagePath = `${ maskCustomShape?.url }`;
		}
		if ( typeof imagePath !== 'undefined' && imagePath ) {
			selectors[
				`.wp-block-vxt-image .wp-block-vxt-image__figure img, .vxt-block-${ block_id } .wp-block-vxt-image--layout-overlay__color-wrapper`
			] = {
	...
	tablet_selectors[ '.wp-block-vxt-image .components-resizable-box__container' ] = {
		width: generateCSSUnit( widthTablet, 'px' ),
		height: generateCSSUnit( heightTablet, 'px' ),
	};

	tablet_selectors[ '.wp-block-vxt-image--layout-default figure img' ] = imageBorderCSSTablet;
	tablet_selectors[ '.wp-block-vxt-image--layout-overlay figure img' ] = imageBorderCSSTablet;

	tablet_selectors[ '.wp-block-vxt-image' ] = {
	...
	tablet_selectors[ ' .wp-block-vxt-image__figure' ] = {
		'align-items': blockAlignTablet,
	};
	tablet_selectors[ '.wp-block-vxt-image .wp-block-vxt-image__figure figcaption' ] = {
	...
	tablet_selectors[ '.wp-block-vxt-image--layout-overlay .wp-block-vxt-image--layout-overlay__inner' ] =
		overlayBorderCSSTablet;

	tablet_selectors[ '.wp-block-vxt-image .wp-block-vxt-image--layout-overlay__inner .vxt-image-heading' ] = {
	...
	// separator
	tablet_selectors[ '.wp-block-vxt-image .wp-block-vxt-image--layout-overlay__inner .vxt-image-separator' ] = {
	...
	tablet_selectors[ '.wp-block-vxt-image .wp-block-vxt-image__figure img' ] = {
	...
	if ( customHeightSetTablet ) {
		tablet_selectors[ '.wp-block-vxt-image .wp-block-vxt-image__figure img' ].height = tabletHeight + 'px';
	}

	// Mobile
	mobile_selectors[ '.wp-block-vxt-image .components-resizable-box__container' ] = {
		width: generateCSSUnit( widthMobile, 'px' ),
		height: generateCSSUnit( heightMobile, 'px' ),
	};

	mobile_selectors[ '.wp-block-vxt-image--layout-default figure img' ] = imageBorderCSSMobile;
	mobile_selectors[ '.wp-block-vxt-image--layout-overlay figure img' ] = imageBorderCSSMobile;

	mobile_selectors[ '.wp-block-vxt-image' ] = {
	...
	mobile_selectors[ ' .wp-block-vxt-image__figure' ] = {
		'align-items': blockAlignMobile,
	};
	mobile_selectors[ '.wp-block-vxt-image .wp-block-vxt-image__figure figcaption' ] = {
	...
	mobile_selectors[ '.wp-block-vxt-image--layout-overlay .wp-block-vxt-image--layout-overlay__inner' ] =
		overlayBorderCSSMobile;

	mobile_selectors[ '.wp-block-vxt-image .wp-block-vxt-image--layout-overlay__inner .vxt-image-heading' ] = {
	...
	mobile_selectors[ '.wp-block-vxt-image .wp-block-vxt-image--layout-overlay__inner .vxt-image-separator' ] = {
	...
	mobile_selectors[ '.wp-block-vxt-image .wp-block-vxt-image__figure img' ] = {
	...
	if ( customHeightSetMobile ) {
		mobile_selectors[ '.wp-block-vxt-image .wp-block-vxt-image__figure img' ].height = mobileHeight + 'px';
	}

	const base_selector = gbsSelector
		? `.editor-styles-wrapper ${ gbsSelector } `
		: `.editor-styles-wrapper .vxt-block-${ block_id }`;
