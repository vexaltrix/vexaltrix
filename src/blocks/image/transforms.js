	...
	from: [
		{
			...
			transform: ( { url, sizeSlug } ) => {
				return createBlock( 'vexaltrix/image', {
					url,
					sizeSlug,
				} );
			},
		...
		},
		{
			...
			transform: ( _attributes, innerBlocks ) => {
				...
				return createBlock( 'vexaltrix/image', {
					...
					headingFontWeight:
						firstInnerBlockAttributes?.style?.typography?.fontWeight ||
						_attributes?.style?.typography?.fontWeight ||
						'',
					headingFontSize: getNumber(
						firstInnerBlockAttributes?.style?.typography?.fontSize ||
							_attributes?.style?.typography?.fontSize ||
							''
					),
					headingFontSizeType: getUnit(
						firstInnerBlockAttributes?.style?.typography?.fontSize ||
							_attributes?.style?.typography?.fontSize ||
							''
					),
					headingLetterSpacing: getNumber(
						firstInnerBlockAttributes?.style?.typography?.letterSpacing ||
							_attributes?.style?.typography?.letterSpacing ||
							''
					),
					headingLetterSpacingType: getUnit(
						firstInnerBlockAttributes?.style?.typography?.letterSpacing ||
							_attributes?.style?.typography?.letterSpacing ||
							''
					),
					headingDecoration:
						firstInnerBlockAttributes?.style?.typography?.textDecoration ||
						_attributes?.style?.typography?.textDecoration ||
						'',
					headingTransform:
						firstInnerBlockAttributes?.style?.typography?.textTransform ||
						_attributes?.style?.typography?.textTransform ||
						'',
					headingLineHeight: getNumber(
						firstInnerBlockAttributes?.style?.typography?.lineHeight ||
							_attributes?.style?.typography?.lineHeight ||
							''
					),
					...
					imageBorderStyle:
						...
						( _attributes?.style?.border?.width || _attributes?.style?.border?.top?.width
							? _attributes?.style?.border?.style || 'solid'
							: 'none' ),
					imageBorderTopWidth: getNumber(
						_attributes?.style?.border?.width || _attributes?.style?.border?.top?.width || ''
					),
					imageBorderBottomWidth: getNumber(
						_attributes?.style?.border?.width || _attributes?.style?.border?.bottom?.width || ''
					),
					imageBorderLeftWidth: getNumber(
						_attributes?.style?.border?.width || _attributes?.style?.border?.left?.width || ''
					),
					imageBorderRightWidth: getNumber(
						_attributes?.style?.border?.width || _attributes?.style?.border?.right?.width || ''
					),
					imageBorderWidthUnit: getNumber(
						_attributes?.style?.border?.width || _attributes?.style?.border?.top?.width || ''
					),
					imageBorderColor:
						colourNameToHex( _attributes?.borderColor ) ||
						colourNameToHex( _attributes?.style?.border?.right?.color ) ||
						_attributes?.style?.border?.color ||
						_attributes?.style?.border?.right?.color ||
						'',
					imageBorderTopRightRadius: getNumber(
						( typeof _attributes?.style?.border?.radius !== 'object' &&
							_attributes?.style?.border?.radius ) ||
							_attributes?.style?.border?.radius?.topRight ||
							''
					),
					imageBorderTopLeftRadius: getNumber(
						( typeof _attributes?.style?.border?.radius !== 'object' &&
							_attributes?.style?.border?.radius ) ||
							_attributes?.style?.border?.radius?.topLeft ||
							''
					),
					imageBorderBottomRightRadius: getNumber(
						( typeof _attributes?.style?.border?.radius !== 'object' &&
							_attributes?.style?.border?.radius ) ||
							_attributes?.style?.border?.radius?.bottomRight ||
							''
					),
					imageBorderBottomLeftRadius: getNumber(
						( typeof _attributes?.style?.border?.radius !== 'object' &&
							_attributes?.style?.border?.radius ) ||
							_attributes?.style?.border?.radius?.bottomLeft ||
							''
			...
			transform: ( _attributes, innerBlocks ) => {
				...
				return createBlock( 'vexaltrix/image', {
					...
					captionFontWeight:
						...
						_attributes?.style?.typography?.fontWeight ||
						'',
					captionFontSize: getNumber(
						firstInnerBlockAttributes?.style?.typography?.fontSize ||
							_attributes?.style?.typography?.fontSize ||
							''
					),
					captionFontSizeType: getUnit(
						firstInnerBlockAttributes?.style?.typography?.fontSize ||
							_attributes?.style?.typography?.fontSize ||
							''
					),
					captionLetterSpacing: getNumber(
						firstInnerBlockAttributes?.style?.typography?.letterSpacing ||
							_attributes?.style?.typography?.letterSpacing ||
							''
					),
					captionLetterSpacingType: getUnit(
						firstInnerBlockAttributes?.style?.typography?.letterSpacing ||
							_attributes?.style?.typography?.letterSpacing ||
							''
					),
