...
function styling( attributes, clientId, name, deviceType ) {
	...
	const selectors = {
		' .vxt-blockquote__content.block-editor-rich-text__editable': {
		...
		' .vxt-blockquote__author.block-editor-rich-text__editable': {
	...
	if ( enableTweet ) {
		selectors[ ' a.vxt-blockquote__tweet-button' ] = {
		...
		const iconMargin = vxt_ultimate_gutenberg_blocks_blocks_info.is_rtl === '1' ? 'margin-left' : 'margin-right';
	...
	const tabletSelectors = {
		...
		' a.vxt-blockquote__tweet-button': {
