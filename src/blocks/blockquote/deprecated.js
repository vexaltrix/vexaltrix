...
/**
 * BLOCK: Vexaltrix Quote Block Attributes
 */
...
export const attributes = {
	...
	descriptionText: {
		selector: 'div.vxt-blockquote__content',
		default:
	...
	author: {
		selector: '.vxt-blockquote__author',
		default: 'Author',
	},
	authorColor: {
		type: 'string',
...
const deprecated = [
	{
		...
		save( props ) {
			...
			return (
				<div
					className={ classnames( props.className, 'vxt-blockquote__outer-wrap' ) }
					id={ `vxt-blockquote-${ block_id }` }
				>
					<div
						className={ classnames(
							'vxt-blockquote__wrap',
					...
					>
						<blockquote className="vxt-blockquote">
							{ skinStyle === 'quotation' && (
								<div className="vxt-blockquote__icon-wrap">
									<span className="vxt-blockquote__icon">{ VXT_Block_Icons.quote_inline_icon }</span>
								</div>
							) }
							<div className="vxt-blockquote__content-wrap">
								{ descriptionText !== '' && (
									<Description
	...
	},
	{
		...
		save( props ) {
			...
			return (
				<div
					className={ classnames( props.className, 'vxt-blockquote__outer-wrap', `vxt-block-${ block_id }` ) }
				>
					<div
						className={ classnames(
							'vxt-blockquote__wrap',
