...
function styling( attributes, clientId, deviceType ) {
	...
	const selectors = {
		'.vxt-columns__wrap': inlineStyles( attributes ),
		' .vxt-columns__video-wrap': {
			opacity: videoOpacity,
		},
		' > .vxt-columns__inner-wrap > .block-editor-inner-blocks > .block-editor-block-list__layout': {
			'max-width': max_width,
		},
		' > .vxt-columns__inner-wrap > .block-editor-inner-blocks > .block-editor-block-list__layout > [data-type="vexaltrix/column"]':
			{
		...
		' .vxt-columns__shape-top .vxt-columns__shape-fill': {
			fill: hexToRgba(
		...
		' .vxt-columns__shape-bottom .vxt-columns__shape-fill': {
			fill: hexToRgba(
	...
	if ( 'video' === backgroundType ) {
		if ( 'color' === overlayType ) {
			...
			selectors[ ' > .vxt-columns__overlay' ][ 'background-image' ] = gradientValue;
		}
		...
		selectors[ ' > .vxt-columns__overlay' ].opacity =
