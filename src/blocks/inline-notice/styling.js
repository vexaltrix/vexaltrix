...
function styling( attributes, clientId, name, deviceType ) {
	...
	const titlePaddingRightMobile =
		'number' === typeof titleRightPaddingMobile ? titleRightPaddingMobile : titleHrPadding;
	const titlePaddingBottomMobile =
		'number' === typeof titleBottomPaddingMobile ? titleBottomPaddingMobile : titleVrPadding;
	...
	const titlePaddingRightTablet =
		'number' === typeof titleRightPaddingTablet ? titleRightPaddingTablet : titleHrPadding;
	const titlePaddingBottomTablet =
		'number' === typeof titleBottomPaddingTablet ? titleBottomPaddingTablet : titleVrPadding;
	...
	const contentPaddingTopMobile =
		'number' === typeof contentTopPaddingMobile ? contentTopPaddingMobile : contentVrPadding;
	const conttentPaddingLeftMobile =
		'number' === typeof contentLeftPaddingMobile ? contentLeftPaddingMobile : contentHrPadding;
	const contentPaddingRightMobile =
		'number' === typeof contentRightPaddingMobile ? contentRightPaddingMobile : contentHrPadding;
	const contentPaddingBottomMobile =
		'number' === typeof contentBottomPaddingMobile ? contentBottomPaddingMobile : contentVrPadding;

	const contentPaddingTopTablet =
		'number' === typeof contentTopPaddingTablet ? contentTopPaddingTablet : contentVrPadding;
	const contentPaddingLeftTablet =
		'number' === typeof contentLeftPaddingTablet ? contentLeftPaddingTablet : contentHrPadding;
	const contentPaddingRightTablet =
		'number' === typeof contentRightPaddingTablet ? contentRightPaddingTablet : contentHrPadding;
	const contentPaddingBottomTablet =
		'number' === typeof contentBottomPaddingTablet ? contentBottomPaddingTablet : contentVrPadding;
	...
	if ( 'modern' === layout ) {
		...
		selectors[ ' .rich-text.block-editor-rich-text__editable.uagb-notice-text' ][ 'border-bottom-right-radius' ] =
			'3px'; // Old User case.
		selectors[ ' .uagb-notice-text.block-editor-block-list__layout' ][ 'background-color' ] = contentBgColor;
		selectors[ ' .uagb-notice-text.block-editor-block-list__layout' ].border = '2px solid ' + noticeColor;
		selectors[ ' .uagb-notice-text.block-editor-block-list__layout' ][ 'border-bottom-left-radius' ] = '3px';
		selectors[ ' .uagb-notice-text.block-editor-block-list__layout' ][ 'border-bottom-right-radius' ] = '3px';
