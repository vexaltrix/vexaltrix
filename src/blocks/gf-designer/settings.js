...
const Settings = ( props ) => {
	...
	const fieldBorderSetting = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Field Style & Border', 'vexaltrix' ) } initialOpen={ true }>
				<MultiButtonsControl
					setAttributes={ setAttributes }
					label={ __( 'Field Style', 'vexaltrix' ) }
					data={ {
						value: fieldStyle,
						label: 'fieldStyle',
					} }
					options={ [
						{
							value: 'box',
							label: __( 'Box', 'vexaltrix' ),
						},
						{
							value: 'underline',
							label: __( 'Underline', 'vexaltrix' ),
						},
					] }
				/>
				<SpacingControl
	...
	const inputSettings = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Input', 'vexaltrix' ) } initialOpen={ false }>
				<AdvancedPopColorControl
					label={ __( 'Color', 'vexaltrix' ) }
				...
				/>
				<ResponsiveSlider
					label={ __( 'Text Area Height', 'vexaltrix' ) }
					data={ {
						desktop: {
	...
	const fieldSettings = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'General', 'vexaltrix' ) }>
				<UAGSelectControl
					...
					options={ vxt_ultimate_gutenberg_blocks_blocks_info.gf_forms }
				/>
				<ToggleControl
				...
				<MultiButtonsControl
					setAttributes={ setAttributes }
					label={ __( 'Form Title & Description', 'vexaltrix' ) }
					data={ {
					...
					options={ [
						...
						{
							value: 'none',
							label: __( 'Hide', 'vexaltrix' ),
						},
					] }
				/>
				<MultiButtonsControl
					setAttributes={ setAttributes }
					label={ __( 'Field & Input Label Alignment', 'vexaltrix' ) }
					data={ {
						value: align,
						label: 'align',
					} }
				...
				{ titleDescStyle !== 'none' && (
					<MultiButtonsControl
						setAttributes={ setAttributes }
						label={ __( 'Title & Description Alignment', 'vexaltrix' ) }
						data={ {
				...
				<MultiButtonsControl
					setAttributes={ setAttributes }
					label={ __( 'Submit Button Alignment', 'vexaltrix' ) }
					data={ {
						desktop: {
					...
					options={ [
						...
						},
						{
							...
							tooltip: __( 'Justified', 'vexaltrix' ),
						},
					] }
					showIcons={ true }
					responsive={ true }
	...
	const btnSetting = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Submit Button', 'vexaltrix' ) } initialOpen={ false }>
				{ btnBorderSetting() }
				<TypographyControl
					label={ __( 'Typography', 'vexaltrix' ) }
					attributes={ attributes }
	...
	const spacingSetting = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Spacing', 'vexaltrix' ) } initialOpen={ false }>
				<ResponsiveSlider
					label={ __( 'Label & Input Space', 'vexaltrix' ) }
					data={ {
						desktop: {
				...
				/>
				<ResponsiveSlider
					label={ __( 'Fields Space', 'vexaltrix' ) }
					data={ {
						desktop: {
							value: fieldSpacing,
							label: 'fieldSpacing',
	...
	const radioCheckSetting = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Radio & Checkbox', 'vexaltrix' ) } initialOpen={ false }>
				<ToggleControl
					label={ __( 'Override Current Style', 'vexaltrix' ) }
				...
				{ enableOveride && (
					<>
						<ResponsiveSlider
							...
							setAttributes={ setAttributes }
						/>
						<h2>{ __( 'Radio & Checkbox Label', 'vexaltrix' ) }</h2>
						<AdvancedPopColorControl
							label={ __( 'Label Color', 'vexaltrix' ) }
						...
						/>
						<AdvancedPopColorControl
							label={ __( 'Selected Color', 'vexaltrix' ) }
						...
						{ fieldBorderStyle !== 'none' && (
							<>
								<h2>{ __( 'Radio & Checkbox Border', 'vexaltrix' ) }</h2>
								<ResponsiveSlider
									label={ __( 'Width', 'vexaltrix' ) }
									data={ {
										desktop: {
						...
						<Range
							label={ __( 'Checkbox Rounded Corners', 'vexaltrix' ) }
							setAttributes={ setAttributes }
	...
	const msgSettings = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Success/Error Message', 'vexaltrix' ) } initialOpen={ false }>
				<p className="vxt-settings-notice">
					{ __( 'Note: This styling can be only seen on frontend', 'vexaltrix' ) }
				</p>
				<h2>{ __( 'Field Validation', 'vexaltrix' ) }</h2>
				<AdvancedPopColorControl
					label={ __( 'Message Color', 'vexaltrix' ) }
				...
				/>
				<ToggleControl
					label={ __( 'Advanced Settings', 'vexaltrix' ) }
				...
				{ advancedValidationSettings && (
					<>
						<AdvancedPopColorControl
							label={ __( 'Field Background Color', 'vexaltrix' ) }
				...
				{ advancedValidationSettings && (
					<>
						<AdvancedPopColorControl
							label={ __( 'Highlight Border Color', 'vexaltrix' ) }
				...
				<h2>{ __( 'Error Message Validation', 'vexaltrix' ) }</h2>
				<AdvancedPopColorControl
					label={ __( 'Color', 'vexaltrix' ) }
				...
				/>
				<h2>{ __( 'Success Message Validation', 'vexaltrix' ) }</h2>
				<AdvancedPopColorControl
					label={ __( 'Color', 'vexaltrix' ) }
