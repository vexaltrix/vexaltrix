...
function styling( attributes, clientId, deviceType ) {
	...
	selectors[ ' span.uagb-post__taxonomy' ] = {
		...
		'padding-bottom':
			...
			generateCSSUnit( taxonomyBottomSpaceFallback, taxonomyBottomSpaceUnit ),
	};
	...
	mobileSelectors = {
		...
		' span.uagb-post__taxonomy': {
			'padding-bottom':
				'aboveTitle' === displayPostTaxonomyAboveTitle &&
				generateCSSUnit( taxonomyBottomSpaceMobile, taxonomyBottomSpaceUnit ),
		},
		...
		' .uagb-post__inner-wrap .uagb-post__image': {
			...
			...( isLeftToRightLayout && 'top' === imgPosition
				? { width: 'unset', display: 'flex', 'align-items': 'center' }
				: {} ),
	...
	tabletSelectors = {
		...
		' span.uagb-post__taxonomy': {
			'padding-bottom':
				'aboveTitle' === displayPostTaxonomyAboveTitle &&
				generateCSSUnit( taxonomyBottomSpaceTablet, taxonomyBottomSpaceUnit ),
		},
		' span.uagb-post__taxonomy.highlighted': {
			'margin-bottom':
				'aboveTitle' === displayPostTaxonomyAboveTitle &&
