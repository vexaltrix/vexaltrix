...
export const PostButton = ( props ) => {
	...
	const postBtnClass = `vxt-text-link ${ buttonTypeClass }`;

	if ( attributes.displayPostLink ) {
		return (
			<div className="vxt-post__text">
				<div className={ classnames( 'vxt-post__cta', 'wp-block-button' ) }>
					<RichText
						value={ attributes.ctaText ? attributes.ctaText : __( 'Read More', 'vexaltrix' ) }
