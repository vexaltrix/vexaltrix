...
const Render = ( props ) => {
	...
	const renderEditMode = () => {
		...
		const InnerBlockProps = {
			...
			templateLock: false,
			allowedBlocks: Object.keys( getBlockMap( 'vexaltrix/post-grid' ) ),
		};
		...
		return (
			<Placeholder label="Post Carousel Layout">
				<div className="uagb-post-grid uagb-block-all-post-grid-item-template">
					...
					<InnerBlockLayoutContextProvider parentName="vexaltrix/post-grid" parentClassName="uagb-block-grid">
