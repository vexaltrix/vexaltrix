...
function CtaStyle( attributes, clientId, name, deviceType, gbsSelector = false ) {
	...
	const selectors = {
		...
		// Title Style
		' .block-editor-rich-text__editable.vxt-cta__title': {
		...
		// Description Style
		' .block-editor-rich-text__editable.vxt-cta__desc': {
	...
	if ( ctaPosition === 'right' ) {
		selectors[ '.vxt-cta__outer-wrap ' ] = {
			display: 'inline-flex',
		};
	}

	selectors[ '.vxt-cta__outer-wrap a.vxt-cta__button-link-wrapper svg' ] = {
	...
	selectors[ '.vxt-cta__outer-wrap a.vxt-cta-second__button svg' ] = {
	...
	selectors[ '.vxt-cta__outer-wrap a.vxt-cta__button-link-wrapper:hover svg' ] = {
		fill: ctaLinkHoverColor,
	};

	selectors[ '.vxt-cta__outer-wrap a.vxt-cta-second__button:hover svg' ] = {
	...
	const tabletSelectors = {
		...
		'.vxt-editor-preview-mode-tablet.vxt-cta__outer-wrap ': {
			'text-align': textAlignTablet,
		...
		'.vxt-cta__outer-wrap a.vxt-cta__button-link-wrapper svg': {
		...
		'.vxt-cta__outer-wrap a.vxt-cta-second__button svg': {
	...
	if ( ctaPosition === 'right' ) {
		tabletSelectors[ '.vxt-cta__outer-wrap.vxt-cta__content-stacked-tablet ' ] = {
			display: 'inherit',
		};
		tabletSelectors[ '.vxt-cta__content-stacked-tablet .vxt-cta__wrap ' ] = {
			width: '100%',
		};
	}
	...
	const mobileSelectors = {
		...
		'.vxt-editor-preview-mode-mobile.vxt-cta__outer-wrap ': {
			'text-align': textAlignMobile,
		...
		' .vxt-cta__button-wrapper a.vxt-cta-typeof-text': {
	...
	if ( ctaType === 'text' ) {
		selectors[ ' a.vxt-cta__button-link-wrapper' ] = {
			color: ctaBtnLinkColor,
			'border-style': 'none !important',
			'text-decoration': 'underline',
			padding: 'unset !important',
		};
		selectors[ ' a.vxt-cta__button-link-wrapper:hover ' ] = {
	...
	if ( secondCtaIconPosition === 'before' ) {
		...
		tabletSelectors[ '.vxt-cta__outer-wrap a.vxt-cta-second__button > svg' ] = {
			[ leftSideMargin ]: secondCtaIconspacingTablet,
		};
		mobileSelectors[ '.vxt-cta__outer-wrap a.vxt-cta-second__button > svg' ] = {
			[ leftSideMargin ]: secondCtaIconSpacingMobile,
		};
		selectors[ '.vxt-cta__outer-wrap div.vxt-cta-second__button > svg' ] = {
			[ leftSideMargin ]: secondCtaIconSpacing,
		};
		tabletSelectors[ '.vxt-cta__outer-wrap div.vxt-cta-second__button > svg' ] = {
			[ leftSideMargin ]: secondCtaIconspacingTablet,
		};
		mobileSelectors[ '.vxt-cta__outer-wrap div.vxt-cta-second__button > svg' ] = {
			[ leftSideMargin ]: secondCtaIconSpacingMobile,
		};
	} else {
	...
	if ( ctaIconPosition === 'before' ) {
		...
		tabletSelectors[ '.vxt-cta__outer-wrap a.vxt-cta__button-link-wrapper > svg' ] = {
			[ leftSideMargin ]: ctaIconSpacingTablet,
		};
		mobileSelectors[ '.vxt-cta__outer-wrap a.vxt-cta__button-link-wrapper > svg' ] = {
			[ leftSideMargin ]: ctaIconSpacingMobile,
		};
		selectors[ '.vxt-cta__outer-wrap div.vxt-cta__button-link-wrapper > svg' ] = {
			[ leftSideMargin ]: ctaIconSpacing,
		};
		tabletSelectors[ '.vxt-cta__outer-wrap div.vxt-cta__button-link-wrapper > svg' ] = {
			[ leftSideMargin ]: ctaIconSpacingTablet,
		};
		mobileSelectors[ '.vxt-cta__outer-wrap div.vxt-cta__button-link-wrapper > svg' ] = {
			[ leftSideMargin ]: ctaIconSpacingMobile,
		};
	} else {
		const rightSideMargin =
	...
	if ( ctaPosition === 'right' && ( ctaType === 'text' || ctaType === 'button' ) ) {
		...
		selectors[ '.vxt-cta__outer-wrap > a' ] = {
			'align-self': 'top' === buttonAlign ? 'flex-start' : 'center',
			height: 'fit-content',
			'margin-left': 'auto',
		};
		tabletSelectors[ ' .vxt-cta__wrap' ] = {
			width: generateCSSUnit( contentWidthTablet, contentWidthType ),
		};
		mobileSelectors[ ' .vxt-cta__wrap' ] = {
			width: generateCSSUnit( contentWidthMobile, contentWidthType ),
		};
	}

	if ( ctaPosition === 'right' ) {
		mobileSelectors[ '.vxt-cta__outer-wrap.vxt-cta__content-stacked-mobile ' ] = {
			display: 'inherit',
		};
		mobileSelectors[ '.vxt-cta__outer-wrap.vxt-cta__content-stacked-tablet ' ] = {
			display: 'inherit',
		};
		mobileSelectors[ '.vxt-cta__content-stacked-mobile .vxt-cta__wrap ' ] = {
			width: '100%',
		};
	}

	if ( 'below-title' === ctaPosition ) {
		mobileSelectors[ '.vxt-cta__outer-wrap ' ] = {
			display: 'inherit',
		};
	}
	if ( 'desktop' === stackBtn ) {
		...
		tabletSelectors[ ' .vxt-cta__buttons' ] = {
			'flex-direction': 'column',
			'row-gap': generateCSSUnit( gapBtnTablet, 'px' ),
		};
		mobileSelectors[ ' .vxt-cta__buttons' ] = {
			'flex-direction': 'column',
	...
	if ( ctaType === 'button' && enabledSecondCtaButton ) {
		selectors[ '.vxt-cta__outer-wrap .vxt-cta__buttons' ] = {
			width: generateCSSUnit( btncontentWidthFallback, btncontentWidthType ),
		};
		tabletSelectors[ '.vxt-cta__outer-wrap .vxt-cta__buttons' ] = {
			width: generateCSSUnit( btncontentWidthTablet, btncontentWidthType ),
		};
		mobileSelectors[ '.vxt-cta__outer-wrap .vxt-cta__buttons' ] = {
	...
	if ( 'desktop' === stack ) {
		...
		tabletSelectors[ '.vxt-cta__outer-wrap ' ] = {
			'flex-direction': 'column',
	...
	if ( ! inheritFromTheme ) {
		// CTA style.
		selectors[ '.vxt-cta__outer-wrap a.vxt-cta__button-link-wrapper' ] = {
			'font-size': generateCSSUnit( ctaFontSize, ctaFontSizeType ),
		...
		// Core Theme CSS
		selectors[
			`.vxt-cta__outer-wrap.wp-block-button:not(.is-style-outline) a.vxt-cta__button-link-wrapper .wp-block-button__link:not(.has-background)`
		] = {
			'font-size': generateCSSUnit( ctaFontSize, ctaFontSizeType ),
			'font-family': ctaFontFamily,
			'font-style': ctaFontStyle,
		...
		selectors[
			`.vxt-cta__outer-wrap.wp-block-button:not(.is-style-outline) a.vxt-cta__button-link-wrapper.wp-block-button__link:not(.has-background):hover`
		] = {
			color: ctaLinkHoverColor,
		...
		tabletSelectors[ '.vxt-cta__outer-wrap a.vxt-cta__button-link-wrapper' ] = {
			'font-size': generateCSSUnit( ctaFontSizeTablet, ctaFontSizeTypeTablet ),
			'padding-top': generateCSSUnit( ctaTopPaddingTablet, tabletCTAPaddingUnit ),
			'padding-bottom': generateCSSUnit( ctaBottomPaddingTablet, tabletCTAPaddingUnit ),
			'padding-left': generateCSSUnit( ctaLeftPaddingTablet, tabletCTAPaddingUnit ),
		...
		mobileSelectors[ '.vxt-cta__outer-wrap a.vxt-cta__button-link-wrapper' ] = {
			'font-size': generateCSSUnit( ctaFontSizeMobile, ctaFontSizeTypeMobile ),
			'padding-top': generateCSSUnit( ctaTopPaddingMobile, mobileCTAPaddingUnit ),
			'padding-bottom': generateCSSUnit( ctaBottomPaddingMobile, mobileCTAPaddingUnit ),
			'padding-left': generateCSSUnit( ctaLeftPaddingMobile, mobileCTAPaddingUnit ),
	...
	if ( ! secInheritFromTheme ) {
		selectors[ '.vxt-cta__outer-wrap a.vxt-cta-second__button' ] = {
			'font-size': generateCSSUnit( secondCtaFontSize, secondCtaFontSizeType ),
		...
		selectors[ '.vxt-cta__outer-wrap a.vxt-cta-second__button:hover' ] = {
		...
		selectors[ '.vxt-cta__outer-wrap a.vxt-cta__button-link-wrapper:hover' ] = {
			color: ctaLinkHoverColor,
			'background-color': ctaBgHoverType === 'color' ? ctaBgHoverColor : 'transparent',
			'border-color': btnBorderHColor,
		};
		tabletSelectors[ '.vxt-cta__outer-wrap a.vxt-cta-second__button' ] = {
			'font-size': generateCSSUnit( secondCtaFontSizeTablet, secondCtaFontSizeTypeTablet ),
		...
		mobileSelectors[ '.vxt-cta__outer-wrap a.vxt-cta-second__button' ] = {
			'font-size': generateCSSUnit( secondCtaFontSizeMobile, secondCtaFontSizeTypeMobile ),
	...
	const base_selector = gbsSelector
		? `.editor-styles-wrapper ${ gbsSelector } `
		: `.editor-styles-wrapper #block-${ clientId } .vxt-block-${ block_id }`;
