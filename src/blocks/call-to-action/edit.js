...
const VexaltrixCallToAction = ( props ) => {
	const {
		isSelected,
		setAttributes,
		attributes,
	...
	const blockStyling = useMemo(
		() => CtaStyle( attributes, clientId, name, deviceType ),
...
export default compose( addInitialAttr, AddStaticStyles, AddGBSStyles )( VexaltrixCallToAction );
