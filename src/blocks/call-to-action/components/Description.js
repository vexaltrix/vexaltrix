...
const Description = ( props ) => {
	...
	if ( 'not_set' === setAttributes && ! enableMultilineParagraph ) {
		return <RichText.Content tagName="p" value={ attributes.description } className="vxt-cta__desc" />;
	}
	...
	return <>{ enableMultilineParagraph ? <div { ...innerBlocksProps } /> : originalContent }</>;
};
