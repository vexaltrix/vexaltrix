...
export default function save( props ) {
	const { block_id, htmlTag, ctaType, ctaLink, ctaTarget, ctaTitle, description, enabledSecondCtaButton } =
		props.attributes;
	...
	return (
		<CustomTag className={ classnames( `vxt-block-${ block_id }`, 'button' === ctaType ? 'wp-block-button' : '' ) }>
			{ ctaType === 'all' && (
				<>
