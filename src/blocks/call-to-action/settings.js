...
const Settings = ( props ) => {
	...
	const secBtnSettings = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Additional Button', 'vexaltrix' ) } initialOpen={ false }>
				<ToggleControl
					label={ __( 'Enable Additional Button', 'vexaltrix' ) }
				...
				{ enabledSecondCtaButton && (
					<>
						...
						<ToggleControl
							...
							onChange={ () => setAttributes( { secInheritFromTheme: ! secInheritFromTheme } ) }
	...
	const ctaSettings = () => {
		return (
			<>
				<UAGAdvancedPanelBody title={ __( 'Button', 'vexaltrix' ) } initialOpen={ false }>
					<MultiButtonsControl
						setAttributes={ setAttributes }
		...
		return (
			<UAGAdvancedPanelBody title={ __( 'Spacing', 'vexaltrix' ) } initialOpen={ false }>
				{ ( ( 'right' !== textAlign && 'none' === stack && 'Desktop' === deviceType ) ||
					...
					<ResponsiveSlider
						label={ __( 'Content And Buttons Gap', 'vexaltrix' ) }
						data={ {
							desktop: {
		...
		return (
			<UAGAdvancedPanelBody title={ __( 'Layout', 'vexaltrix' ) } initialOpen={ true }>
				...
				<MultiButtonsControl
					...
					showIcons={ false }
					help={ __( 'Note: Choose on what breakpoint the CTA button will stack.', 'vexaltrix' ) }
				/>
				<MultiButtonsControl
					setAttributes={ setAttributes }
				...
				{ ctaType !== 'all' && ctaType !== 'none' && ctaType !== 'text' && (
					<>
						{ enabledSecondCtaButton && (
							<>
								<ResponsiveSlider
									label={ __( 'Buttons Width', 'vexaltrix' ) }
									data={ {
										desktop: {
