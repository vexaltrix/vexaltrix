...
function styling( attributes, clientId, name, deviceType, gbsSelector = false ) {
	...
	const getFlippedAlignment = ( alignment ) => {
		...
		if ( '1' !== vxt_ultimate_gutenberg_blocks_blocks_info.is_rtl ) {
			return alignment;
		}
	...
	const rightSidePadding =
		vxt_ultimate_gutenberg_blocks_blocks_info.is_rtl === '1' ? 'padding-left' : 'padding-right';
	const leftSidePadding = vxt_ultimate_gutenberg_blocks_blocks_info.is_rtl === '1' ? 'padding-right' : 'padding-left';
	...
	const selectors = {
		...
		' .vxt-iconbox-icon-wrap': {
			...
			'line-height': generateCSSUnit( iconSizeFallback, iconSizeType ),
			[ leftSidePadding ]: generateCSSUnit( iconLeftMargin, iconMarginUnit ),
			[ rightSidePadding ]: generateCSSUnit( iconRightMargin, iconMarginUnit ),
		...
		'.vxt-infobox-icon-right .vxt-ifb-icon-wrap:hover > svg:hover': {
			fill: iconHover,
		},
		'.vxt-infobox__content-wrap .vxt-ifb-icon-wrap > svg:hover': {
			fill: iconHover,
		},
		'.vxt-infobox_cta-type-all:hover .vxt-infobox__content-wrap svg': {
			fill: iconHover,
			color: iconHover,
		},
		'.vxt-infobox__content-wrap .vxt-ifb-icon-wrap > svg': {
		...
		'.vxt-infobox__content-wrap .vxt-ifb-image-content > img': {
			[ leftSidePadding ]: generateCSSUnit( iconLeftMargin, iconMarginUnit ),
			[ rightSidePadding ]: generateCSSUnit( iconRightMargin, iconMarginUnit ),
			'padding-top': generateCSSUnit( iconTopMargin, iconMarginUnit ),
			'padding-bottom': generateCSSUnit( iconBottomMargin, iconMarginUnit ),
		...
		// Prefix Style
		' .block-editor-rich-text__editable.vxt-ifb-title-prefix': {
		...
		// Title Style
		' .block-editor-rich-text__editable.vxt-ifb-title a': {
			color: headingColor,
		},
		' .block-editor-rich-text__editable.vxt-ifb-title': {
		...
		' .block-editor-rich-text__editable.vxt-ifb-desc': {
			'font-size': generateCSSUnit( subHeadFontSize, subHeadFontSizeType ),
			'font-family': subHeadFontFamily,
			'font-weight': subHeadFontWeight,
			'line-height': generateCSSUnit( subHeadLineHeight, subHeadLineHeightType ),
		...
		'.vxt-infobox__content-wrap': mainContainerBorderCSS,
	...
	const tabletSelectors = {
		...
		'.vxt-infobox__content-wrap .vxt-ifb-icon-wrap > svg': {
			'padding-top': generateCSSUnit( iconMarginTopTablet, iconTabletMarginUnit ),
			[ rightSidePadding ]: generateCSSUnit( iconMarginRightTablet, iconTabletMarginUnit ),
			'padding-bottom': generateCSSUnit( iconMarginBottomTablet, iconTabletMarginUnit ),
			[ leftSidePadding ]: generateCSSUnit( iconMarginLeftTablet, iconTabletMarginUnit ),
		},
		'.vxt-infobox__content-wrap .vxt-ifb-content .vxt-ifb-icon-wrap > svg': {
			'padding-top': generateCSSUnit( iconMarginTopTablet, iconTabletMarginUnit ),
			[ rightSidePadding ]: generateCSSUnit( iconMarginRightTablet, iconTabletMarginUnit ),
		...
		'.vxt-infobox__content-wrap': mainContainerBorderCSSTablet,
	};
	...
	const mobileSelectors = {
		...
		'.vxt-infobox__content-wrap .vxt-ifb-icon-wrap > svg': {
			'padding-top': generateCSSUnit( iconMarginTopMobile, iconMobileMarginUnit ),
			[ rightSidePadding ]: generateCSSUnit( iconMarginRightMobile, iconMobileMarginUnit ),
			'padding-bottom': generateCSSUnit( iconMarginBottomMobile, iconMobileMarginUnit ),
			[ leftSidePadding ]: generateCSSUnit( iconMarginLeftMobile, iconMobileMarginUnit ),
		},
		'.vxt-infobox__content-wrap .vxt-ifb-content .vxt-ifb-icon-wrap > svg': {
			'padding-top': generateCSSUnit( iconMarginTopMobile, iconMobileMarginUnit ),
			[ rightSidePadding ]: generateCSSUnit( iconMarginRightMobile, iconMobileMarginUnit ),
		...
		'.vxt-infobox__content-wrap': mainContainerBorderCSSMobile,
	};

	if ( iconimgPosition === 'left' || iconimgPosition === 'right' ) {
		if ( stack === 'none' ) {
			tabletSelectors[ ' .vxt-infobox-margin-wrapper' ] = {
				display: 'flex',
			};
			mobileSelectors[ ' .vxt-infobox-margin-wrapper' ] = {
				display: 'flex',
			};
	...
	if ( iconimgPosition === 'above-title' ) {
		...
		tabletSelectors[ '.vxt-infobox-icon-above-title' ] = {
			'text-align': flippedHeadingAlignTablet,
		};
		mobileSelectors[ '.vxt-infobox-icon-above-title' ] = {
	...
	if ( iconimgPosition === 'below-title' ) {
		...
		tabletSelectors[ '.vxt-infobox-icon-below-title' ] = {
			'text-align': flippedHeadingAlignTablet,
		};
		mobileSelectors[ '.vxt-infobox-icon-below-title' ] = {
			'text-align': flippedHeadingAlignMobile,
		};
	}
	...
	tabletSelectors[ '.vxt-infobox__content-wrap:not(.wp-block-vxt-info-box--has-margin)' ] = {
	...
	tabletSelectors[ '.vxt-infobox__content-wrap.wp-block-vxt-info-box--has-margin .vxt-infobox-margin-wrapper' ] = {
		'padding-top': generateCSSUnit( blockTopPaddingTablet, blockPaddingUnitTablet ),
		'padding-right': generateCSSUnit( blockRightPaddingTablet, blockPaddingUnitTablet ),
		'padding-bottom': generateCSSUnit( blockBottomPaddingTablet, blockPaddingUnitTablet ),
		'padding-left': generateCSSUnit( blockLeftPaddingTablet, blockPaddingUnitTablet ),
	...
	mobileSelectors[ '.vxt-infobox__content-wrap:not(.wp-block-vxt-info-box--has-margin)' ] = {
	...
	mobileSelectors[ '.vxt-infobox__content-wrap.wp-block-vxt-info-box--has-margin .vxt-infobox-margin-wrapper' ] = {
		'padding-top': generateCSSUnit( blockTopPaddingMobile, blockPaddingUnitMobile ),
		'padding-right': generateCSSUnit( blockRightPaddingMobile, blockPaddingUnitMobile ),
		'padding-bottom': generateCSSUnit( blockBottomPaddingMobile, blockPaddingUnitMobile ),
		'padding-left': generateCSSUnit( blockLeftPaddingMobile, blockPaddingUnitMobile ),
	...
	if ( imageWidthType ) {
		// Image
		selectors[ '.vxt-infobox__content-wrap img' ] = {
			width: generateCSSUnit( imageWidthFallback, imageWidthUnit ),
		};
		selectors[ '.vxt-infobox__content-wrap .vxt-ifb-content .vxt-ifb-right-title-image > img' ] = {
			width: generateCSSUnit( imageWidthFallback, imageWidthUnit ),
		};
		selectors[ '.vxt-infobox__content-wrap .vxt-ifb-content .vxt-ifb-left-title-image > img' ] = {
			width: generateCSSUnit( imageWidthFallback, imageWidthUnit ),
		};
		selectors[ '.vxt-infobox__content-wrap .vxt-ifb-content .vxt-ifb-image-content > img' ] = {
			width: generateCSSUnit( imageWidthFallback, imageWidthUnit ),
		};

		tabletSelectors[ '.vxt-infobox__content-wrap img' ] = {
			width: generateCSSUnit( imageWidthFallbackTablet, imageWidthUnitTablet ),
		};
		tabletSelectors[ '.vxt-infobox__content-wrap .vxt-ifb-content .vxt-ifb-right-title-image > img' ] = {
			width: generateCSSUnit( imageWidthFallbackTablet, imageWidthUnitTablet ),
		};
		tabletSelectors[ '.vxt-infobox__content-wrap .vxt-ifb-content .vxt-ifb-left-title-image > img' ] = {
			width: generateCSSUnit( imageWidthFallbackTablet, imageWidthUnitTablet ),
		};
		tabletSelectors[ '.vxt-infobox__content-wrap .vxt-ifb-content .vxt-ifb-image-content > img' ] = {
			width: generateCSSUnit( imageWidthFallbackTablet, imageWidthUnitTablet ),
		};

		mobileSelectors[ '.vxt-infobox__content-wrap img' ] = {
			width: generateCSSUnit( imageWidthFallbackMobile, imageWidthUnitMobile ),
		};
		mobileSelectors[ '.vxt-infobox__content-wrap .vxt-ifb-content .vxt-ifb-right-title-image > img' ] = {
			width: generateCSSUnit( imageWidthFallbackMobile, imageWidthUnitMobile ),
		};
		mobileSelectors[ '.vxt-infobox__content-wrap .vxt-ifb-content .vxt-ifb-left-title-image > img' ] = {
			width: generateCSSUnit( imageWidthFallbackMobile, imageWidthUnitMobile ),
		};
		mobileSelectors[ '.vxt-infobox__content-wrap .vxt-ifb-content .vxt-ifb-image-content > img' ] = {
			width: generateCSSUnit( imageWidthFallbackMobile, imageWidthUnitMobile ),
		};
	}
	...
	if ( 'after' === ctaIconPosition ) {
		const rightSideMargin =
			vxt_ultimate_gutenberg_blocks_blocks_info.is_rtl === '1' ? 'margin-right' : 'margin-left';

		selectors[ '.vxt-infobox__content-wrap .vxt-infobox-cta-link > svg' ] = {
			[ rightSideMargin ]: ctaIconSpacing,
		};
		tabletSelectors[ '.vxt-infobox__content-wrap .vxt-infobox-cta-link > svg' ] = {
			[ rightSideMargin ]: ctaIconSpacingTablet,
		};
		mobileSelectors[ '.vxt-infobox__content-wrap .vxt-infobox-cta-link > svg' ] = {
			[ rightSideMargin ]: ctaIconSpacingMobile,
		};
	} else {
		const leftSideMargin =
			vxt_ultimate_gutenberg_blocks_blocks_info.is_rtl === '1' ? 'margin-left' : 'margin-right';
	...
	if ( ! inheritFromTheme ) {
		...
		selectors[ ' div.vxt-ifb-cta a.vxt-infobox-cta-link' ] = {
		...
		selectors[ ' div.vxt-ifb-cta a.vxt-infobox-cta-link:hover' ] = {
		...
		selectors[
			'.vxt-infobox__content-wrap .vxt-ifb-cta .vxt-ifb-button-wrapper.wp-block-button a.vxt-infobox-cta-link.wp-block-button__link'
		] = {
			color: ctaBtnLinkColor,
		...
		selectors[
			'.vxt-infobox__content-wrap .vxt-ifb-cta .vxt-ifb-button-wrapper.wp-block-button a.vxt-infobox-cta-link.wp-block-button__link:hover'
		] = {
			color: ctaLinkHoverColor,
			'background-color': ctaBgHoverType === 'color' ? ctaBgHoverColor : 'transparent',
			'border-color': btnBorderHColor,
		};
		selectors[ ' .vxt-ifb-button-wrapper .vxt-infobox-cta-link:hover' ] = {
			color: ctaLinkHoverColor,
			'background-color': ctaBgHoverType === 'color' ? ctaBgHoverColor : 'transparent',
			'border-color': btnBorderHColor,
		};
		...
		selectors[ ' .vxt-ifb-button-wrapper .vxt-infobox-cta-link:hover svg' ] = {
			fill: ctaLinkHoverColor,
		};
		...
		tabletSelectors[ ' .vxt-infobox-cta-link' ] = {
		...
		mobileSelectors[ ' .vxt-infobox-cta-link' ] = {
			'font-size': generateCSSUnit( ctaFontSizeMobile, ctaFontSizeTypeMobile ),
		...
		selectors[ ' .vxt-infobox-cta-link.wp-block-button__link' ] = ctaBorderCSS;
		mobileSelectors[ ' .vxt-infobox-cta-link.wp-block-button__link' ] = ctaBorderCSSMobile;
		tabletSelectors[ ' .vxt-infobox-cta-link.wp-block-button__link' ] = ctaBorderCSSTablet;
	}

	const base_selector =
		'.editor-styles-wrapper ' +
		( gbsSelector ? gbsSelector + ' ' : `#block-${ clientId } .vxt-block-${ block_id }` );
