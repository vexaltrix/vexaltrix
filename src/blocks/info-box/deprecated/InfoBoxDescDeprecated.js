/**
 * Deprecation of InfoBoxDesc component for old versions before 2.13.2.
 */
...
const InfoBoxDesc = ( props ) => {
	...
	if ( 'not_set' === setAttributes ) {
		return <RichText.Content tagName="p" value={ headingDesc } className="vxt-ifb-desc" />;
	}
