...
const imageWidthDefault =
	'yes' === vxt_ultimate_gutenberg_blocks_blocks_info.vxt_ultimate_gutenberg_blocks_old_user_less_than_2 ? 120 : '';
...
const attributes = {
	inheritFromTheme: {
		type: 'boolean',
		default: 'enabled' === vxt_ultimate_gutenberg_blocks_blocks_info.btn_inherit_from_theme,
	},
	prefixTitle: {
		source: 'html',
		selector: 'span.vxt-ifb-title-prefix',
		default: __( 'Prefix', 'vexaltrix' ),
	},
	classMigrate: {
		type: 'boolean',
		default: false,
	...
	infoBoxTitle: {
		source: 'html',
		selector: '.vxt-ifb-title',
		default: __( 'Info Box', 'vexaltrix' ),
	},
	headingDesc: {
		source: 'html',
		selector: '.vxt-ifb-desc',
		default: __(
