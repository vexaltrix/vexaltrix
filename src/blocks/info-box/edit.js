...
const VexaltrixInfoBox = ( props ) => {
	...
	useEffect( () => {
		if (
			( hasDynamicImg || hasDescriptionDC || hasPrefixTitleDC || hasTitleDC ) &&
			! attributes?.context?.postId
		) {
...
export default compose( addInitialAttr, AddStaticStyles, InfoBoxWrapper, AddGBSStyles )( VexaltrixInfoBox );
