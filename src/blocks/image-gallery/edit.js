...
const VexaltrixImageGallery = ( props ) => {
	const {
		clientId,
		attributes,
	...
	useEffect( () => {
		...
		if ( ! vxt_ultimate_gutenberg_blocks_blocks_info.vexaltrix_pro_status && 'url' === imageClickEvent ) {
...
export default compose( addInitialAttr, AddStaticStyles )( VexaltrixImageGallery );
