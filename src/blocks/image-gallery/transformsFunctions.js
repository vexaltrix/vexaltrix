...
export const pickRelevantMediaFiles = ( image, thumbnailSize, mediumSize, largeSize, fullSize, oldImages ) => {
	...
	if (
		( image.id && ! image.sizes && ! image.media_details ) ||
		( 'medium_large' === thumbnailSize && ! oldThumbnailSize )
	) {
	...
	sizes.thumbnail = {
		height:
			get( image, [ 'sizes', thumbnailSize, 'height' ] ) ||
			get( image, [ 'media_details', 'sizes', thumbnailSize, 'height' ] ) ||
			undefined,
		width:
			get( image, [ 'sizes', thumbnailSize, 'width' ] ) ||
			get( image, [ 'media_details', 'sizes', thumbnailSize, 'width' ] ) ||
			undefined,
		url:
			get( image, [ 'sizes', thumbnailSize, 'url' ] ) ||
			get( image, [ 'media_details', 'sizes', thumbnailSize, 'source_url' ] ) ||
			oldThumbnailSize ||
			image?.url ||
			image?.source_url,
	...
	sizes.medium = {
		height:
			get( image, [ 'sizes', mediumSize, 'height' ] ) ||
			get( image, [ 'media_details', 'sizes', mediumSize, 'height' ] ) ||
			undefined,
		width:
			get( image, [ 'sizes', mediumSize, 'width' ] ) ||
			get( image, [ 'media_details', 'sizes', mediumSize, 'width' ] ) ||
			undefined,
		url:
			get( image, [ 'sizes', mediumSize, 'url' ] ) ||
			get( image, [ 'media_details', 'sizes', mediumSize, 'source_url' ] ) ||
			oldMediumSize ||
			image?.url ||
			image?.source_url,
		orientation: getOrientation(
	...
	sizes.large = {
		height:
			get( image, [ 'sizes', largeSize, 'height' ] ) ||
			get( image, [ 'media_details', 'sizes', largeSize, 'height' ] ) ||
			undefined,
		width:
			get( image, [ 'sizes', largeSize, 'width' ] ) ||
			get( image, [ 'media_details', 'sizes', largeSize, 'width' ] ) ||
			undefined,
		url:
			get( image, [ 'sizes', largeSize, 'url' ] ) ||
			get( image, [ 'media_details', 'sizes', largeSize, 'source_url' ] ) ||
			oldLargeSize ||
			image?.url ||
			image?.source_url,
		orientation: getOrientation(
	...
	sizes.full = {
		url:
			get( image, [ 'sizes', fullSize, 'url' ] ) ||
			get( image, [ 'media_details', 'sizes', fullSize, 'source_url' ] ) ||
			image?.url ||
			image?.source_url,
		height:
			get( image, [ 'sizes', fullSize, 'height' ] ) ||
			get( image, [ 'media_details', 'sizes', fullSize, 'height' ] ) ||
			undefined,
		width:
			get( image, [ 'sizes', fullSize, 'width' ] ) ||
