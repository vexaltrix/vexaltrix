...
const Lightbox = ( { attributes, setAttributes, setLightboxPreview } ) => {
	...
	const renderLightbox = () => (
		<div className="swiper vexaltrix-image-gallery__control-lightbox--main" ref={ lightboxRef }>
						...
						{ lightboxDisplayCaptions && (
							<div
								className={ applyFilters(
									'vexaltrix.image-gallery.render.lightboxCaptionClasses',
	...
	const renderThumbnails = () => (
		<div
			className="vexaltrix-image-gallery__control-lightbox--thumbnails-wrapper"
			style={ {
				display: lightboxThumbnails ? undefined : 'none',
			} }
		>
			<div className="swiper vexaltrix-image-gallery__control-lightbox--thumbnails" ref={ thumbnailRef }>
				<div className="swiper-wrapper">
					{ mediaGallery.map(
						( media ) =>
	...
	return (
		<div className="vexaltrix-image-gallery__control-lightbox">
			{ renderLightbox() }
			{ renderThumbnails() }
			{ lightboxDisplayCount && (
				<div className="vexaltrix-image-gallery__control-lightbox--count">{ `${
					CurrentSlide + 1
				} / ${ lightboxTotal }` }</div>
			) }
			{ lightboxCloseIcon && (
				<button
					className="vexaltrix-image-gallery__control-lightbox--close"
