...
const UAGPresets = ( props ) => {
	...
	const presetDropdown = (
		<SelectControl
			className="vxt-presets-dropdown"
	...
	const presetRadioImage = (
		<>
			<div className="vxt-presets-radio-image-wrap">{ presetRadioImageOptions }</div>
		</>
	);
	...
	return (
		<div ref={ panelRef } className="components-base-control">
			...
			<div className={ classnames( className, 'vxt-presets-main-wrap' ) }>
				<div className="vxt-presets-label-reset-wrap">
...
UAGPresets.defaultProps = {
	...
	label: __( 'Select Preset', 'vexaltrix' ),
};
