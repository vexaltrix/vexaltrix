...
function FontFamilyControl( props ) {
	...
	const customFonts = vxt_ultimate_gutenberg_blocks_blocks_info.vexaltrix_custom_fonts;
	...
	const onFontfamilyChange = ( value ) => {
		...
		const { loadGoogleFonts, fontFamily } = props;
	...
	if ( true !== props.disableFontSize ) {
		fontSize = (
			<RangeTypographyControl
				...
				typeLabelMobile={
					props.fontSizeTypeMobile?.label ? props.fontSizeTypeMobile.label : props.fontSizeType.label
				}
				typeTablet={ props.fontSizeTypeTablet ? props.fontSizeTypeTablet : props.fontSizeType }
				typeLabelTablet={
					props.fontSizeTypeTablet?.label ? props.fontSizeTypeTablet.label : props.fontSizeType.label
				}
				...
				min={ 0 }
				sizeMobileText={ ! props.fontSizeLabel ? __( 'Font Size', 'vexaltrix' ) : props.fontSizeLabel }
				sizeTabletText={ ! props.fontSizeLabel ? __( 'Font Size', 'vexaltrix' ) : props.fontSizeLabel }
				sizeText={ ! props.fontSizeLabel ? __( 'Font Size', 'vexaltrix' ) : props.fontSizeLabel }
				units={ [
					{
		...
		<>
			...
			<div className="components-base-control uag-font-family-searchable-select__wrapper">
				...
				<Select
					...
					placeholder={ __( 'Default', 'vexaltrix' ) }
			...
			{ props.fontStyle && (
				<UAGSelectControl
					...
					options={ [
						...
						{
							value: 'italic',
							label: __( 'Italic', 'vexaltrix' ),
						},
						{
							value: 'oblique',
							label: __( 'Oblique', 'vexaltrix' ),
						},
					] }
				/>
			) }
