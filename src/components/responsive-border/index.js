...
const defaultProps = {
	...
	borderColorLabel: __( 'Color', 'vexaltrix' ),
...
const ResponsiveBorder = ( props ) => {
	...
	const {
		...
		normalTabLabel = __( 'Normal', 'vexaltrix' ),
		hoverTabLabel = __( 'Hover', 'vexaltrix' ),
		borderRadiusHelp,
		help = false,
	} = props;
	...
	const advancedControls = (
		<>
			{ ! disabledBorderTitle && <p className="vexaltrix-panel__body-sub-heading">{ label }</p> }
			<UAGSelectControl
