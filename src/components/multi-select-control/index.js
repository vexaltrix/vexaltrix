...
export default function UAGMultiSelectControl( props ) {
	const { label, options, data, isSearchable, setAttributes, help } = props;
	...
	return (
		<div ref={ panelRef } className="vexaltrix-multi-select-control components-base-control">
			...
			<Select
				...
				classNamePrefix={ 'vexaltrix-multi-select' }
				className={ 'vexaltrix-multi-select' }
