...
const SpacingControl = ( props ) => {
	...
	const getPlaceholder = ( currentDevice, mobileValue, tabletValue, desktopValue ) => {
		switch ( currentDevice ) {
			...
			case 'mobile':
				if (
					'number' === typeof valueRightTablet.value ||
					'number' === typeof valueTopTablet.value ||
					'number' === typeof valueBottomTablet.value ||
					'number' === typeof valueLeftTablet.value
				) {
	...
	if ( link ) {
		linkHtml = (
			<span
				className="vxt-spacing-control__link vxt-spacing-control-connected dashicons dashicons-admin-links "
				onClick={ () => {
		...
		if ( ! link.value ) {
			linkHtml = (
				<span
					className="vxt-spacing-control__link vxt-spacing-control-disconnected dashicons dashicons-editor-unlink"
					onClick={ () => {
						onLinkClickHandler();
	...
	output.Desktop = (
		<>
			<div className="vxt-spacing-control__inputs">
				<input
					className="vxt-spacing-control__number"
					type="number"
					min={ min }
	...
	return (
		<div ref={ panelRef } className="components-base-control">
			...
			<div className="vxt-spacing-control">
				<div className="vxt-size-type-field-tabs">
					<div className="vxt-control__header">
						...
						<div className="vxt-control__actions">
							<UAGReset
								onReset={ resetValues }
								attributeNames={ [
									valueTop?.label,
					...
					<div className="vxt-spacing-control__input-labels">
						<span className="vxt-spacing-control__number-label">{ __( 'Top', 'vexaltrix' ) }</span>
						<span className="vxt-spacing-control__number-label">{ __( 'Right', 'vexaltrix' ) }</span>
						<span className="vxt-spacing-control__number-label">{ __( 'Bottom', 'vexaltrix' ) }</span>
						<span className="vxt-spacing-control__number-label">{ __( 'Left', 'vexaltrix' ) }</span>
						<span className="vxt-spacing-control__number-label vxt-spacing-control__link-label"></span>
					</div>
				</div>
