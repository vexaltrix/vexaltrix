...
// Add fonts.
\Vexaltrix\Core\Blocks\BlockJs::blocksAdvancedHeadingGfont( $attr );

$mSelectors = [];
$tSelectors = [];

$highlightBorderCss        = \Vexaltrix\Core\Blocks\BlockHelper::uagGenerateBorderCss( $attr, 'highLight' );
$highlightBorderCssTablet = \Vexaltrix\Core\Blocks\BlockHelper::uagGenerateBorderCss( $attr, 'highLight', 'tablet' );
$highlightBorderCssMobile = \Vexaltrix\Core\Blocks\BlockHelper::uagGenerateBorderCss( $attr, 'highLight', 'mobile' );
...
$selectors = [
	...
	'.wp-block-vxt-advanced-heading .vxt-highlight'    => array_merge(
		[
			...
			'font-size'               => \Vexaltrix\Support\Helper::getCssValue( $attr['highLightFontSize'], $attr['highLightFontSizeType'] ),
			'line-height'             => \Vexaltrix\Support\Helper::getCssValue( $attr['highLightLineHeight'], $attr['highLightLineHeightType'] ),
			'padding-top'             => \Vexaltrix\Support\Helper::getCssValue(
...
$headingTextShadowColor = ( ! empty( $attr['headShadowColor'] ) ? \Vexaltrix\Support\Helper::getCssValue( $attr['headShadowHOffset'], 'px' ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $attr['headShadowVOffset'], 'px' ) . ' ' . \Vexaltrix\Support\Helper::getCssValue( $attr['headShadowBlur'], 'px' ) . ' ' . $attr['headShadowColor'] : '' );
...
$tSelectors['.wp-block-vxt-advanced-heading .vxt-highlight'] = array_merge(
	[
		'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['highLightTopPaddingTablet'], $attr['highLightPaddingUnitTablet'] ),
		'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['highLightRightPaddingTablet'], $attr['highLightPaddingUnitTablet'] ),
		'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['highLightBottomPaddingTablet'], $attr['highLightPaddingUnitTablet'] ),
		'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['highLightLeftPaddingTablet'], $attr['highLightPaddingUnitTablet'] ),
	],
...
$mSelectors['.wp-block-vxt-advanced-heading .vxt-highlight'] = array_merge(
	[
		'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['highLightTopPaddingMobile'], $attr['highLightPaddingUnitMobile'] ),
		'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['highLightRightPaddingMobile'], $attr['highLightPaddingUnitMobile'] ),
		'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['highLightBottomPaddingMobile'], $attr['highLightPaddingUnitMobile'] ),
		'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['highLightLeftPaddingMobile'], $attr['highLightPaddingUnitMobile'] ),
	],
...
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'head', ' .vxt-heading-text', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'subHead', ' .vxt-desc-text', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'highLight', '.wp-block-vxt-advanced-heading .vxt-highlight', $combinedSelectors );
