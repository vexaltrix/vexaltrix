...
// Adds Fonts.
\Vexaltrix\Core\Blocks\BlockJs::blocksGfStylerGfont( $attr );
...
$selectors = [
	...
	' .gform_wrapper input:not([type=submit])'             => [
		...
		'border-width'     => \Vexaltrix\Support\Helper::getCssValue(
			$attr['fieldBorderWidth'],
			$attr['fieldBorderWidthType']
		),
		'border-radius'    => \Vexaltrix\Support\Helper::getCssValue(
			$attr['fieldBorderRadius'],
			$attr['fieldBorderRadiusType']
		),
		'padding-left'     => \Vexaltrix\Support\Helper::getCssValue( $fieldLeftPadding, $attr['fieldpaddingUnit'] ),
		'padding-right'    => \Vexaltrix\Support\Helper::getCssValue( $fieldRightPadding, $attr['fieldpaddingUnit'] ),
		'padding-top'      => \Vexaltrix\Support\Helper::getCssValue( $fieldTopPadding, $attr['fieldpaddingUnit'] ),
		'padding-bottom'   => \Vexaltrix\Support\Helper::getCssValue( $fieldBottomPadding, $attr['fieldpaddingUnit'] ),
	...
	' input[type=button]'                                  => [
		...
		'padding-left'     => \Vexaltrix\Support\Helper::getCssValue( $buttonLeftPadding, $attr['buttonpaddingUnit'] ),
		'padding-right'    => \Vexaltrix\Support\Helper::getCssValue( $buttonRightPadding, $attr['buttonpaddingUnit'] ),
		'padding-top'      => \Vexaltrix\Support\Helper::getCssValue( $buttonTopPadding, $attr['buttonpaddingUnit'] ),
		'padding-bottom'   => \Vexaltrix\Support\Helper::getCssValue( $buttonBottomPadding, $attr['buttonpaddingUnit'] ),
	],
	...
	' .gform_footer.top_label input[type="submit"]'        => [
		'font-size' => \Vexaltrix\Support\Helper::getCssValue( $attr['buttonFontSize'], $attr['buttonFontSizeType'] ),
	],
	...
	' .gfield_checkbox input[type="checkbox"] + label:before' => [
		'background-color' => $attr['fieldBgColor'],
		'color'            => $attr['fieldInputColor'],
		'height'           => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldVrPadding'], 'px' ),
		'width'            => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldVrPadding'], 'px' ),
		'border-style'     => $attr['fieldBorderStyle'],
		'border-color'     => $attr['fieldBorderColor'],
		'border-width'     => \Vexaltrix\Support\Helper::getCssValue(
			$attr['fieldBorderWidth'],
	...
	' .vxt-gf-styler__field-style-underline .gform_wrapper input:not([type=submit])' => [
		...
		'border-bottom-width' => \Vexaltrix\Support\Helper::getCssValue(
			$attr['fieldBorderWidth'],
			$attr['fieldBorderWidthType']
		),
		'border-radius'       => \Vexaltrix\Support\Helper::getCssValue(
	...
	' .vxt-gf-styler__check-style-enabled .gfield_checkbox input[type="checkbox"] + label:before' => [
		...
		'height'           => \Vexaltrix\Support\Helper::getCssValue(
			$attr['radioCheckSize'],
			'px'
		),
		'width'            => \Vexaltrix\Support\Helper::getCssValue(
			$attr['radioCheckSize'],
			'px'
		),
		'font-size'        => 'calc( ' . $attr['radioCheckSize'] . 'px / 1.2 )',
	...
	' .gform_wrapper.gravity-theme div.validation_message' => [
		...
		'padding-left'     => \Vexaltrix\Support\Helper::getCssValue( $msgLeftPadding, $attr['msgpaddingUnit'] ),
		'padding-right'    => \Vexaltrix\Support\Helper::getCssValue( $msgRightPadding, $attr['msgpaddingUnit'] ),
		'padding-top'      => \Vexaltrix\Support\Helper::getCssValue( $msgTopPadding, $attr['msgpaddingUnit'] ),
		'padding-bottom'   => \Vexaltrix\Support\Helper::getCssValue( $msgBottomPadding, $attr['msgpaddingUnit'] ),
	],
...
$tSelectors = [
	...
	' .gform_wrapper.gravity-theme input:not([type=submit])' => [
		'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldleftTabletPadding'], $attr['fieldtabletPaddingUnit'] ),
		'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldrightTabletPadding'], $attr['fieldtabletPaddingUnit'] ),
		'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldtopTabletPadding'], $attr['fieldtabletPaddingUnit'] ),
		'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldbottomTabletPadding'], $attr['fieldtabletPaddingUnit'] ),
		'margin-top'     => \Vexaltrix\Support\Helper::getCssValue(
	...
	' .gform_wrapper.gravity-theme .gfield textarea.large' => [
		...
		'height'         => 'auto' === $attr['textAreaHeightTablet'] ? $attr['textAreaHeightTablet'] : \Vexaltrix\Support\Helper::getCssValue(
	...
	' input.gform_button'                                  => [
		'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['buttonleftTabletPadding'], $attr['buttontabletPaddingUnit'] ),
		'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['buttonrightTabletPadding'], $attr['buttontabletPaddingUnit'] ),
		'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['buttontopTabletPadding'], $attr['buttontabletPaddingUnit'] ),
		'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['buttonbottomTabletPadding'], $attr['buttontabletPaddingUnit'] ),
		'border-width'   => \Vexaltrix\Support\Helper::getCssValue(
	...
	' .gform_wrapper.gravity-theme div.validation_message' => [
		'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['msgleftTabletPadding'], $attr['msgtabletPaddingUnit'] ),
		'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['msgrightTabletPadding'], $attr['msgtabletPaddingUnit'] ),
		'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['msgtopTabletPadding'], $attr['msgtabletPaddingUnit'] ),
		'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['msgbottomTabletPadding'], $attr['msgtabletPaddingUnit'] ),
	],
...
$mSelectors = [
	...
	' .gform_wrapper.gravity-theme input:not([type=submit])' => [
		'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldleftMobilePadding'], $attr['fieldmobilePaddingUnit'] ),
		'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldrightMobilePadding'], $attr['fieldmobilePaddingUnit'] ),
		'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldtopMobilePadding'], $attr['fieldmobilePaddingUnit'] ),
		'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldbottomMobilePadding'], $attr['fieldmobilePaddingUnit'] ),
		'margin-top'     => \Vexaltrix\Support\Helper::getCssValue(
	...
	' .gform_wrapper.gravity-theme .gfield textarea.large' => [
		...
		'height'         => 'auto' === $attr['textAreaHeightMobile'] ? $attr['textAreaHeightMobile'] : \Vexaltrix\Support\Helper::getCssValue(
	...
	' input.gform_button'                                  => [
		'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['buttonleftMobilePadding'], $attr['buttonmobilePaddingUnit'] ),
		'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['buttonrightMobilePadding'], $attr['buttonmobilePaddingUnit'] ),
		'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['buttontopMobilePadding'], $attr['buttonmobilePaddingUnit'] ),
		'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['buttonbottomMobilePadding'], $attr['buttonmobilePaddingUnit'] ),
		'border-width'   => \Vexaltrix\Support\Helper::getCssValue(
	...
	' .gform_wrapper.gravity-theme div.validation_message' => [
		'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['msgleftMobilePadding'], $attr['msgmobilePaddingUnit'] ),
		'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['msgrightMobilePadding'], $attr['msgmobilePaddingUnit'] ),
		'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['msgtopMobilePadding'], $attr['msgmobilePaddingUnit'] ),
		'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['msgbottomMobilePadding'], $attr['msgmobilePaddingUnit'] ),
	],
	' .gform_wrapper.gravity-theme select '                => [
		'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldleftTabletPadding'], $attr['fieldtabletPaddingUnit'] ),
		'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['fieldrightTabletPadding'], $attr['fieldtabletPaddingUnit'] ),
...
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'validationMsg', ' .gform_wrapper.gravity-theme .validation_message', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'validationMsg', ' span.wpgf-not-valid-tip', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'successMsg', ' .gform_confirmation_message', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'msg', ' .gform_wrapper div.validation_error', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'msg', ' .wpgf-response-output', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'button', ' input.gform_button, input.gform_previous_button, input.gform_next_button', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'label', ' form .gfield_checkbox label.gfield_label', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'label', ' form .gfield_radio label.gfield_label', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'label', ' .gform_wrapper.gravity-theme label.gfield_label', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'input', ' textarea', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'input', ' select', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'input', ' .gform_wrapper.gravity-theme input:not([type=submit])', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'radioCheck', ' .vxt-gf-styler__check-style-enabled form .gfield_checkbox label', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'input', ' .chosen-container-single span', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'radioCheck', ' .vxt-gf-styler__check-style-enabled form .gfield_radio label', $combinedSelectors );
