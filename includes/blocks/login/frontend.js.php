...
$loginBlock          = \Vexaltrix\Admin\AdminSettings::get( 'uag_login_block', [] );
$thisFieldErrorMsg = [
	'username' => sprintf(
...
$loginBlockOptions  = apply_filters(
	...
	[
		...
		'recaptchaSiteKey'     => \Vexaltrix\Admin\AdminSettings::get( 'uag_recaptcha_site_key_' . $attr['reCaptchaType'], '' ),
