...
if ( ! $attr['inheritGap'] ) {
	if ( 'desktop' === $attr['stack'] ) {
		...
		$selectors['.wp-block-vxt-buttons.vxt-buttons__outer-wrap .vxt-buttons__wrap ']   = [
			...
			'gap'            => \Vexaltrix\Support\Helper::getCssValue( $attr['gap'], 'px' ),
		];
		$tSelectors['.wp-block-vxt-buttons.vxt-buttons__outer-wrap .vxt-buttons__wrap '] = [
			'gap' => \Vexaltrix\Support\Helper::getCssValue( $attr['gapTablet'], 'px' ),
		];
		$mSelectors['.wp-block-vxt-buttons.vxt-buttons__outer-wrap .vxt-buttons__wrap '] = [
			'gap' => \Vexaltrix\Support\Helper::getCssValue( $attr['gapMobile'], 'px' ),
		];
...
if ( $attr['childMigrate'] ) {
	...
	$buttonDesktopStyle = [ // For Backword user.
		...
		'letter-spacing'  => \Vexaltrix\Support\Helper::getCssValue( $attr['fontLetterSpacing'], $attr['fontLetterSpacingType'] ),
	];

	if ( 'default' === $attr['buttonSize'] ) {
		$buttonDesktopPadding = [
			'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['topPadding'], $attr['paddingUnit'] ),
			'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['bottomPadding'], $attr['paddingUnit'] ),
			'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['leftPadding'], $attr['paddingUnit'] ),
			'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['rightPadding'], $attr['paddingUnit'] ),
		];
		$buttonTabletPadding  = [
	...
	$buttonTabletStyle = [
		'font-size'      => \Vexaltrix\Support\Helper::getCssValue( $attr['fontSizeTablet'], $attr['fontSizeTypeTablet'] ),
		'line-height'    => \Vexaltrix\Support\Helper::getCssValue( $attr['lineHeightTablet'], $attr['lineHeightType'] ),
		'letter-spacing' => \Vexaltrix\Support\Helper::getCssValue( $attr['fontLetterSpacingTablet'], $attr['fontLetterSpacingType'] ),
	];

	$buttonMobileStyle = [
		'font-size'      => \Vexaltrix\Support\Helper::getCssValue( $attr['fontSizeMobile'], $attr['fontSizeTypeMobile'] ),
		'line-height'    => \Vexaltrix\Support\Helper::getCssValue( $attr['lineHeightMobile'], $attr['lineHeightType'] ),
		'letter-spacing' => \Vexaltrix\Support\Helper::getCssValue( $attr['fontLetterSpacingMobile'], $attr['fontLetterSpacingType'] ),
	];
...
if ( ! $attr['childMigrate'] ) {
	...
	foreach ( $attr['buttons'] as $key => $button ) {
		...
		$childSelectors = \Vexaltrix\Core\Blocks\BlockHelper::getButtonsChildSelectors( $button, $key, $attr['childMigrate'] );
