...
// Adds Fonts.
\Vexaltrix\Presentation\Blocks\BlockJs::blocksContentTimelineGfont( $attr );
...
$selectors = [
	...
	' .vxt-timeline__line'                                => [
		...
		'width'            => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['separatorwidth'], 'px' ),
	],
	...
	' .vxt-timeline__marker'                              => [
		...
		'min-height'       => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsize'], 'px' ),
		'min-width'        => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsize'], 'px' ),
		'line-height'      => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsize'], 'px' ),
		'border'           => $attr['borderwidth'] . 'px solid ' . $attr['separatorBorder'],
	],
	'.vxt-timeline__left-block .vxt-timeline__left .vxt-timeline__arrow' => [
		'height' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsize'], 'px' ),
	],
	...
	'.vxt-timeline__center-block .vxt-timeline__left .vxt-timeline__marker' => [
		'margin-left'  => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['horizontalSpace'], $attr['horizontalSpaceUnit'] ),
		'margin-right' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['horizontalSpace'], $attr['horizontalSpaceUnit'] ),
	],
	...
	' .vxt-timeline__date-hide.vxt-timeline__date-inner' => [
		'margin-bottom' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['dateBottomspace'], 'px' ),
	...
	' .vxt-events-new .vxt-timeline__events-inner-new'   => [  // Old user CSS.
		'padding' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['bgPadding'], 'px' ),
	],
	...
	$mSelectors = [
		...
		'.vxt-timeline__center-block .vxt-timeline__left .vxt-timeline__marker' => [
			'margin-left'  => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['horizontalSpaceMobile'], $attr['horizontalSpaceUnitMobile'] ),
			'margin-right' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['horizontalSpaceMobile'], $attr['horizontalSpaceUnitMobile'] ),
		],
		'.vxt-timeline__center-block .vxt-timeline__right .vxt-timeline__marker' => [
			'margin-left'  => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['horizontalSpaceMobile'], $attr['horizontalSpaceUnitMobile'] ),
			'margin-right' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['horizontalSpaceMobile'], $attr['horizontalSpaceUnitMobile'] ),
		...
		' .vxt-timeline__marker'                 => [
			'background-color' => $attr['separatorBg'],
			'min-height'       => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsizeMobile'], 'px' ),
			'min-width'        => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsizeMobile'], 'px' ),
			'line-height'      => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsizeMobile'], 'px' ),
			'border'           => $attr['borderwidth'] . 'px solid ' . $attr['separatorBorder'],
		],
		'.vxt-timeline__left-block .vxt-timeline__left .vxt-timeline__arrow' => [
			'height' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsizeMobile'], 'px' ),
		],
		'.vxt-timeline__right-block .vxt-timeline__right .vxt-timeline__arrow' => [
			'height' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsizeMobile'], 'px' ),
		],
	...
	$tSelectors = [
		...
		'.vxt-timeline__center-block .vxt-timeline__left .vxt-timeline__marker' => [
			'margin-left'  => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['horizontalSpaceTablet'], $attr['horizontalSpaceUnitTablet'] ),
			'margin-right' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['horizontalSpaceTablet'], $attr['horizontalSpaceUnitTablet'] ),
		],
		'.vxt-timeline__center-block .vxt-timeline__right .vxt-timeline__marker' => [
			'margin-left'  => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['horizontalSpaceTablet'], $attr['horizontalSpaceUnitTablet'] ),
			'margin-right' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['horizontalSpaceTablet'], $attr['horizontalSpaceUnitTablet'] ),
		...
		' .vxt-timeline__marker'                 => [
			'background-color' => $attr['separatorBg'],
			'min-height'       => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsizeTablet'], 'px' ),
			'min-width'        => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsizeTablet'], 'px' ),
			'line-height'      => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsizeTablet'], 'px' ),
			'border'           => $attr['borderwidth'] . 'px solid ' . $attr['separatorBorder'],
		],
		'.vxt-timeline__left-block .vxt-timeline__left .vxt-timeline__arrow' => [
			'height' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsizeTablet'], 'px' ),
		],
		'.vxt-timeline__right-block .vxt-timeline__right .vxt-timeline__arrow' => [
			'height' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['connectorBgsizeTablet'], 'px' ),
		],
	...
	$combinedSelectors = \Vexaltrix\Core\Support\Helper::getTypographyCss( $attr, 'head', ' .vxt-timeline__heading', $combinedSelectors );
	...
	return \Vexaltrix\Core\Support\Helper::generateAllCss( $combinedSelectors, $baseSelector . $id . '.vxt-timeline__outer-wrap' );
