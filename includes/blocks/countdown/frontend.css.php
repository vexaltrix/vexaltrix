...
\Vexaltrix\Presentation\Blocks\BlockJs::blocksCountdownGfont( $attr );
...
// Box Border CSS.
$boxBorderCss        = \Vexaltrix\Presentation\Blocks\BlockHelper::uagGenerateBorderCss( $attr, 'box' );
$boxBorderCssTablet = \Vexaltrix\Presentation\Blocks\BlockHelper::uagGenerateBorderCss( $attr, 'box', 'tablet' );
$boxBorderCssMobile = \Vexaltrix\Presentation\Blocks\BlockHelper::uagGenerateBorderCss( $attr, 'box', 'mobile' );
...
$selectors = [
	...
	'.wp-block-vxt-countdown .wp-block-vxt-countdown__box' => array_merge(
		[
			...
			'width'            => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxWidth'], 'px' ),
			'height'           => $attr['isSquareBox'] ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxWidth'], 'px' ) : 'auto',
			...
			'padding-top'      => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxTopPadding'], $attr['boxPaddingUnit'] ),
			'padding-right'    => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxRightPadding'], $attr['boxPaddingUnit'] ),
			'padding-bottom'   => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxBottomPadding'], $attr['boxPaddingUnit'] ),
			'padding-left'     => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxLeftPadding'], $attr['boxPaddingUnit'] ),
			'row-gap'          => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['internalBoxSpacing'], 'px' ),
			'column-gap'       => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['internalBoxSpacing'], 'px' ),
	...
	'.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-minutes:not(:last-child)' => [
		'margin-right' => $attr['showSeconds'] ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacing'], 'px' ) : 'unset',
	],

	'.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-hours:not(:last-child)' => [
		'margin-right' => ( $attr['showSeconds'] || $attr['showMinutes'] ) ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacing'], 'px' ) : 'unset',
	],

	'.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-days:not(:last-child)' => [
		'margin-right' => ( $attr['showSeconds'] || $attr['showMinutes'] || $attr['showHours'] ) ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacing'], 'px' ) : 'unset',
	],
	...
	'.wp-block-vxt-countdown .wp-block-vxt-countdown__time' => [
		...
		'font-size'       => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['digitFontSize'], $attr['digitFontSizeType'] ),
		'line-height'     => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['digitLineHeight'], $attr['digitLineHeightType'] ),
		'letter-spacing'  => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['digitLetterSpacing'], $attr['digitLetterSpacingType'] ),
...
$tSelectors['.wp-block-vxt-countdown .wp-block-vxt-countdown__box'] = array_merge(
	[
		'width'           => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxWidthTablet'], 'px' ),
		'height'          => $attr['isSquareBox'] ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxWidthTablet'], 'px' ) : 'auto',
		...
		'padding-top'     => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxTopPaddingTablet'], $attr['boxPaddingUnitTablet'] ),
		'padding-right'   => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxRightPaddingTablet'], $attr['boxPaddingUnitTablet'] ),
		'padding-bottom'  => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxBottomPaddingTablet'], $attr['boxPaddingUnitTablet'] ),
		'padding-left'    => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxLeftPaddingTablet'], $attr['boxPaddingUnitTablet'] ),
		'row-gap'         => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['internalBoxSpacingTablet'], 'px' ),
		'column-gap'      => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['internalBoxSpacingTablet'], 'px' ),
	],
	$boxBorderCssTablet
);

$tSelectors['.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-minutes:not(:last-child)'] = [
	'margin-right' => $attr['showSeconds'] ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacingTablet'], 'px' ) : 'unset',
];

$tSelectors['.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-hours:not(:last-child)'] = [
	'margin-right' => ( $attr['showSeconds'] || $attr['showMinutes'] ) ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacingTablet'], 'px' ) : 'unset',
];

$tSelectors['.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-days:not(:last-child)'] = [
	'margin-right' => ( $attr['showSeconds'] || $attr['showMinutes'] || $attr['showHours'] ) ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacingTablet'], 'px' ) : 'unset',
];

$tSelectors['.wp-block-vxt-countdown .wp-block-vxt-countdown__time'] = [
	'font-size'      => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['digitFontSizeTablet'], $attr['digitFontSizeTypeTablet'] ),
	'line-height'    => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['digitLineHeightTablet'], $attr['digitLineHeightType'] ),
	'letter-spacing' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['digitLetterSpacingTablet'], $attr['digitLetterSpacingType'] ),
];
...
$tSelectors['.wp-block-vxt-countdown div.wp-block-vxt-countdown__label'] = [
	...
	'font-size'      => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['labelFontSizeTablet'], $attr['labelFontSizeTypeTablet'] ),
	'line-height'    => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['labelLineHeightTablet'], $attr['labelLineHeightType'] ),
...
$mSelectors['.wp-block-vxt-countdown .wp-block-vxt-countdown__box'] = array_merge(
	[
		'width'           => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxWidthMobile'], 'px' ),
		'height'          => $attr['isSquareBox'] ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxWidthMobile'], 'px' ) : 'auto',
		...
		'padding-top'     => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxTopPaddingMobile'], $attr['boxPaddingUnitMobile'] ),
		'padding-right'   => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxRightPaddingMobile'], $attr['boxPaddingUnitMobile'] ),
		'padding-bottom'  => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxBottomPaddingMobile'], $attr['boxPaddingUnitMobile'] ),
		'padding-left'    => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxLeftPaddingMobile'], $attr['boxPaddingUnitMobile'] ),
		'row-gap'         => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['internalBoxSpacingMobile'], 'px' ),
		'column-gap'      => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['internalBoxSpacingMobile'], 'px' ),
	],
	$boxBorderCssMobile
);

$mSelectors['.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-minutes:not(:last-child)'] = [
	'margin-right' => $attr['showSeconds'] ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacingMobile'], 'px' ) : 'unset',
];

$mSelectors['.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-hours:not(:last-child)'] = [
	'margin-right' => ( $attr['showSeconds'] || $attr['showMinutes'] ) ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacingMobile'], 'px' ) : 'unset',
];

$mSelectors['.wp-block-vxt-countdown .wp-block-vxt-countdown__box.wp-block-vxt-countdown__box-days:not(:last-child)'] = [
	'margin-right' => ( $attr['showSeconds'] || $attr['showMinutes'] || $attr['showHours'] ) ? \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacingMobile'], 'px' ) : 'unset',
];

$mSelectors['.wp-block-vxt-countdown .wp-block-vxt-countdown__time'] = [
	'font-size'      => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['digitFontSizeMobile'], $attr['digitFontSizeTypeMobile'] ),
	'line-height'    => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['digitLineHeightMobile'], $attr['digitLineHeightType'] ),
	'letter-spacing' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['digitLetterSpacingMobile'], $attr['digitLetterSpacingType'] ),
];
...
$mSelectors['.wp-block-vxt-countdown div.wp-block-vxt-countdown__label'] = [
	...
	'font-size'      => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['labelFontSizeMobile'], $attr['labelFontSizeTypeMobile'] ),
	'line-height'    => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['labelLineHeightMobile'], $attr['labelLineHeightType'] ),
...
if ( true === $attr['showSeparator'] ) {
	...
	$selectors[ $separatorSelector ] = [
		...
		'font-size'   => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['separatorFontSize'], $attr['separatorFontSizeType'] ),
		'line-height' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['separatorLineHeight'], $attr['separatorLineHeightType'] ),
		'color'       => $attr['separatorColor'],
		'right'       => is_int( $attr['separatorRightSpacing'] ) ? \Vexaltrix\Core\Support\Helper::getCssValue( -$attr['separatorRightSpacing'], 'px' ) : '',
		'top'         => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['separatorTopSpacing'], 'px' ),
	];
	...
	$tSelectors[ $separatorSelector ] = [
		'font-size'   => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['separatorFontSizeTablet'], $attr['separatorFontSizeTypeTablet'] ),
		'line-height' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['separatorLineHeightTablet'], $attr['separatorLineHeightType'] ),
		'right'       => is_int( $attr['separatorRightSpacingTablet'] ) ? \Vexaltrix\Core\Support\Helper::getCssValue( -$attr['separatorRightSpacingTablet'], 'px' ) : '',
		'top'         => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['separatorTopSpacingTablet'], 'px' ),
	];

	$mSelectors[ $separatorSelector ] = [
		'font-size'   => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['separatorFontSizeMobile'], $attr['separatorFontSizeTypeMobile'] ),
		'line-height' => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['separatorLineHeightMobile'], $attr['separatorLineHeightType'] ),
		'right'       => is_int( $attr['separatorRightSpacingMobile'] ) ? \Vexaltrix\Core\Support\Helper::getCssValue( -$attr['separatorRightSpacingMobile'], 'px' ) : '',
		'top'         => \Vexaltrix\Core\Support\Helper::getCssValue( $attr['separatorTopSpacingMobile'], 'px' ),
	];
}
...
if ( $isRtl ) {
	...
	$selectors[ $boxGapSelectorRTL ]['margin-right']   = \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacing'], 'px' );
	$tSelectors[ $boxGapSelectorRTL ]['margin-right'] = \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacingTablet'], 'px' );
	$mSelectors[ $boxGapSelectorRTL ]['margin-right'] = \Vexaltrix\Core\Support\Helper::getCssValue( $attr['boxSpacingMobile'], 'px' );
}
