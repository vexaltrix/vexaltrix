...
// Adds Fonts.
\Vexaltrix\Core\Blocks\BlockJs::blocksPostTimelineGfont( $attr );
...
$selectors = [
	...
	' .vxt-timeline__link'                               => [
		'text-align'    => \Vexaltrix\Core\Blocks\BlockHelper::getLogicalTextAlign( $attr['align'] ),
		'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['ctaBottomSpacing'], 'px' ),
	],
	' .dashicons-admin-users'                             => [
		'color'       => $attr['authorColor'],
		'font-size'   => \Vexaltrix\Support\Helper::getCssValue( $attr['authorFontSize'], $attr['authorFontSizeType'] ),
		'font-weight' => $attr['authorFontWeight'],
		'line-height' => \Vexaltrix\Support\Helper::getCssValue( $attr['authorLineHeight'], $attr['authorLineHeightType'] ),
	],
	...
	' .vxt-timeline__heading-text'                       => [
		...
		'margin-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['headTopSpacing'], 'px' ),
	],
	'.vxt_ultimate_gutenberg_blocks_timeline__cta-enable .vxt-timeline-desc-content' => [
		'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['contentSpace'], 'px' ),
		'margin-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['authorSpace'], 'px' ),
	],
	' .vxt-timeline__author-link + .vxt-timeline__link_parent' => [
		'margin-top' => \Vexaltrix\Support\Helper::getCssValue( $attr['authorSpace'], 'px' ),
	],
	'.vxt-timeline__center-block .vxt-timeline__marker' => [
		'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( $horizontalSpace, $attr['horizontalSpaceUnit'] ),
		'margin-right' => \Vexaltrix\Support\Helper::getCssValue( $horizontalSpace, $attr['horizontalSpaceUnit'] ),
	],
...
$desktopSelectors = \Vexaltrix\Core\Blocks\BlockHelper::getTimelineSelectors( $attr );
$selectors         = array_merge( $selectors, $desktopSelectors );

$tSelectors = [
	' .dashicons-admin-users'                              => [
		'font-size'   => \Vexaltrix\Support\Helper::getCssValue( $attr['authorFontSizeTablet'], $attr['authorFontSizeType'] ),
		'line-height' => \Vexaltrix\Support\Helper::getCssValue( $attr['authorLineHeightTablet'], $attr['authorLineHeightType'] ),
	],
	' .vxt-timeline__link'                                => [
		'text-align'    => \Vexaltrix\Core\Blocks\BlockHelper::getLogicalTextAlign( $attr['alignTablet'] ),
		'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['ctaBottomSpacingTablet'], 'px' ),
	],
	' .vxt-timeline__heading-text'                        => [
	...
	'.vxt_ultimate_gutenberg_blocks_timeline__cta-enable .vxt-timeline-desc-content' => [
		'margin-top' => \Vexaltrix\Support\Helper::getCssValue( $attr['authorSpaceTablet'], 'px' ),
	],
	' .vxt-timeline__author-link + .vxt-timeline__link_parent' => [
		'margin-top' => \Vexaltrix\Support\Helper::getCssValue( $attr['authorSpaceTablet'], 'px' ),
	],
	'.vxt-timeline__center-block .vxt-timeline__marker'  => [
		'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( $horizontalSpaceTablet, $attr['horizontalSpaceUnitTablet'] ),
		'margin-right' => \Vexaltrix\Support\Helper::getCssValue( $horizontalSpaceTablet, $attr['horizontalSpaceUnitTablet'] ),
	],
...
$tabletSelectors = \Vexaltrix\Core\Blocks\BlockHelper::getTimelineTabletSelectors( $attr );
$tSelectors      = array_merge( $tSelectors, $tabletSelectors );

// Mobile responsive CSS.
$mSelectors = [
	' .dashicons-admin-users'                              => [
		'font-size'   => \Vexaltrix\Support\Helper::getCssValue( $attr['authorFontSizeMobile'], $attr['authorFontSizeType'] ),
		'line-height' => \Vexaltrix\Support\Helper::getCssValue( $attr['authorLineHeightMobile'], $attr['authorLineHeightType'] ),
	],
	' .vxt-timeline__link'                                => [
		'text-align'    => \Vexaltrix\Core\Blocks\BlockHelper::getLogicalTextAlign( $attr['alignMobile'] ),
		'margin-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['ctaBottomSpacingMobile'], 'px' ),
	],
	' .vxt-timeline__heading-text'                        => [
	...
	'.vxt_ultimate_gutenberg_blocks_timeline__cta-enable .vxt-timeline-desc-content' => [
		'margin-top' => \Vexaltrix\Support\Helper::getCssValue( $attr['authorSpaceMobile'], 'px' ),
	],
	' .vxt-timeline__author-link + .vxt-timeline__link_parent' => [
		'margin-top' => \Vexaltrix\Support\Helper::getCssValue( $attr['authorSpaceMobile'], 'px' ),
	],
	'.vxt-timeline__center-block .vxt-timeline__marker'  => [
		'margin-left'  => \Vexaltrix\Support\Helper::getCssValue( $horizontalSpaceMobile, $attr['horizontalSpaceUnitMobile'] ),
		'margin-right' => \Vexaltrix\Support\Helper::getCssValue( $horizontalSpaceMobile, $attr['horizontalSpaceUnitTablet'] ),
	],
	' .vxt-timeline__day-new .vxt-timeline__inner-date-new' => [
		'text-align' => \Vexaltrix\Core\Blocks\BlockHelper::getLogicalTextAlign( $attr['alignMobile'] ),
	],
...
$mobileSelectors = \Vexaltrix\Core\Blocks\BlockHelper::getTimelineMobileSelectors( $attr );
...
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'author', ' .vxt-timeline__author-link', $combinedSelectors );
$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'head', ' .vxt-timeline__heading a', $combinedSelectors );

if ( ! $attr['inheritFromTheme'] ) {
	$combinedSelectors = \Vexaltrix\Support\Helper::getTypographyCss( $attr, 'cta', ' .vxt-timeline__link', $combinedSelectors );
}

return \Vexaltrix\Support\Helper::generateAllCss( $combinedSelectors, '.vxt-block-' . $id . '.vxt-timeline__outer-wrap' );
