...
// Add fonts.
\Vexaltrix\Core\Blocks\BlockJs::blocksCounterGfont( $attr );
...
$iconWrapBorderCss        = \Vexaltrix\Core\Blocks\BlockHelper::uagGenerateBorderCss( $attr, 'iconWrap' );
$iconWrapBorderCssTablet = \Vexaltrix\Core\Blocks\BlockHelper::uagGenerateBorderCss( $attr, 'iconWrap', 'tablet' );
$iconWrapBorderCssMobile = \Vexaltrix\Core\Blocks\BlockHelper::uagGenerateBorderCss( $attr, 'iconWrap', 'mobile' );
...
$iconAndImageSpacingTablet = [
	'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['iconTopPaddingTablet'], $attr['iconPaddingUnitTablet'] ),
	'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['iconRightPaddingTablet'], $attr['iconPaddingUnitTablet'] ),
	'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['iconBottomPaddingTablet'], $attr['iconPaddingUnitTablet'] ),
	'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['iconLeftPaddingTablet'], $attr['iconPaddingUnitTablet'] ),

	'margin-top'     => \Vexaltrix\Support\Helper::getCssValue( $attr['iconTopMarginTablet'], $attr['iconMarginUnitTablet'] ),
	'margin-right'   => \Vexaltrix\Support\Helper::getCssValue( $attr['iconRightMarginTablet'], $attr['iconMarginUnitTablet'] ),
	'margin-bottom'  => \Vexaltrix\Support\Helper::getCssValue( $attr['iconBottomMarginTablet'], $attr['iconMarginUnitTablet'] ),
	'margin-left'    => \Vexaltrix\Support\Helper::getCssValue( $attr['iconLeftMarginTablet'], $attr['iconMarginUnitTablet'] ),
];

$iconAndImageSpacingMobile = [
	'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['iconTopPaddingMobile'], $attr['iconPaddingUnitMobile'] ),
	'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['iconRightPaddingMobile'], $attr['iconPaddingUnitMobile'] ),
	'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['iconBottomPaddingMobile'], $attr['iconPaddingUnitMobile'] ),
	'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['iconLeftPaddingMobile'], $attr['iconPaddingUnitMobile'] ),

	'margin-top'     => \Vexaltrix\Support\Helper::getCssValue( $attr['iconTopMarginMobile'], $attr['iconMarginUnitMobile'] ),
	'margin-right'   => \Vexaltrix\Support\Helper::getCssValue( $attr['iconRightMarginMobile'], $attr['iconMarginUnitMobile'] ),
	'margin-bottom'  => \Vexaltrix\Support\Helper::getCssValue( $attr['iconBottomMarginMobile'], $attr['iconMarginUnitMobile'] ),
	'margin-left'    => \Vexaltrix\Support\Helper::getCssValue( $attr['iconLeftMarginMobile'], $attr['iconMarginUnitMobile'] ),
];
...
$selectors = [
	...
	'.wp-block-vxt-counter .wp-block-vxt-counter__icon svg' => [
		'fill'   => $attr['iconColor'],
		'width'  => \Vexaltrix\Support\Helper::getCssValue( $attr['iconSize'], $attr['iconSizeType'] ),
		'height' => \Vexaltrix\Support\Helper::getCssValue( $attr['iconSize'], $attr['iconSizeType'] ),
	],
	...
	'.wp-block-vxt-counter .wp-block-vxt-counter__title' => [
		...
		'font-size'       => \Vexaltrix\Support\Helper::getCssValue( $attr['headingFontSize'], $attr['headingFontSizeType'] ),
		'line-height'     => \Vexaltrix\Support\Helper::getCssValue( $attr['headingLineHeight'], $attr['headingLineHeightType'] ),
		'letter-spacing'  => \Vexaltrix\Support\Helper::getCssValue( $attr['headingLetterSpacing'], $attr['headingLetterSpacingType'] ),
		'color'           => $attr['headingColor'],
		'margin-top'      => \Vexaltrix\Support\Helper::getCssValue( $attr['headingTopMargin'], $attr['headingMarginUnit'] ),
		'margin-right'    => \Vexaltrix\Support\Helper::getCssValue( $attr['headingRightMargin'], $attr['headingMarginUnit'] ),
		'margin-bottom'   => \Vexaltrix\Support\Helper::getCssValue( $attr['headingBottomMargin'], $attr['headingMarginUnit'] ),
		'margin-left'     => \Vexaltrix\Support\Helper::getCssValue( $attr['headingLeftMargin'], $attr['headingMarginUnit'] ),
	],
	'.wp-block-vxt-counter .wp-block-vxt-counter__number' => [
		...
		'font-size'       => \Vexaltrix\Support\Helper::getCssValue( $attr['numberFontSize'], $attr['numberFontSizeType'] ),
		'line-height'     => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLineHeight'], $attr['numberLineHeightType'] ),
		'letter-spacing'  => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLetterSpacing'], $attr['numberLetterSpacingType'] ),
		'color'           => $attr['numberColor'],
		'margin-top'      => \Vexaltrix\Support\Helper::getCssValue( $attr['numberTopMargin'], $attr['numberMarginUnit'] ),
		'margin-right'    => \Vexaltrix\Support\Helper::getCssValue( $attr['numberRightMargin'], $attr['numberMarginUnit'] ),
		'margin-bottom'   => \Vexaltrix\Support\Helper::getCssValue( $attr['numberBottomMargin'], $attr['numberMarginUnit'] ),
		'margin-left'     => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLeftMargin'], $attr['numberMarginUnit'] ),
	],
	'.wp-block-vxt-counter .wp-block-vxt-counter__number .vxt-counter-block-prefix' => [
		'margin-right' => \Vexaltrix\Support\Helper::getCssValue( $attr['prefixRightDistance'], 'px' ),
	],
	'.wp-block-vxt-counter .wp-block-vxt-counter__number .vxt-counter-block-suffix' => [
		'margin-left' => \Vexaltrix\Support\Helper::getCssValue( $attr['suffixLeftDistance'], 'px' ),
	],
	'.wp-block-vxt-counter--circle .wp-block-vxt-counter-circle-container' => [
		'max-width' => \Vexaltrix\Support\Helper::getCssValue( $attr['circleSize'], 'px' ),
	],
	'.wp-block-vxt-counter--circle .wp-block-vxt-counter-circle-container svg circle' => [
		'stroke-width' => \Vexaltrix\Support\Helper::getCssValue( $attr['circleStokeSize'], 'px' ),
		'stroke'       => $attr['circleBackground'],
		'r'            => \Vexaltrix\Support\Helper::getCssValue( $circleRadius, 'px' ),
		'cx'           => \Vexaltrix\Support\Helper::getCssValue( $circlePos, 'px' ),
		'cy'           => \Vexaltrix\Support\Helper::getCssValue( $circlePos, 'px' ),
	],
	'.wp-block-vxt-counter--circle .wp-block-vxt-counter-circle-container svg .vxt-counter-circle__progress' => [
		...
		'stroke-dasharray'  => \Vexaltrix\Support\Helper::getCssValue( $circleDash, 'px' ),
		'stroke-dashoffset' => \Vexaltrix\Support\Helper::getCssValue( $circleDash, 'px' ),
	],
	...
	'.wp-block-vxt-counter--bars .wp-block-vxt-counter-bars-container .wp-block-vxt-counter__number' => [
		'height'         => \Vexaltrix\Support\Helper::getCssValue( $attr['barSize'], 'px' ),
		'background'     => $attr['barForeground'],
		'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['numberTopMargin'], $attr['numberMarginUnit'] ),
		'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['numberRightMargin'], $attr['numberMarginUnit'] ),
		'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['numberBottomMargin'], $attr['numberMarginUnit'] ),
		'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLeftMargin'], $attr['numberMarginUnit'] ),
	],
];
...
$tSelectors['.wp-block-vxt-counter .wp-block-vxt-counter__icon svg'] = [
	'width'  => \Vexaltrix\Support\Helper::getCssValue( $attr['iconSizeTablet'], $attr['iconSizeTypeTablet'] ),
	'height' => \Vexaltrix\Support\Helper::getCssValue( $attr['iconSizeTablet'], $attr['iconSizeTypeTablet'] ),
];

$tSelectors['.wp-block-vxt-counter .wp-block-vxt-counter__title']                             = [
	'font-size'      => \Vexaltrix\Support\Helper::getCssValue( $attr['headingFontSizeTablet'], $attr['headingFontSizeType'] ),
	'line-height'    => \Vexaltrix\Support\Helper::getCssValue( $attr['headingLineHeightTablet'], $attr['headingLineHeightType'] ),
	'letter-spacing' => \Vexaltrix\Support\Helper::getCssValue( $attr['headingLetterSpacingTablet'], $attr['headingLetterSpacingType'] ),
	'margin-top'     => \Vexaltrix\Support\Helper::getCssValue( $attr['headingTopMarginTablet'], $attr['headingMarginUnitTablet'] ),
	'margin-right'   => \Vexaltrix\Support\Helper::getCssValue( $attr['headingRightMarginTablet'], $attr['headingMarginUnitTablet'] ),
	'margin-bottom'  => \Vexaltrix\Support\Helper::getCssValue( $attr['headingBottomMarginTablet'], $attr['headingMarginUnitTablet'] ),
	'margin-left'    => \Vexaltrix\Support\Helper::getCssValue( $attr['headingLeftMarginTablet'], $attr['headingMarginUnitTablet'] ),
];
$tSelectors['.wp-block-vxt-counter .wp-block-vxt-counter__number']                            = [
	'font-size'      => \Vexaltrix\Support\Helper::getCssValue( $attr['numberFontSizeTablet'], $attr['numberFontSizeType'] ),
	'line-height'    => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLineHeightTablet'], $attr['numberLineHeightType'] ),
	'letter-spacing' => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLetterSpacingTablet'], $attr['numberLetterSpacingType'] ),
	'margin-top'     => \Vexaltrix\Support\Helper::getCssValue( $attr['numberTopMarginTablet'], $attr['numberMarginUnitTablet'] ),
	'margin-right'   => \Vexaltrix\Support\Helper::getCssValue( $attr['numberRightMarginTablet'], $attr['numberMarginUnitTablet'] ),
	'margin-bottom'  => \Vexaltrix\Support\Helper::getCssValue( $attr['numberBottomMarginTablet'], $attr['numberMarginUnitTablet'] ),
	'margin-left'    => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLeftMarginTablet'], $attr['numberMarginUnitTablet'] ),
];
$tSelectors['.wp-block-vxt-counter .wp-block-vxt-counter__number .vxt-counter-block-prefix'] = [
	'margin-right' => \Vexaltrix\Support\Helper::getCssValue( $attr['prefixRightDistanceTablet'], 'px' ),
];
$tSelectors['.wp-block-vxt-counter .wp-block-vxt-counter__number .vxt-counter-block-suffix'] = [
	'margin-left' => \Vexaltrix\Support\Helper::getCssValue( $attr['suffixLeftDistanceTablet'], 'px' ),
];
$tSelectors['.wp-block-vxt-counter--bars .wp-block-vxt-counter-bars-container .wp-block-vxt-counter__number'] = [
	'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['numberTopMarginTablet'], $attr['numberMarginUnitTablet'] ),
	'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['numberRightMarginTablet'], $attr['numberMarginUnitTablet'] ),
	'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['numberBottomMarginTablet'], $attr['numberMarginUnitTablet'] ),
	'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLeftMarginTablet'], $attr['numberMarginUnitTablet'] ),
];
...
$mSelectors['.wp-block-vxt-counter .wp-block-vxt-counter__icon svg'] = [
	'width'  => \Vexaltrix\Support\Helper::getCssValue( $attr['iconSizeMobile'], $attr['iconSizeTypeMobile'] ),
	'height' => \Vexaltrix\Support\Helper::getCssValue( $attr['iconSizeMobile'], $attr['iconSizeTypeMobile'] ),
];

$mSelectors['.wp-block-vxt-counter .wp-block-vxt-counter__title']                             = [
	'font-size'      => \Vexaltrix\Support\Helper::getCssValue( $attr['headingFontSizeMobile'], $attr['headingFontSizeType'] ),
	'line-height'    => \Vexaltrix\Support\Helper::getCssValue( $attr['headingLineHeightMobile'], $attr['headingLineHeightType'] ),
	'letter-spacing' => \Vexaltrix\Support\Helper::getCssValue( $attr['headingLetterSpacingMobile'], $attr['headingLetterSpacingType'] ),
	'margin-top'     => \Vexaltrix\Support\Helper::getCssValue( $attr['headingTopMarginMobile'], $attr['headingMarginUnitMobile'] ),
	'margin-right'   => \Vexaltrix\Support\Helper::getCssValue( $attr['headingRightMarginMobile'], $attr['headingMarginUnitMobile'] ),
	'margin-bottom'  => \Vexaltrix\Support\Helper::getCssValue( $attr['headingBottomMarginMobile'], $attr['headingMarginUnitMobile'] ),
	'margin-left'    => \Vexaltrix\Support\Helper::getCssValue( $attr['headingLeftMarginMobile'], $attr['headingMarginUnitMobile'] ),
];
$mSelectors['.wp-block-vxt-counter .wp-block-vxt-counter__number']                            = [
	'font-size'      => \Vexaltrix\Support\Helper::getCssValue( $attr['numberFontSizeMobile'], $attr['numberFontSizeType'] ),
	'line-height'    => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLineHeightMobile'], $attr['numberLineHeightType'] ),
	'letter-spacing' => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLetterSpacingMobile'], $attr['numberLetterSpacingType'] ),
	'margin-top'     => \Vexaltrix\Support\Helper::getCssValue( $attr['numberTopMarginMobile'], $attr['numberMarginUnitMobile'] ),
	'margin-right'   => \Vexaltrix\Support\Helper::getCssValue( $attr['numberRightMarginMobile'], $attr['numberMarginUnitMobile'] ),
	'margin-bottom'  => \Vexaltrix\Support\Helper::getCssValue( $attr['numberBottomMarginMobile'], $attr['numberMarginUnitMobile'] ),
	'margin-left'    => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLeftMarginMobile'], $attr['numberMarginUnitMobile'] ),
];
$mSelectors['.wp-block-vxt-counter .wp-block-vxt-counter__number .vxt-counter-block-prefix'] = [
	'margin-right' => \Vexaltrix\Support\Helper::getCssValue( $attr['prefixRightDistanceMobile'], 'px' ),
];
$mSelectors['.wp-block-vxt-counter .wp-block-vxt-counter__number .vxt-counter-block-suffix'] = [
	'margin-left' => \Vexaltrix\Support\Helper::getCssValue( $attr['suffixLeftDistanceMobile'], 'px' ),
];
$mSelectors['.wp-block-vxt-counter--bars .wp-block-vxt-counter-bars-container .wp-block-vxt-counter__number'] = [
	'padding-top'    => \Vexaltrix\Support\Helper::getCssValue( $attr['numberTopMarginMobile'], $attr['numberMarginUnitMobile'] ),
	'padding-right'  => \Vexaltrix\Support\Helper::getCssValue( $attr['numberRightMarginMobile'], $attr['numberMarginUnitMobile'] ),
	'padding-bottom' => \Vexaltrix\Support\Helper::getCssValue( $attr['numberBottomMarginMobile'], $attr['numberMarginUnitMobile'] ),
	'padding-left'   => \Vexaltrix\Support\Helper::getCssValue( $attr['numberLeftMarginMobile'], $attr['numberMarginUnitMobile'] ),
];
...
if ( 'bars' === $attr['layout'] ) {
	...
	$selectors[ $barContainer ]['box-shadow'] = \Vexaltrix\Support\Helper::getCssValue( $attr['boxShadowHOffset'], 'px' ) .
													' ' .
	...
	if ( ( ( '' !== $attr['boxShadowBlurHover'] ) && ( null !== $attr['boxShadowBlurHover'] ) ) || '' !== $attr['boxShadowColorHover'] ) {
		...
		$selectors[ $barContainerHover ]['box-shadow'] = \Vexaltrix\Support\Helper::getCssValue( $attr['boxShadowHOffsetHover'], 'px' ) .
																	' ' .
