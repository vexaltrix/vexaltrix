...
const ProFeatures = () => {
	...
	const blocksInfo = vexaltrixAdmin.blocks_info;
				...
				<div className="flex flex-col w-full p-1">
					...
					<div className="flex items-center justify-between w-full">
						<Link
							to={ {
								pathname: 'admin.php',
								search: '?page=vexaltrix&path=blocks',
							} }
							className="text-text-tertiary no-underline"
						>
							{ __( 'Configure', 'vexaltrix' ) }
						</Link>
					</div>
				</div>
			</Container>
			...
			>
				<div className="flex items-center justify-between w-full mb-1 p-1">
					...
					<div className="flex items-center gap-x-2">
						<Badge
							label={
								vexaltrixAdmin.zip_ai_admin_nonce
									? __( 'Connected', 'vexaltrix' )
									: __( 'Connect', 'vexaltrix' )
							}
							size="xs"
							type="pill"
							variant={ vexaltrixAdmin.zip_ai_admin_nonce ? 'green' : 'blue' }
						/>
					</div>
				</div>
				...
				<div className="flex flex-col w-full p-1">
					...
					<div className="flex items-center justify-between w-full">
						<Link
							to={ {
								pathname: 'admin.php',
								search: '?page=vexaltrix&path=ai-features',
							} }
							className="text-text-tertiary no-underline"
						>
							{ __( 'Launch', 'vexaltrix' ) }
