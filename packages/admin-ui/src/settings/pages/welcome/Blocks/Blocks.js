...
const Blocks = () => {
	...
	const blocks = [
		...
		},
		{
			...
			slug: 'instagram-feed',
			icon: VXT_Block_Icons[ 'instagram-feed' ],
			is_pro: true,
			is_active: false,
		...
		},
		{
			...
			slug: 'loop-builder',
			icon: VXT_Block_Icons[ 'loop-builder' ],
			is_pro: true,
			is_active: false,
		...
		},
		{
			...
			icon: VXT_Block_Icons[ 'dynamic-content' ],
			is_pro: true,
			is_active: false,
		...
		},
		{
			...
			slug: 'image-gallery',
			icon: VXT_Block_Icons[ 'image-gallery' ],
			is_pro: false,
			is_active: true,
		...
		},
		{
			...
			icon: VXT_Block_Icons[ 'animations-extension' ],
			is_pro: false,
			is_active: true,
