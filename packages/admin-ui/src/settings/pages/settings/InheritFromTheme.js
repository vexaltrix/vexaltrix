...
const InheritFromThemeRender = () => {
	...
	const updateEnableInheritFromTheme = () => {
		...
		const data = {
			security: vexaltrixAdmin.btn_inherit_from_theme_nonce,
			value: status,
		};
	...
	return (
		<>
			<SettingsItem
				title={ __( 'Button - Inherit From Theme', 'vexaltrix' ) }
				settingText={ __(
					'Enable the "Inherit From Theme" option to make all buttons in Vexaltrix blocks across your website inherit their styles from the theme.',
					'vexaltrix'
				) }
			>
				<Switch
