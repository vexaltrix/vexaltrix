...
const TemplatesButton = () => {
	...
	return (
		<>
			<SettingsItem
				title={ __( 'Enable Templates Button', 'vexaltrix' ) }
				settingText={ __(
					'Vexaltrix comes with a stunning library of page templates and block patterns. This library is accessible with the Templates button while editing the page or post. Manage the visibility of that button with this option.',
					'vexaltrix'
				) }
			>
				<Switch
