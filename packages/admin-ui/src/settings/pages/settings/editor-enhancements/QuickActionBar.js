...
const QuickActionBar = () => {
	...
	const debouncedApiCall = useCallback(
		debounce( ( status ) => {
			const data = {
				security: vexaltrixAdmin.enable_quick_action_sidebar_nonce,
				value: status,
			};
	...
	return (
		<>
			<SettingsItem
				title={ __( 'Enable Quick Action Bar', 'vexaltrix' ) }
				settingText={ __(
					'The Vexaltrix Quick Action Bar lets you have all your frequently used Vexaltrix blocks right at your fingertips!',
					'vexaltrix'
				) }
			>
				<Switch
