...
const RollBackConfirmPopup = ( props ) => {
	...
	const onContinueClick = () => {
		const rollbackUrl = vexaltrixAdmin.rollback_url.replace( 'VERSION', previousVersionSelect );
		setopenPopup( false );
		...
		<Transition.Root show={ open } as={ Fragment }>
			...
			>
				<div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
					...
					>
						<div className="relative z-10 inline-block p-3 rounded-lg bg-background-primary w-120 font-[Figtree]">
