...
const RegenerateAssets = () => {
	...
	const regenerateAssets = () => {
		...
		const data = {
			security: vexaltrixAdmin.regenerate_assets_nonce,
			value: true,
		};
							...
							<div className="inline-block p-3 rounded-lg bg-background-primary w-120 font-[Figtree] relative z-999999">
								...
								<div className="p-2">
									<div className="flex justify-end items-center w-full gap-3">
										...
										<Button
											className="bg-button-primary text-text-on-color vxt-remove-ring hover:bg-button-primary-hover regenerate-btn "
											size="md"
											tag="button"
											type="button"
											variant="primary"
	...
	return (
		<>
			<SettingsItem
				title={ __( 'Asset Regeneration', 'vexaltrix' ) }
				settingText={ __(
			...
			>
				<Button onClick={ openModal } className="vxt-remove-ring" style={ { fontWeight: '500' } }>
					{ __( 'Regenerate Assets', 'vexaltrix' ) }
				</Button>
			</SettingsItem>
			...
			<ConfirmationPopup
				{ ...{
					...
					popupContent: {
						title: __( 'Regenerate Assets', 'vexaltrix' ),
						description: __(
