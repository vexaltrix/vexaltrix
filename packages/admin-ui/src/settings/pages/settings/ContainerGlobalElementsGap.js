...
const ContainerGlobalElementsGap = () => {
	...
	const saveValue = ( value ) => {
        ...
        const data = {
            security: vexaltrixAdmin.container_global_elements_gap_nonce,
            value,
        };
		// Call the getApiData function with the specified parameters
        const getApiFetchData = getApiData( {
            url: vexaltrixAdmin.ajax_url,
            action: 'vxt_container_global_elements_gap',
            data,
        } );
    ...
    return (
        <>
			<SettingsItem
				title={ __( 'Container Elements Gap', 'vexaltrix' ) }
				settingText={ __( 'This setting will apply default Row & Column Gaps in the Container Block.', 'vexaltrix' ) }
			>
				<Input
					defaultValue={ 1140 }
					id="default-width"
