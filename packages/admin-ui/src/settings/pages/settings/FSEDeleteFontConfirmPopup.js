...
const FSEDeleteFontConfirmPopup = ( props ) => {
	...
	const onRemoveClick = () => {
		...
		const data = {
			security: vexaltrixAdmin.fse_font_globally_delete_nonce,
							...
							<div className="mb-2 p-2">
								<div className="flex w-full justify-between items-center mb-2">
									<div className="text-base font-semibold text-text-primary">
										{ __( 'Remove Font Family', 'vexaltrix' ) }
									</div>
								...
								<div className="text-sm text-text-secondary font-normal w-full text-left">
									{ ReactHtmlParser(
										sprintf(
											// translators: %1$s: Strong Tag,  %2$s: selected font family of Vexaltrix, %3$s Strong Closing Tag.
											__(
