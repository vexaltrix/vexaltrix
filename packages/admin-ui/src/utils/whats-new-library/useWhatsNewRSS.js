                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.RSS_Fetch_Instance.fetchData()
                                ...
                                Object.keys( res ).forEach( function ( key ) {
                                    ...
                                    const lastPostUnixTime = _this.isMultiFeedRSS() ? _this.multiLastPostUnixTime[key] : _this.lastPostUnixTime;
        ...
        const injectContents = function ( key ) {
            ...
            _this.RSS_Fetch_Instance.fetchData()
                ...
                data.forEach( function ( item ) {
                    ...
                    const contentTitle = _this.getArgs().flyout.innerContent.titleLink ?
                    ...
                    const additionalClasses = _this.getArgs().flyout.innerContent.additionalClasses;
                    if ( !!key ) {
            ...
            navBtns.forEach( function ( navBtn ) {
                ...
                navBtn.addEventListener( 'click', function ( e ) {
                    ...
                    navBtns.forEach( function ( navBtn ) {
                        ...
                        const innerContentClassName = '.inner-content-item-feed-key-'.concat( feedKey );
...
var WhatsNewRSSView = /** @class */ ( function () {
    ...
    WhatsNewRSSView.prototype.setNotification = function ( notificationsCount ) {
        const notificationBadge = document.querySelector( '#'.concat( this.getTriggerButtonID(), ' .whats-new-rss-notification-badge' ) );
    ...
    WhatsNewRSSView.prototype.setMultiFeedTabNotificationCount = function ( key, notificationCount ) {
        ...
        const tabBtn = document.querySelector( '#'.concat( this.getFlyoutMultiFeedNavID(), ' button[data-feed-key="' ).concat( key, '"]' ) );
        if ( !tabBtn ) {
            return;
        }
    ...
    WhatsNewRSSView.prototype.createExcerpt = function ( content, readMoreLink, options ) {
        const wordLimit = options.wordLimit, moreSymbol = options.moreSymbol, readMore = options.readMore;
        if ( !wordLimit ) {
            return content;
        }
