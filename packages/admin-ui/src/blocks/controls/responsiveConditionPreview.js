		...
		if ( null !== element && undefined !== element ) {
			if ( null === desktopStyle || undefined === desktopStyle ) {
				...
				$style.innerHTML =
					...
					'.vxt-editor-preview-mode-desktop{ background:repeating-linear-gradient(125deg, rgba(0, 0, 0, 0.15), rgba(0, 0, 0, 0.15) 1px, transparent 2px, transparent 9px); border: 1px solid rgba(0, 0, 0, 0.15); } ';
				$style.innerHTML +=
					'.vxt-block-' +
					props.clientId.substr( 0, 8 ) +
					'.vxt-editor-preview-mode-desktop:before{ content: ""; display: block; position: absolute; top: 0; left: 0; width: 100%; height: 100%;  background-color: rgba(255, 255, 255, 0.6); z-index: 9997; } ';
		...
		if ( props.attributes.UAGHideTab ) {
			if ( null === iframeTabletElement || undefined === iframeTabletElement ) {
				...
				$style.innerHTML =
					'.vxt-block-' +
					props.clientId.substr( 0, 8 ) +
					'.vxt-editor-preview-mode-tablet{ background:repeating-linear-gradient(125deg, rgba(0, 0, 0, 0.15), rgba(0, 0, 0, 0.15) 1px, transparent 2px, transparent 9px); border: 1px solid rgba(0, 0, 0, 0.15); } ';
				$style.innerHTML +=
					'.vxt-block-' +
					props.clientId.substr( 0, 8 ) +
					'.vxt-editor-preview-mode-tablet:before{ content: ""; display: block; position: absolute; top: 0; left: 0; width: 100%; height: 100%;  background-color: rgba(255, 255, 255, 0.6); z-index: 9997; } ';
		...
		if ( props.attributes.UAGHideMob ) {
			if ( null === iframeMobileElement || undefined === iframeMobileElement ) {
				...
				$style.innerHTML =
					'.vxt-block-' +
					props.clientId.substr( 0, 8 ) +
					'.vxt-editor-preview-mode-mobile{ background:repeating-linear-gradient(125deg, rgba(0, 0, 0, 0.15), rgba(0, 0, 0, 0.15) 1px, transparent 2px, transparent 9px); border: 1px solid rgba(0, 0, 0, 0.15); } ';
				$style.innerHTML +=
					'.vxt-block-' +
					props.clientId.substr( 0, 8 ) +
					'.vxt-editor-preview-mode-mobile:before{ content: ""; display: block; position: absolute; top: 0; left: 0; width: 100%; height: 100%;  background-color: rgba(255, 255, 255, 0.6); z-index: 9997; } ';
