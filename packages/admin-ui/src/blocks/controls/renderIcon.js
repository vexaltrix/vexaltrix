...
function renderSVG( svg, setAttributes = false, extraProps = {} ) {
	...
	if ( 0 !== vxt_ultimate_gutenberg_blocks_blocks_info.font_awesome_5_polyfill.length ) {
		fontAwesome = vxt_ultimate_gutenberg_blocks_blocks_info.vxt_ultimate_gutenberg_blocks_svg_icons[ svg ];
		if ( ! fontAwesome ) {
			fontAwesome =
				vxt_ultimate_gutenberg_blocks_blocks_info.vxt_ultimate_gutenberg_blocks_svg_icons[
					vxt_ultimate_gutenberg_blocks_blocks_info.font_awesome_5_polyfill?.[ svg ]
				];
		}
	}
