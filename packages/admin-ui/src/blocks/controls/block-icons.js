...
const vexaltrixDarkColor = '#1d2327';

// Negative Space Color needs to be implemented for the property that doesn't use iconColor.
const noColor = 'none';

const VXT_Block_Icons = {
	// ------------------------.
	// All Vexaltrix Block Icons .
	// ------------------------.

	logo: el(
		'svg',
		{ width: 20, height: 20, viewBox: '0 0 85 85', className: 'vxt-editor-icons' },
		el( 'path', {
			d:
	...
	section: el(
		'svg',
		{ width: 24, height: 24, viewBox: '0 0 24 24', fill: 'none', className: 'vxt-editor-icons' },
		el( 'path', {
			d:
	...
	buttons_child: el(
		'svg',
		{ width: 24, height: 24, viewBox: '0 0 24 24', className: 'vxt-editor-icons' },
		el( 'path', {
			d:
	...
	call_to_action: el(
		'svg',
		{ width: 40, height: 40, viewBox: '0 0 24 24', fill: 'none', className: 'vxt-editor-icons' },
		el( 'path', {
			d:
	...
	accept: el(
		'svg',
		{ width: 24, height: 24, role: 'img', viewBox: '0 0 24 24', className: 'vxt-editor-icons' },
		el( 'path', {
			d:
	...
	slider: el(
		'svg',
		{ width: 24, height: 24, viewBox: '0 0 26 24', fill: 'none', className: 'vxt-editor-icons' },
		el( 'rect', {
			x: 5.4502,
			y: 4.98621,
			width: 15.0978,
	...
	loop_builder: el(
		'svg',
		{ width: 24, height: 24, viewBox: '0 0 25 24', fill: 'none', className: 'vxt-editor-icons' },
		el(
			'g',
			null,
			el( 'path', {
				d:
					'M3.35981 8.80578C5.11039 7.05892 7.94864 7.05892 9.69922 8.80578L12.8689 11.9687L9.69922 15.1317C7.94864 16.8785 5.11039 16.8785 3.35981 15.1317C1.60923 13.3848 1.60923 10.5526 3.35981 8.80578Z',
				fill: noColor,
				stroke: iconColor,
				strokeWidth: 1.4,
			} ),
			el( 'path', {
				d:
					'M22.2987 15.1942C20.5481 16.9411 17.7099 16.9411 15.9593 15.1942L12.7896 12.0313L15.9593 8.86831C17.7099 7.12146 20.5481 7.12146 22.2987 8.86831C24.0493 10.6152 24.0493 13.4474 22.2987 15.1942Z',
				fill: noColor,
				stroke: iconColor,
				strokeWidth: 1.4,
			} )
	...
	loop_search: el(
		...
		el( 'path', {
			d:
				'M1 19L7 13M5 8C5 11.866 8.13401 15 12 15C15.866 15 19 11.866 19 8C19 4.13401 15.866 1 12 1C8.13401 1 5 4.13401 5 8Z',
			fill: noColor,
			stroke: iconColor,
			strokeWidth: 1.4,
			strokeLinecap: 'round',
	...
	loop_sort: el(
		...
		el( 'path', {
			d:
				'M2.95 6.4691V3.00943C2.95 2.84374 3.08431 2.70943 3.25 2.70943H20.75C20.9157 2.70943 21.05 2.84374 21.05 3.00943V6.45928C21.05 6.54425 21.014 6.62523 20.9509 6.68212L16.269 10.9021C15.9114 11.2245 15.7072 11.6834 15.7072 12.1649V18.5587C15.7072 18.6803 15.6339 18.7898 15.5215 18.8361L8.53336 21.7145C8.33591 21.7959 8.11911 21.6507 8.11911 21.4371V12.1551C8.11911 11.6833 7.92309 11.2328 7.57792 10.9112L3.0455 6.6886L2.57457 7.19409L3.0455 6.6886C2.98459 6.63186 2.95 6.55235 2.95 6.4691Z',
			fill: noColor,
			stroke: iconColor,
			strokeWidth: 1.4,
		} )
	...
	loop_category: el(
		...
		el( 'path', {
			d:
				'M14 16.47C14 15.5272 14 15.0558 14.2929 14.7629C14.5858 14.47 15.0572 14.47 16 14.47H19C19.9428 14.47 20.4142 14.47 20.7071 14.7629C21 15.0558 21 15.5272 21 16.47V19.47C21 20.4128 21 20.8842 20.7071 21.1771C20.4142 21.47 19.9428 21.47 19 21.47H16C15.0572 21.47 14.5858 21.47 14.2929 21.1771C14 20.8842 14 20.4128 14 19.47V16.47Z',
			fill: noColor,
			stroke: iconColor,
			strokeWidth: 1.4,
			strokeLinecap: 'round',
	...
	// --------------------------------.
	// All Vexaltrix Cross-Product Icons .
	// --------------------------------.
	...
	sure_forms: el(
		'svg',
		{
			...
			fill: noColor,
			stroke: noColor,
			className: 'vxt-editor-icons sureforms-logo',
		},
		el(
			'g',
			{ clipPath: 'url(#clip_vexaltrix_sureforms_block_icon)' },
			el( 'rect', { width: '32', height: '32', fill: 'transparent', strokeWidth: '1.4', stroke: '#0063a1' } ),
			el( 'path', {
		...
		el(
			...
			el(
				'clipPath',
				{ id: 'clip_vexaltrix_sureforms_block_icon' },
				el( 'rect', {
					width: '192',
					height: '32',
					fill: 'white',
	...
	quote_1: el(
		'svg',
		{ width: 20, height: 20, className: 'vxt-editor-icons' },
		el( 'path', {
			d:
	...
	at_the_rate: el(
		'svg',
		{ width: 30, height: 30, className: 'vxt-editor-icons' },
		el( 'path', {
			d:
	...
	carousel_left: el(
		'svg',
		{ width: 20, height: 20, viewBox: '0 0 256 512', className: 'vxt-editor-icons' },
		el( 'path', {
			d:
	...
	form1: el(
		'svg',
		{ width: 20, height: 20, role: 'img', viewBox: '0 0 58 58', className: 'vxt-editor-icons' },
		el( 'path', {
			fill: vexaltrixDarkColor,
			d:
		...
		el( 'path', { fill: vexaltrixDarkColor, d: 'M38.1,15.6h-27v-3.4h27V15.6z' } ),
		el( 'path', { fill: vexaltrixDarkColor, d: 'M38.1,23h-27v-3.4h27V23z' } ),
		el( 'path', { fill: vexaltrixDarkColor, d: 'M35.2,29.6H13.5v-2.7h21.7V29.6z' } ),
		el( 'path', { fill: vexaltrixDarkColor, d: 'M35.2,35.4H13.5v-2.7h21.7V35.4z' } ),
		el( 'path', { fill: vexaltrixDarkColor, d: 'M35.2,27.8v6.3h-2.7v-6.3H35.2z' } ),
		el( 'path', { fill: vexaltrixDarkColor, d: 'M16.2,27.9v6.3h-2.7v-6.3H16.2z' } ),
		el( 'path', {
			fill: vexaltrixDarkColor,
			d:
	...
	form2: el(
		...
		el( 'path', { fill: vexaltrixDarkColor, d: 'M14.7,19.6h26.1v-3.7H14.7V19.6z' } ),
		el( 'path', { fill: vexaltrixDarkColor, d: 'M14.7,27h26.1v-3.7H14.7V27z' } ),
		el( 'path', { fill: vexaltrixDarkColor, d: 'M14.7,34.5h26.1v-3.7H14.7V34.5z' } ),
		el( 'path', {
			fill: vexaltrixDarkColor,
			d:
	...
	form3: el(
		'svg',
		{ width: 20, height: 20, role: 'img', viewBox: '0 0 58 58', className: 'vxt-editor-icons' },
		el( 'path', { fill: vexaltrixDarkColor, d: 'M41.5,46.1h-27v-3.4h27V46.1z' } ),
		el( 'path', {
			fill: vexaltrixDarkColor,
			d:
	...
	close: el(
		'svg',
		{ width: 8, height: 8, viewBox: '0 0 6 6', className: 'vxt-editor-icons' },
		el( 'path', {
			fill: vexaltrixDarkColor,
			d:
	...
	add: el(
		'svg',
		{ width: 8, height: 8, viewBox: '0 0 8 8', className: 'vxt-editor-icons' },
		el( 'path', {
			fill: vexaltrixDarkColor,
			d:
	...
	bg_color: el(
		'svg',
		{ width: 11, height: 10, viewBox: '0 0 11 10', className: 'vxt-editor-icons' },
		el( 'path', {
			fill: vexaltrixDarkColor,
			d:
	...
	bg_gradient: el(
		'svg',
		{ width: 12, height: 12, viewBox: '0 0 10 10', className: 'vxt-editor-icons' },
		el( 'path', {
			fill: vexaltrixDarkColor,
			fillRule: 'evenodd',
			clipRule: 'evenodd',
	...
	bg_image: el(
		'svg',
		{ width: 14, height: 14, viewBox: '0 0 14 14', className: 'vxt-editor-icons' },
		el( 'path', {
			fill: vexaltrixDarkColor,
			d:
	...
	bg_video: el(
		'svg',
		{ width: 14, height: 8, viewBox: '0 0 14 8', className: 'vxt-editor-icons' },
		el( 'path', {
			fill: vexaltrixDarkColor,
			d:
	...
	dynamic_content: el(
		'svg',
		{ width: 24, height: 24, viewBox: '0 0 24 24', fill: 'red', className: 'vxt-editor-icons' },
		el( 'path', {
			stoke: vexaltrixDarkColor,
			strokeWidth: 1.4,
			d:
	...
	icon: el(
		'svg',
		{ width: 24, height: 25, viewBox: '0 0 24 25', fill: 'none', className: 'vxt-editor-icons' },
		el( 'path', {
			d:
	...
	pencilIcon: el(
		'svg',
		{ width: 20, height: 20, viewBox: '0 0 20 20', fill: 'none', className: 'vxt-editor-icons' },
		el( 'path', {
			d:
...
export const renderLegacyBlockEditorIcon = ( blockName ) => (
	<>
		{ VXT_Block_Icons[ blockName ] }
		<div className="vexaltrix__legacy-icon--block-inserter-label">Legacy</div>
	</>
);

export default VXT_Block_Icons;
