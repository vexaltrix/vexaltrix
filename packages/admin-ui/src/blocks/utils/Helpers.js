...
export function convertToPixel( lengthString ) {
	...
	return match
		? parseFloat( match[ 1 ] ) *
				( match[ 3 ].toLowerCase() === 'rem' || match[ 3 ].toLowerCase() === 'em' ? 16 : 1 )
		: 10;
}
...
// JS counterpart of VXT_Block_Helper::get_logical_text_align(). Flips
