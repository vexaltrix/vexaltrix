				...
				<Container.Item className="flex flex-1 flex-col gap-2">
					...
					<div className=" text-brand-primary-600 flex space-x-1">
						...
						<div className="font-semibold text-xs">
							{ __( 'Unlock Pro Features', 'vexaltrix' ) }
						</div>
					</div>

					<div>
						<Title className="text-text-primary" tag="h1" title="Limitless Design With Vexaltrix Pro!" />
					...
					<div className="grid grid-cols-2 gap-3">
						<ul className="list-none pl-0 space-y-2">
							<li className="flex items-center space-x-2 text-field-label text-sm">
								...
								<span>{ __( 'Instagram Feed Block', 'vexaltrix' ) }</span>
							</li>
							<li className="flex items-center space-x-2 text-field-label text-sm">
								<Check className="text-brand-primary-600" size={ 14 } />
								<span>{ __( 'Dynamic Content', 'vexaltrix' ) }</span>
							</li>
							<li className="flex items-center space-x-2 text-field-label text-sm">
								<Check className="text-brand-primary-600" size={ 14 } />
								<span>{ __( 'Popup Builder', 'vexaltrix' ) }</span>
							</li>
						</ul>
						...
						<ul className="list-none pl-0 space-y-2">
							<li className="flex items-center space-x-2 text-field-label text-sm">
								<Check className="text-brand-primary-600" size={ 14 } />
								<span>{ __( 'Global Block Styles', 'vexaltrix' ) }</span>
							</li>
							<li className="flex items-center space-x-2 text-field-label text-sm">
								<Check className="text-brand-primary-600" size={ 14 } />
								<span>{ __( 'Loop Builder', 'vexaltrix' ) }</span>
							</li>
							<li className="flex items-center space-x-2 text-field-label text-sm">
								<Check className="text-brand-primary-600" size={ 14 } />
								<span>{ __( 'And More…', 'vexaltrix' ) }</span>
							</li>
						</ul>
					</div>
					...
					{ freeVPro ? (
						...
						<div className="flex gap-3 mt-2">
							<a
								...
								rel="noreferrer"
							>
								<Button variant="secondary" className="vxt-remove-ring">
							...
							<Link
								...
								to={ {
									pathname: 'admin.php',
									search: '?page=vexaltrix&path=free-vs-pro',
								} }
							>
								<Button variant="ghost" className="vxt-remove-ring">
					...
					{ freeVPro && (
						<a
							href={vexaltrixAdmin.vxt_links?.uagDashboard + '-view-plan'}
							target="_blank"
							rel="noreferrer"
	...
	return (
		<Container className="bg-white p-6 shadow-sm rounded-lg border border-solid border-border-subtle flex items-center gap-8 md:flex-row flex-col-reverse unlock-pro-features">
			<Container.Item className="flex flex-1 flex-col gap-2">
				...
				<div>
					<Title className="text-text-primary mb-1" tag="h1" title="Limitless Design With Vexaltrix Pro!" />
					<p className="text-sm text-text-secondary m-0">
						{ __(
							'Utilize advanced blocks, extensions, and premium features to create a websites that stands out!',
							'vexaltrix'
				...
				{ freeVPro && (
					<a
						href={vexaltrixAdmin.vxt_links?.freeVsPro}
						target="_blank"
						rel="noreferrer"
						className="text-xxs text-brand-primary-600 w-full flex justify-end md:pr-[10px] pr-2 -mt-2"
					>
