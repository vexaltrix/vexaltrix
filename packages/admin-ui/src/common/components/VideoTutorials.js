...
const VideoTutorials = () => {
	const videos = [
		`${ VXT_LINKS.YOUTUBE_EMBED }-Ksf984Tcgw`,
		`${ VXT_LINKS.YOUTUBE_EMBED }3TYf_v-T7n8`,
		`${ VXT_LINKS.YOUTUBE_EMBED }DKgGid221_U`,
		`${ VXT_LINKS.YOUTUBE_EMBED }m2uVrKWPnbA`,
		`${ VXT_LINKS.YOUTUBE_EMBED }0PKYbB2XbFE`,
		'',
	];
	...
	const getThumbnailUrl = ( videoUrl ) => {
		...
		return `${ VXT_LINKS.YOUTUBE_THUMBNAIL }${ videoId }/hqdefault.jpg`;
	};
					...
					{ videos.map( ( video, index ) => {
						return video !== '' ? (
							...
							<div
								...
								onClick={ () =>
									window.open(
										VXT_LINKS.YOUTUBE_PLAYLIST,
										'_blank'
									)
								}
							>
								<img
									src={ getThumbnailUrl( `${ VXT_LINKS.YOUTUBE_EMBED }ywLPlWqhM0Y` ) }
